 ...
 * \brief Disable resending feature. Resending feature should not be needed
 ...
 * \brief Set the number of messages stored.
 ...
 * \brief Set the CoAP re-send interval in seconds.
 ...
 * \brief Set the size of the re-sending buffer.
 ...
 * \brief Set the maximum size (in bytes) that
 ...
 * \brief Set the maximum payload size allowed before blockwising the message.
 ...
 * \brief Enable the blockwise functionality in CoAP library also when blockwise payload
 ...
 * \brief Define how many times CoAP library tries to re-send the CoAP packet.
 ...
 * \brief Maximum time in seconds how long message is kept for duplicate detection.
