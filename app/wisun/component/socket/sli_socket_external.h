 ...
 *
 ******************************************************************************/
#ifndef _SLI_SOCKET_EXTERNAL_H_
#define _SLI_SOCKET_EXTERNAL_H_
 ...
 *****************************************************************************/
int32_t sli_socket_external_socket(sock_domain_t domain, sock_type_t type, int32_t protocol);
 ...
 * @return if any error occurred, return with -1, otherwise return with the socket id
 *****************************************************************************/
int32_t sli_socket_external_close(int32_t sockfd);
 ...
 *****************************************************************************/
int32_t sli_socket_external_bind(int32_t sockfd, const struct sockaddr *addr, socklen_t addrlen);
 ...
 * @return On success, zero is returned.  On error, -1 is returned
 *****************************************************************************/
int32_t sli_socket_external_listen(int32_t sockfd, int32_t backlog);
 ...
 *****************************************************************************/
int32_t sli_socket_external_accept(int32_t sockfd, struct sockaddr *addr, socklen_t *addrlen);
 ...
 *****************************************************************************/
int32_t sli_socket_external_connect(int32_t sockfd, const struct sockaddr *addr, socklen_t addrlen);
 ...
 *****************************************************************************/
int32_t sli_socket_external_send(int32_t sockfd, const void *buf, uint32_t len, int32_t flags);
 ...
 * @return On success, these calls return the number of bytes sent. On error, -1 is returned
 *****************************************************************************/
int32_t sli_socket_external_sendto(int32_t sockfd, const void *buf, uint32_t len,
 ...
 *****************************************************************************/
int32_t sli_socket_external_recv(int32_t sockfd, const void *buf, uint32_t len, int32_t flags);
 ...
 * @return return the number of bytes received, or -1 if an error occurred
 *****************************************************************************/
int32_t sli_socket_external_recvfrom(int32_t sockfd, void *buf, uint32_t len, int32_t flags,
 ...
 *****************************************************************************/
int32_t sli_socket_external_setsockopt(int32_t socket, int32_t level, int32_t optname,
 ...
 * @return Return 0 on success, other wise -1
 *****************************************************************************/
int32_t sli_socket_external_getsockopt(int32_t sockfd, int32_t level, int32_t optname,
