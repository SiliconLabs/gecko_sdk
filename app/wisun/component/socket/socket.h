...
/**************************************************************************//**
 * @brief Create an endpoint for communication and return a socket ID.
 * @details Socket API support Wi-SUN FAN and external IP network communications.
 *          External handlers can be implemented, the default implementations are weak functions.
 *          Created sockets added to socket handler automatically
...
/**************************************************************************//**
 * @brief Long host byte order to network order.
 * @details It converts the unsigned integer hostlong from host byte order to network byte order.
 *          For Wi-SUN, conversion is not needed. Dummy implementation
...
/**************************************************************************//**
 * @brief Short host byte order to network order.
 * @details It converts the unsigned short integer hostshort from host byte order to network byte order.
 *          For Wi-SUN, conversion is not needed. Dummy implementation
...
/**************************************************************************//**
 * @brief Long network byte order to host byte order.
 * @details It converts the unsigned integer netlong from network byte order to host byte order.
 *          For Wi-SUN, conversion is not needed. Dummy implementation
...
/**************************************************************************//**
 * @brief Short network byte order to host byte order.
 * @details It converts the unsigned short integer netshort from network byte order to host byte order.
 *          For Wi-SUN, conversion is not needed. Dummy implementation
 * @param[in] netshort
