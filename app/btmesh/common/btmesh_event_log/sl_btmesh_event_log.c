  ...
  switch (evt_id) {
    ...
    case sl_btmesh_evt_node_provisioned_id: {
      ...
      sl_btmesh_evt_node_provisioned_t
        data = evt->data.evt_node_provisioned;
      app_log_append(" address="); log_append_uint16_t(data.address);
      app_log_append(" iv_index="); log_append_uint32_t(data.iv_index);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_node_config_get_id: {
      ...
      sl_btmesh_evt_node_config_get_t
        data = evt->data.evt_node_config_get;
    ...
    case sl_btmesh_evt_node_display_output_oob_id: {
      ...
      sl_btmesh_evt_node_display_output_oob_t
        data = evt->data.evt_node_display_output_oob;
    ...
    case sl_btmesh_evt_node_input_oob_request_id: {
      ...
      sl_btmesh_evt_node_input_oob_request_t
        data = evt->data.evt_node_input_oob_request;
    ...
    case sl_btmesh_evt_node_provisioning_started_id: {
      ...
      sl_btmesh_evt_node_provisioning_started_t
        data = evt->data.evt_node_provisioning_started;
    ...
    case sl_btmesh_evt_node_provisioning_failed_id: {
      ...
      sl_btmesh_evt_node_provisioning_failed_t
        data = evt->data.evt_node_provisioning_failed;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_node_key_added_id: {
      ...
      sl_btmesh_evt_node_key_added_t
        data = evt->data.evt_node_key_added;
    ...
    case sl_btmesh_evt_node_model_config_changed_id: {
      ...
      sl_btmesh_evt_node_model_config_changed_t
        data = evt->data.evt_node_model_config_changed;
    ...
    case sl_btmesh_evt_node_ivrecovery_needed_id: {
      ...
      sl_btmesh_evt_node_ivrecovery_needed_t
        data = evt->data.evt_node_ivrecovery_needed;
    ...
    case sl_btmesh_evt_node_changed_ivupdate_state_id: {
      ...
      sl_btmesh_evt_node_changed_ivupdate_state_t
        data = evt->data.evt_node_changed_ivupdate_state;
      app_log_append(" iv_index="); log_append_uint32_t(data.iv_index);
    ...
    case sl_btmesh_evt_node_key_removed_id: {
      ...
      sl_btmesh_evt_node_key_removed_t
        data = evt->data.evt_node_key_removed;
      app_log_append(" type="); log_append_uint8_t(data.type);
      app_log_append(" index="); log_append_uint16_t(data.index);
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_node_key_updated_id: {
      ...
      sl_btmesh_evt_node_key_updated_t
        data = evt->data.evt_node_key_updated;
      app_log_append(" type="); log_append_uint8_t(data.type);
      app_log_append(" index="); log_append_uint16_t(data.index);
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_node_heartbeat_id: {
      ...
      sl_btmesh_evt_node_heartbeat_t
        data = evt->data.evt_node_heartbeat;
    ...
    case sl_btmesh_evt_node_heartbeat_start_id: {
      ...
      sl_btmesh_evt_node_heartbeat_start_t
        data = evt->data.evt_node_heartbeat_start;
      app_log_append(" src_addr="); log_append_uint16_t(data.src_addr);
      app_log_append(" dst_addr="); log_append_uint16_t(data.dst_addr);
    ...
    case sl_btmesh_evt_node_heartbeat_stop_id: {
      ...
      sl_btmesh_evt_node_heartbeat_stop_t
        data = evt->data.evt_node_heartbeat_stop;
      app_log_append(" src_addr="); log_append_uint16_t(data.src_addr);
      app_log_append(" dst_addr="); log_append_uint16_t(data.dst_addr);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_node_local_dcd_data_id: {
      ...
      sl_btmesh_evt_node_local_dcd_data_t
        data = evt->data.evt_node_local_dcd_data;
    ...
    case sl_btmesh_evt_node_local_dcd_data_end_id: {
      ...
      sl_btmesh_evt_node_local_dcd_data_end_t
        data = evt->data.evt_node_local_dcd_data_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_node_local_model_metadata_page_id: {
      ...
      sl_btmesh_evt_node_local_model_metadata_page_t
        data = evt->data.evt_node_local_model_metadata_page;
      app_log_append(" page="); log_append_uint8_t(data.page);
      app_log_append(" data="); log_append_uint8array(data.data);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_node_start_received_id: {
      ...
      sl_btmesh_evt_node_start_received_t
        data = evt->data.evt_node_start_received;
    ...
    case sl_btmesh_evt_node_address_updated_id: {
      ...
      sl_btmesh_evt_node_address_updated_t
        data = evt->data.evt_node_address_updated;
    ...
    case sl_btmesh_evt_prov_provisioning_suspended_id: {
      ...
      sl_btmesh_evt_prov_provisioning_suspended_t
        data = evt->data.evt_prov_provisioning_suspended;
    ...
    case sl_btmesh_evt_prov_capabilities_id: {
      ...
      sl_btmesh_evt_prov_capabilities_t
        data = evt->data.evt_prov_capabilities;
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
    ...
    case sl_btmesh_evt_prov_provisioning_failed_id: {
      ...
      sl_btmesh_evt_prov_provisioning_failed_t
        data = evt->data.evt_prov_provisioning_failed;
      app_log_append(" reason="); log_append_uint8_t(data.reason);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_prov_device_provisioned_id: {
      ...
      sl_btmesh_evt_prov_device_provisioned_t
        data = evt->data.evt_prov_device_provisioned;
      app_log_append(" address="); log_append_uint16_t(data.address);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_prov_unprov_beacon_id: {
      ...
      sl_btmesh_evt_prov_unprov_beacon_t
        data = evt->data.evt_prov_unprov_beacon;
    ...
    case sl_btmesh_evt_prov_oob_pkey_request_id: {
      ...
      sl_btmesh_evt_prov_oob_pkey_request_t
        data = evt->data.evt_prov_oob_pkey_request;
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_prov_oob_display_input_id: {
      ...
      sl_btmesh_evt_prov_oob_display_input_t
        data = evt->data.evt_prov_oob_display_input;
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" input_action="); log_append_uint8_t(data.input_action);
      app_log_append(" input_size="); log_append_uint8_t(data.input_size);
      app_log_append(" data="); log_append_uint8array(data.data);
    ...
    case sl_btmesh_evt_prov_ddb_list_id: {
      ...
      sl_btmesh_evt_prov_ddb_list_t
        data = evt->data.evt_prov_ddb_list;
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" address="); log_append_uint16_t(data.address);
      app_log_append(" elements="); log_append_uint8_t(data.elements);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_prov_key_refresh_phase_update_id: {
      ...
      sl_btmesh_evt_prov_key_refresh_phase_update_t
        data = evt->data.evt_prov_key_refresh_phase_update;
    ...
    case sl_btmesh_evt_prov_key_refresh_node_update_id: {
      ...
      sl_btmesh_evt_prov_key_refresh_node_update_t
        data = evt->data.evt_prov_key_refresh_node_update;
      app_log_append(" key="); log_append_uint16_t(data.key);
      app_log_append(" phase="); log_append_uint8_t(data.phase);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
    ...
    case sl_btmesh_evt_prov_key_refresh_complete_id: {
      ...
      sl_btmesh_evt_prov_key_refresh_complete_t
        data = evt->data.evt_prov_key_refresh_complete;
      app_log_append(" key="); log_append_uint16_t(data.key);
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_prov_add_ddb_entry_complete_id: {
      ...
      sl_btmesh_evt_prov_add_ddb_entry_complete_t
        data = evt->data.evt_prov_add_ddb_entry_complete;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_prov_delete_ddb_entry_complete_id: {
      ...
      sl_btmesh_evt_prov_delete_ddb_entry_complete_t
        data = evt->data.evt_prov_delete_ddb_entry_complete;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_prov_provisioning_records_list_id: {
      ...
      sl_btmesh_evt_prov_provisioning_records_list_t
        data = evt->data.evt_prov_provisioning_records_list;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
    ...
    case sl_btmesh_evt_prov_start_sent_id: {
      ...
      sl_btmesh_evt_prov_start_sent_t
        data = evt->data.evt_prov_start_sent;
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
      app_log_append(" algorithm="); log_append_uint8_t(data.algorithm);
      app_log_append(" public_key="); log_append_uint8_t(data.public_key);
      app_log_append(" authentication_method="); log_append_uint8_t(data.authentication_method);
    ...
    case sl_btmesh_evt_proxy_connected_id: {
      ...
      sl_btmesh_evt_proxy_connected_t
        data = evt->data.evt_proxy_connected;
    ...
    case sl_btmesh_evt_proxy_disconnected_id: {
      ...
      sl_btmesh_evt_proxy_disconnected_t
        data = evt->data.evt_proxy_disconnected;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_silabs_config_client_model_status_id: {
      ...
      sl_btmesh_evt_silabs_config_client_model_status_t
        data = evt->data.evt_silabs_config_client_model_status;
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
    ...
    case sl_btmesh_evt_silabs_config_client_network_pdu_status_id: {
      ...
      sl_btmesh_evt_silabs_config_client_network_pdu_status_t
        data = evt->data.evt_silabs_config_client_network_pdu_status;
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
    ...
    case sl_btmesh_evt_vendor_model_receive_id: {
      ...
      sl_btmesh_evt_vendor_model_receive_t
        data = evt->data.evt_vendor_model_receive;
    ...
    case sl_btmesh_evt_vendor_model_send_complete_id: {
      ...
      sl_btmesh_evt_vendor_model_send_complete_t
        data = evt->data.evt_vendor_model_send_complete;
      app_log_append(" result="); log_append_uint16_t(data.result);
    ...
    case sl_btmesh_evt_health_client_server_status_id: {
      ...
      sl_btmesh_evt_health_client_server_status_t
        data = evt->data.evt_health_client_server_status;
    ...
    case sl_btmesh_evt_health_client_server_status_period_id: {
      ...
      sl_btmesh_evt_health_client_server_status_period_t
        data = evt->data.evt_health_client_server_status_period;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" result="); log_append_uint16_t(data.result);
    ...
    case sl_btmesh_evt_health_client_server_status_attention_id: {
      ...
      sl_btmesh_evt_health_client_server_status_attention_t
        data = evt->data.evt_health_client_server_status_attention;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" result="); log_append_uint16_t(data.result);
    ...
    case sl_btmesh_evt_health_server_attention_id: {
      ...
      sl_btmesh_evt_health_server_attention_t
        data = evt->data.evt_health_server_attention;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_health_server_test_request_id: {
      ...
      sl_btmesh_evt_health_server_test_request_t
        data = evt->data.evt_health_server_test_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_generic_client_server_status_id: {
      ...
      sl_btmesh_evt_generic_client_server_status_t
        data = evt->data.evt_generic_client_server_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" model_id="); log_append_uint16_t(data.model_id);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_generic_server_client_request_id: {
      ...
      sl_btmesh_evt_generic_server_client_request_t
        data = evt->data.evt_generic_server_client_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" model_id="); log_append_uint16_t(data.model_id);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
    ...
    case sl_btmesh_evt_generic_server_state_changed_id: {
      ...
      sl_btmesh_evt_generic_server_state_changed_t
        data = evt->data.evt_generic_server_state_changed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" model_id="); log_append_uint16_t(data.model_id);
      app_log_append(" remaining_ms="); log_append_uint32_t(data.remaining_ms);
      app_log_append(" type="); log_append_uint8_t(data.type);
    ...
    case sl_btmesh_evt_generic_server_state_recall_id: {
      ...
      sl_btmesh_evt_generic_server_state_recall_t
        data = evt->data.evt_generic_server_state_recall;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" model_id="); log_append_uint16_t(data.model_id);
    ...
    case sl_btmesh_evt_test_local_heartbeat_subscription_complete_id: {
      ...
      sl_btmesh_evt_test_local_heartbeat_subscription_complete_t
        data = evt->data.evt_test_local_heartbeat_subscription_complete;
      app_log_append(" count="); log_append_uint16_t(data.count);
    ...
    case sl_btmesh_evt_test_replay_protection_list_entry_set_id: {
      ...
      sl_btmesh_evt_test_replay_protection_list_entry_set_t
        data = evt->data.evt_test_replay_protection_list_entry_set;
      app_log_append(" address="); log_append_uint16_t(data.address);
    ...
    case sl_btmesh_evt_lpn_friendship_established_id: {
      ...
      sl_btmesh_evt_lpn_friendship_established_t
        data = evt->data.evt_lpn_friendship_established;
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
    ...
    case sl_btmesh_evt_friend_friendship_established_id: {
      ...
      sl_btmesh_evt_friend_friendship_established_t
        data = evt->data.evt_friend_friendship_established;
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
    ...
    case sl_btmesh_evt_config_client_request_modified_id: {
      ...
      sl_btmesh_evt_config_client_request_modified_t
        data = evt->data.evt_config_client_request_modified;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_config_client_netkey_list_id: {
      ...
      sl_btmesh_evt_config_client_netkey_list_t
        data = evt->data.evt_config_client_netkey_list;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_appkey_status_id: {
      ...
      sl_btmesh_evt_config_client_appkey_status_t
        data = evt->data.evt_config_client_appkey_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_appkey_list_id: {
      ...
      sl_btmesh_evt_config_client_appkey_list_t
        data = evt->data.evt_config_client_appkey_list;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_appkey_list_end_id: {
      ...
      sl_btmesh_evt_config_client_appkey_list_end_t
        data = evt->data.evt_config_client_appkey_list_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_binding_status_id: {
      ...
      sl_btmesh_evt_config_client_binding_status_t
        data = evt->data.evt_config_client_binding_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_config_client_bindings_list_end_id: {
      ...
      sl_btmesh_evt_config_client_bindings_list_end_t
        data = evt->data.evt_config_client_bindings_list_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_model_pub_status_id: {
      ...
      sl_btmesh_evt_config_client_model_pub_status_t
        data = evt->data.evt_config_client_model_pub_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" address="); log_append_uint16_t(data.address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_config_client_subs_list_id: {
      ...
      sl_btmesh_evt_config_client_subs_list_t
        data = evt->data.evt_config_client_subs_list;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_subs_list_end_id: {
      ...
      sl_btmesh_evt_config_client_subs_list_end_t
        data = evt->data.evt_config_client_subs_list_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_heartbeat_pub_status_id: {
      ...
      sl_btmesh_evt_config_client_heartbeat_pub_status_t
        data = evt->data.evt_config_client_heartbeat_pub_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
    ...
    case sl_btmesh_evt_config_client_heartbeat_sub_status_id: {
      ...
      sl_btmesh_evt_config_client_heartbeat_sub_status_t
        data = evt->data.evt_config_client_heartbeat_sub_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" source_address="); log_append_uint16_t(data.source_address);
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
    ...
    case sl_btmesh_evt_config_client_beacon_status_id: {
      ...
      sl_btmesh_evt_config_client_beacon_status_t
        data = evt->data.evt_config_client_beacon_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_default_ttl_status_id: {
      ...
      sl_btmesh_evt_config_client_default_ttl_status_t
        data = evt->data.evt_config_client_default_ttl_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" value="); log_append_uint8_t(data.value);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_config_client_gatt_proxy_status_id: {
      ...
      sl_btmesh_evt_config_client_gatt_proxy_status_t
        data = evt->data.evt_config_client_gatt_proxy_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" value="); log_append_uint8_t(data.value);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_config_client_relay_status_id: {
      ...
      sl_btmesh_evt_config_client_relay_status_t
        data = evt->data.evt_config_client_relay_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_network_transmit_status_id: {
      ...
      sl_btmesh_evt_config_client_network_transmit_status_t
        data = evt->data.evt_config_client_network_transmit_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_identity_status_id: {
      ...
      sl_btmesh_evt_config_client_identity_status_t
        data = evt->data.evt_config_client_identity_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" value="); log_append_uint8_t(data.value);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_config_client_friend_status_id: {
      ...
      sl_btmesh_evt_config_client_friend_status_t
        data = evt->data.evt_config_client_friend_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" value="); log_append_uint8_t(data.value);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_config_client_key_refresh_phase_status_id: {
      ...
      sl_btmesh_evt_config_client_key_refresh_phase_status_t
        data = evt->data.evt_config_client_key_refresh_phase_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
      app_log_append(" value="); log_append_uint8_t(data.value);
    ...
    case sl_btmesh_evt_config_client_lpn_polltimeout_status_id: {
      ...
      sl_btmesh_evt_config_client_lpn_polltimeout_status_t
        data = evt->data.evt_config_client_lpn_polltimeout_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_config_client_dcd_data_id: {
      ...
      sl_btmesh_evt_config_client_dcd_data_t
        data = evt->data.evt_config_client_dcd_data;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" page="); log_append_uint8_t(data.page);
      app_log_append(" data="); log_append_uint8array(data.data);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_config_client_dcd_data_end_id: {
      ...
      sl_btmesh_evt_config_client_dcd_data_end_t
        data = evt->data.evt_config_client_dcd_data_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_reset_status_id: {
      ...
      sl_btmesh_evt_config_client_reset_status_t
        data = evt->data.evt_config_client_reset_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_config_client_obo_ack_received_id: {
      ...
      sl_btmesh_evt_config_client_obo_ack_received_t
        data = evt->data.evt_config_client_obo_ack_received;
    ...
    case sl_btmesh_evt_mbt_client_server_information_status_id: {
      ...
      sl_btmesh_evt_mbt_client_server_information_status_t
        data = evt->data.evt_mbt_client_server_information_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_mbt_client_query_information_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_query_information_complete_t
        data = evt->data.evt_mbt_client_query_information_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_mbt_client_server_transfer_status_id: {
      ...
      sl_btmesh_evt_mbt_client_server_transfer_status_t
        data = evt->data.evt_mbt_client_server_transfer_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" phase="); log_append_uint8_t(data.phase);
    ...
    case sl_btmesh_evt_mbt_client_start_transfer_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_start_transfer_complete_t
        data = evt->data.evt_mbt_client_start_transfer_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_mbt_client_server_block_status_id: {
      ...
      sl_btmesh_evt_mbt_client_server_block_status_t
        data = evt->data.evt_mbt_client_server_block_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
    ...
    case sl_btmesh_evt_mbt_client_start_block_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_start_block_complete_t
        data = evt->data.evt_mbt_client_start_block_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_mbt_client_send_chunk_request_id: {
      ...
      sl_btmesh_evt_mbt_client_send_chunk_request_t
        data = evt->data.evt_mbt_client_send_chunk_request;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_mbt_client_server_partial_block_report_id: {
      ...
      sl_btmesh_evt_mbt_client_server_partial_block_report_t
        data = evt->data.evt_mbt_client_server_partial_block_report;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" missing_chunks="); log_append_uint8array(data.missing_chunks);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_mbt_client_query_block_status_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_query_block_status_complete_t
        data = evt->data.evt_mbt_client_query_block_status_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_mbt_client_tx_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_tx_complete_t
        data = evt->data.evt_mbt_client_tx_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_mbt_client_server_failed_id: {
      ...
      sl_btmesh_evt_mbt_client_server_failed_t
        data = evt->data.evt_mbt_client_server_failed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_mbt_client_transfer_complete_id: {
      ...
      sl_btmesh_evt_mbt_client_transfer_complete_t
        data = evt->data.evt_mbt_client_transfer_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_mbt_server_state_changed_id: {
      ...
      sl_btmesh_evt_mbt_server_state_changed_t
        data = evt->data.evt_mbt_server_state_changed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_mbt_server_transfer_start_req_id: {
      ...
      sl_btmesh_evt_mbt_server_transfer_start_req_t
        data = evt->data.evt_mbt_server_transfer_start_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
      app_log_append(" blob_size="); log_append_uint32_t(data.blob_size);
    ...
    case sl_btmesh_evt_mbt_server_block_start_id: {
      ...
      sl_btmesh_evt_mbt_server_block_start_t
        data = evt->data.evt_mbt_server_block_start;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
      app_log_append(" block_number="); log_append_uint16_t(data.block_number);
    ...
    case sl_btmesh_evt_mbt_server_chunk_id: {
      ...
      sl_btmesh_evt_mbt_server_chunk_t
        data = evt->data.evt_mbt_server_chunk;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" block_number="); log_append_uint16_t(data.block_number);
    ...
    case sl_btmesh_evt_mbt_server_transfer_cancel_id: {
      ...
      sl_btmesh_evt_mbt_server_transfer_cancel_t
        data = evt->data.evt_mbt_server_transfer_cancel;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_mbt_server_partial_block_report_tx_complete_id: {
      ...
      sl_btmesh_evt_mbt_server_partial_block_report_tx_complete_t
        data = evt->data.evt_mbt_server_partial_block_report_tx_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_sensor_server_get_request_id: {
      ...
      sl_btmesh_evt_sensor_server_get_request_t
        data = evt->data.evt_sensor_server_get_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_server_get_column_request_id: {
      ...
      sl_btmesh_evt_sensor_server_get_column_request_t
        data = evt->data.evt_sensor_server_get_column_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_server_get_series_request_id: {
      ...
      sl_btmesh_evt_sensor_server_get_series_request_t
        data = evt->data.evt_sensor_server_get_series_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_server_publish_id: {
      ...
      sl_btmesh_evt_sensor_server_publish_t
        data = evt->data.evt_sensor_server_publish;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" period_ms="); log_append_uint32_t(data.period_ms);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_sensor_setup_server_get_cadence_request_id: {
      ...
      sl_btmesh_evt_sensor_setup_server_get_cadence_request_t
        data = evt->data.evt_sensor_setup_server_get_cadence_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_setup_server_set_cadence_request_id: {
      ...
      sl_btmesh_evt_sensor_setup_server_set_cadence_request_t
        data = evt->data.evt_sensor_setup_server_set_cadence_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_setup_server_get_setting_request_id: {
      ...
      sl_btmesh_evt_sensor_setup_server_get_setting_request_t
        data = evt->data.evt_sensor_setup_server_get_setting_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_setup_server_set_setting_request_id: {
      ...
      sl_btmesh_evt_sensor_setup_server_set_setting_request_t
        data = evt->data.evt_sensor_setup_server_set_setting_request;
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_setup_server_publish_id: {
      ...
      sl_btmesh_evt_sensor_setup_server_publish_t
        data = evt->data.evt_sensor_setup_server_publish;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" period_ms="); log_append_uint32_t(data.period_ms);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_sensor_client_descriptor_status_id: {
      ...
      sl_btmesh_evt_sensor_client_descriptor_status_t
        data = evt->data.evt_sensor_client_descriptor_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_cadence_status_id: {
      ...
      sl_btmesh_evt_sensor_client_cadence_status_t
        data = evt->data.evt_sensor_client_cadence_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_settings_status_id: {
      ...
      sl_btmesh_evt_sensor_client_settings_status_t
        data = evt->data.evt_sensor_client_settings_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_status_id: {
      ...
      sl_btmesh_evt_sensor_client_status_t
        data = evt->data.evt_sensor_client_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_column_status_id: {
      ...
      sl_btmesh_evt_sensor_client_column_status_t
        data = evt->data.evt_sensor_client_column_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_series_status_id: {
      ...
      sl_btmesh_evt_sensor_client_series_status_t
        data = evt->data.evt_sensor_client_series_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_sensor_client_publish_id: {
      ...
      sl_btmesh_evt_sensor_client_publish_t
        data = evt->data.evt_sensor_client_publish;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" period_ms="); log_append_uint32_t(data.period_ms);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_fw_update_client_info_status_current_fwid_id: {
      ...
      sl_btmesh_evt_fw_update_client_info_status_current_fwid_t
        data = evt->data.evt_fw_update_client_info_status_current_fwid;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_fw_update_client_info_status_update_uri_id: {
      ...
      sl_btmesh_evt_fw_update_client_info_status_update_uri_t
        data = evt->data.evt_fw_update_client_info_status_update_uri;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" index="); log_append_uint8_t(data.index);
      app_log_append(" count="); log_append_uint8_t(data.count);
    ...
    case sl_btmesh_evt_fw_update_client_update_status_id: {
      ...
      sl_btmesh_evt_fw_update_client_update_status_t
        data = evt->data.evt_fw_update_client_update_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" phase="); log_append_uint8_t(data.phase);
    ...
    case sl_btmesh_evt_fw_update_client_metadata_status_id: {
      ...
      sl_btmesh_evt_fw_update_client_metadata_status_t
        data = evt->data.evt_fw_update_client_metadata_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" additional_information="); log_append_uint8_t(data.additional_information);
    ...
    case sl_btmesh_evt_lc_client_mode_status_id: {
      ...
      sl_btmesh_evt_lc_client_mode_status_t
        data = evt->data.evt_lc_client_mode_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_client_om_status_id: {
      ...
      sl_btmesh_evt_lc_client_om_status_t
        data = evt->data.evt_lc_client_om_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_client_light_onoff_status_id: {
      ...
      sl_btmesh_evt_lc_client_light_onoff_status_t
        data = evt->data.evt_lc_client_light_onoff_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_client_property_status_id: {
      ...
      sl_btmesh_evt_lc_client_property_status_t
        data = evt->data.evt_lc_client_property_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_server_mode_updated_id: {
      ...
      sl_btmesh_evt_lc_server_mode_updated_t
        data = evt->data.evt_lc_server_mode_updated;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_server_om_updated_id: {
      ...
      sl_btmesh_evt_lc_server_om_updated_t
        data = evt->data.evt_lc_server_om_updated;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_server_occupancy_updated_id: {
      ...
      sl_btmesh_evt_lc_server_occupancy_updated_t
        data = evt->data.evt_lc_server_occupancy_updated;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" source_address="); log_append_uint16_t(data.source_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_server_ambient_lux_level_updated_id: {
      ...
      sl_btmesh_evt_lc_server_ambient_lux_level_updated_t
        data = evt->data.evt_lc_server_ambient_lux_level_updated;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" source_address="); log_append_uint16_t(data.source_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_lc_server_linear_output_updated_id: {
      ...
      sl_btmesh_evt_lc_server_linear_output_updated_t
        data = evt->data.evt_lc_server_linear_output_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_lc_server_state_updated_id: {
      ...
      sl_btmesh_evt_lc_server_state_updated_t
        data = evt->data.evt_lc_server_state_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" state="); log_append_uint8_t(data.state);
    ...
    case sl_btmesh_evt_lc_server_regulator_debug_info_id: {
      ...
      sl_btmesh_evt_lc_server_regulator_debug_info_t
        data = evt->data.evt_lc_server_regulator_debug_info;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_lc_setup_server_set_property_id: {
      ...
      sl_btmesh_evt_lc_setup_server_set_property_t
        data = evt->data.evt_lc_setup_server_set_property;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scene_client_status_id: {
      ...
      sl_btmesh_evt_scene_client_status_t
        data = evt->data.evt_scene_client_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scene_client_register_status_id: {
      ...
      sl_btmesh_evt_scene_client_register_status_t
        data = evt->data.evt_scene_client_register_status;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scene_server_get_id: {
      ...
      sl_btmesh_evt_scene_server_get_t
        data = evt->data.evt_scene_server_get;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scene_server_register_get_id: {
      ...
      sl_btmesh_evt_scene_server_register_get_t
        data = evt->data.evt_scene_server_register_get;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scene_server_recall_id: {
      ...
      sl_btmesh_evt_scene_server_recall_t
        data = evt->data.evt_scene_server_recall;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_scene_server_publish_id: {
      ...
      sl_btmesh_evt_scene_server_publish_t
        data = evt->data.evt_scene_server_publish;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" period_ms="); log_append_uint32_t(data.period_ms);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_scene_server_compact_recall_id: {
      ...
      sl_btmesh_evt_scene_server_compact_recall_t
        data = evt->data.evt_scene_server_compact_recall;
    ...
    case sl_btmesh_evt_scene_setup_server_store_id: {
      ...
      sl_btmesh_evt_scene_setup_server_store_t
        data = evt->data.evt_scene_setup_server_store;
      app_log_append(" destination_address="); log_append_uint16_t(data.destination_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_scheduler_client_status_id: {
      ...
      sl_btmesh_evt_scheduler_client_status_t
        data = evt->data.evt_scheduler_client_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scheduler_client_action_status_id: {
      ...
      sl_btmesh_evt_scheduler_client_action_status_t
        data = evt->data.evt_scheduler_client_action_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_scheduler_server_scene_changed_id: {
      ...
      sl_btmesh_evt_scheduler_server_scene_changed_t
        data = evt->data.evt_scheduler_server_scene_changed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" transition_time_ms="); log_append_uint32_t(data.transition_time_ms);
      app_log_append(" scene_number="); log_append_uint16_t(data.scene_number);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_scheduler_server_action_triggered_id: {
      ...
      sl_btmesh_evt_scheduler_server_action_triggered_t
        data = evt->data.evt_scheduler_server_action_triggered;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" index="); log_append_uint8_t(data.index);
      app_log_append(" action="); log_append_uint8_t(data.action);
      app_log_append(" transition_time_ms="); log_append_uint32_t(data.transition_time_ms);
    ...
    case sl_btmesh_evt_fw_update_server_check_fw_metadata_req_id: {
      ...
      sl_btmesh_evt_fw_update_server_check_fw_metadata_req_t
        data = evt->data.evt_fw_update_server_check_fw_metadata_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" fw_index="); log_append_uint8_t(data.fw_index);
    ...
    case sl_btmesh_evt_fw_update_server_update_start_req_id: {
      ...
      sl_btmesh_evt_fw_update_server_update_start_req_t
        data = evt->data.evt_fw_update_server_update_start_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
      app_log_append(" fw_index="); log_append_uint8_t(data.fw_index);
    ...
    case sl_btmesh_evt_fw_update_server_verify_fw_req_id: {
      ...
      sl_btmesh_evt_fw_update_server_verify_fw_req_t
        data = evt->data.evt_fw_update_server_verify_fw_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_update_server_apply_id: {
      ...
      sl_btmesh_evt_fw_update_server_apply_t
        data = evt->data.evt_fw_update_server_apply;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_update_server_update_cancelled_id: {
      ...
      sl_btmesh_evt_fw_update_server_update_cancelled_t
        data = evt->data.evt_fw_update_server_update_cancelled;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_update_server_distributor_self_update_req_id: {
      ...
      sl_btmesh_evt_fw_update_server_distributor_self_update_req_t
        data = evt->data.evt_fw_update_server_distributor_self_update_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" fw_index="); log_append_uint8_t(data.fw_index);
    ...
    case sl_btmesh_evt_time_server_time_updated_id: {
      ...
      sl_btmesh_evt_time_server_time_updated_t
        data = evt->data.evt_time_server_time_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_time_server_time_zone_offset_updated_id: {
      ...
      sl_btmesh_evt_time_server_time_zone_offset_updated_t
        data = evt->data.evt_time_server_time_zone_offset_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_time_server_tai_utc_delta_updated_id: {
      ...
      sl_btmesh_evt_time_server_tai_utc_delta_updated_t
        data = evt->data.evt_time_server_tai_utc_delta_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_time_server_time_role_updated_id: {
      ...
      sl_btmesh_evt_time_server_time_role_updated_t
        data = evt->data.evt_time_server_time_role_updated;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
    ...
    case sl_btmesh_evt_time_client_time_status_id: {
      ...
      sl_btmesh_evt_time_client_time_status_t
        data = evt->data.evt_time_client_time_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_time_client_time_zone_status_id: {
      ...
      sl_btmesh_evt_time_client_time_zone_status_t
        data = evt->data.evt_time_client_time_zone_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_time_client_tai_utc_delta_status_id: {
      ...
      sl_btmesh_evt_time_client_tai_utc_delta_status_t
        data = evt->data.evt_time_client_tai_utc_delta_status;
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" appkey_index="); log_append_uint16_t(data.appkey_index);
    ...
    case sl_btmesh_evt_fw_dist_server_dist_start_req_id: {
      ...
      sl_btmesh_evt_fw_dist_server_dist_start_req_t
        data = evt->data.evt_fw_dist_server_dist_start_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
    ...
    case sl_btmesh_evt_fw_dist_server_dist_cancel_id: {
      ...
      sl_btmesh_evt_fw_dist_server_dist_cancel_t
        data = evt->data.evt_fw_dist_server_dist_cancel;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_dist_server_dist_cancel_complete_id: {
      ...
      sl_btmesh_evt_fw_dist_server_dist_cancel_complete_t
        data = evt->data.evt_fw_dist_server_dist_cancel_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_fw_dist_server_upload_cancel_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_cancel_t
        data = evt->data.evt_fw_dist_server_upload_cancel;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_fw_dist_server_node_failed_id: {
      ...
      sl_btmesh_evt_fw_dist_server_node_failed_t
        data = evt->data.evt_fw_dist_server_node_failed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" address="); log_append_uint16_t(data.address);
    ...
    case sl_btmesh_evt_fw_dist_server_upload_complete_metadata_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_complete_metadata_t
        data = evt->data.evt_fw_dist_server_upload_complete_metadata;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" metadata="); log_append_uint8array(data.metadata);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_fw_dist_server_upload_complete_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_complete_t
        data = evt->data.evt_fw_dist_server_upload_complete;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" size="); log_append_uint32_t(data.size);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
    ...
    case sl_btmesh_evt_fw_dist_server_upload_failed_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_failed_t
        data = evt->data.evt_fw_dist_server_upload_failed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" size="); log_append_uint32_t(data.size);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
    ...
    case sl_btmesh_evt_fw_dist_server_upload_oob_start_uri_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_oob_start_uri_t
        data = evt->data.evt_fw_dist_server_upload_oob_start_uri;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
    ...
    case sl_btmesh_evt_fw_dist_server_upload_oob_start_req_id: {
      ...
      sl_btmesh_evt_fw_dist_server_upload_oob_start_req_t
        data = evt->data.evt_fw_dist_server_upload_oob_start_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" fwid="); log_append_uint8array(data.fwid);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_fw_dist_server_fw_delete_req_id: {
      ...
      sl_btmesh_evt_fw_dist_server_fw_delete_req_t
        data = evt->data.evt_fw_dist_server_fw_delete_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" fwid="); log_append_uint8array(data.fwid);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_fw_dist_server_fw_delete_all_req_id: {
      ...
      sl_btmesh_evt_fw_dist_server_fw_delete_all_req_t
        data = evt->data.evt_fw_dist_server_fw_delete_all_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_dist_server_dist_suspend_id: {
      ...
      sl_btmesh_evt_fw_dist_server_dist_suspend_t
        data = evt->data.evt_fw_dist_server_dist_suspend;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_fw_dist_server_resume_req_id: {
      ...
      sl_btmesh_evt_fw_dist_server_resume_req_t
        data = evt->data.evt_fw_dist_server_resume_req;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" group_address="); log_append_uint16_t(data.group_address);
    ...
    case sl_btmesh_evt_fw_dist_client_receivers_status_id: {
      ...
      sl_btmesh_evt_fw_dist_client_receivers_status_t
        data = evt->data.evt_fw_dist_client_receivers_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
    ...
    case sl_btmesh_evt_fw_dist_client_receivers_list_id: {
      ...
      sl_btmesh_evt_fw_dist_client_receivers_list_t
        data = evt->data.evt_fw_dist_client_receivers_list;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" index="); log_append_uint16_t(data.index);
      app_log_append(" nodes_list_size="); log_append_uint16_t(data.nodes_list_size);
    ...
    case sl_btmesh_evt_fw_dist_client_receivers_list_end_id: {
      ...
      sl_btmesh_evt_fw_dist_client_receivers_list_end_t
        data = evt->data.evt_fw_dist_client_receivers_list_end;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_fw_dist_client_capabilities_status_id: {
      ...
      sl_btmesh_evt_fw_dist_client_capabilities_status_t
        data = evt->data.evt_fw_dist_client_capabilities_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_fw_dist_client_distribution_status_id: {
      ...
      sl_btmesh_evt_fw_dist_client_distribution_status_t
        data = evt->data.evt_fw_dist_client_distribution_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" phase="); log_append_uint8_t(data.phase);
    ...
    case sl_btmesh_evt_fw_dist_client_upload_status_id: {
      ...
      sl_btmesh_evt_fw_dist_client_upload_status_t
        data = evt->data.evt_fw_dist_client_upload_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" phase="); log_append_uint8_t(data.phase);
    ...
    case sl_btmesh_evt_fw_dist_client_fw_status_id: {
      ...
      sl_btmesh_evt_fw_dist_client_fw_status_t
        data = evt->data.evt_fw_dist_client_fw_status;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
      app_log_append(" status="); log_append_uint8_t(data.status);
    ...
    case sl_btmesh_evt_fw_dist_client_upload_failed_id: {
      ...
      sl_btmesh_evt_fw_dist_client_upload_failed_t
        data = evt->data.evt_fw_dist_client_upload_failed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" server_address="); log_append_uint16_t(data.server_address);
    ...
    case sl_btmesh_evt_remote_provisioning_client_scan_capabilities_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_scan_capabilities_t
        data = evt->data.evt_remote_provisioning_client_scan_capabilities;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" server="); log_append_uint16_t(data.server);
    ...
    case sl_btmesh_evt_remote_provisioning_client_scan_status_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_scan_status_t
        data = evt->data.evt_remote_provisioning_client_scan_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" state="); log_append_uint8_t(data.state);
    ...
    case sl_btmesh_evt_remote_provisioning_client_scan_report_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_scan_report_t
        data = evt->data.evt_remote_provisioning_client_scan_report;
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" rssi="); log_append_int8_t(data.rssi);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
    ...
    case sl_btmesh_evt_remote_provisioning_client_extended_scan_report_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_extended_scan_report_t
        data = evt->data.evt_remote_provisioning_client_extended_scan_report;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" uuid="); log_append_uuid_128(data.uuid);
    ...
    case sl_btmesh_evt_remote_provisioning_client_link_status_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_link_status_t
        data = evt->data.evt_remote_provisioning_client_link_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" state="); log_append_uint8_t(data.state);
    ...
    case sl_btmesh_evt_remote_provisioning_client_link_report_id: {
      ...
      sl_btmesh_evt_remote_provisioning_client_link_report_t
        data = evt->data.evt_remote_provisioning_client_link_report;
      app_log_append(" server="); log_append_uint16_t(data.server);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" state="); log_append_uint8_t(data.state);
      app_log_append(" reason="); log_append_uint8_t(data.reason);
    ...
    case sl_btmesh_evt_remote_provisioning_server_link_open_request_id: {
      ...
      sl_btmesh_evt_remote_provisioning_server_link_open_request_t
        data = evt->data.evt_remote_provisioning_server_link_open_request;
      app_log_append(" address="); log_append_bd_addr(data.address);
      app_log_append(" address_type="); log_append_uint8_t(data.address_type);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_remote_provisioning_server_link_close_request_id: {
      ...
      sl_btmesh_evt_remote_provisioning_server_link_close_request_t
        data = evt->data.evt_remote_provisioning_server_link_close_request;
    ...
    case sl_btmesh_evt_fw_standalone_updater_dist_state_changed_id: {
      ...
      sl_btmesh_evt_fw_standalone_updater_dist_state_changed_t
        data = evt->data.evt_fw_standalone_updater_dist_state_changed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" state="); log_append_uint8_t(data.state);
      app_log_append(" num_active_nodes="); log_append_uint16_t(data.num_active_nodes);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_fw_standalone_updater_node_failed_id: {
      ...
      sl_btmesh_evt_fw_standalone_updater_node_failed_t
        data = evt->data.evt_fw_standalone_updater_node_failed;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" address="); log_append_uint16_t(data.address);
      app_log_append(" update_phase="); log_append_uint8_t(data.update_phase);
      app_log_append(" update_status="); log_append_uint8_t(data.update_status);
    ...
    case sl_btmesh_evt_ncp_fw_list_fw_deleted_id: {
      ...
      sl_btmesh_evt_ncp_fw_list_fw_deleted_t
        data = evt->data.evt_ncp_fw_list_fw_deleted;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" fwid="); log_append_uint8array(data.fwid);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_ncp_fw_list_fw_all_deleted_id: {
      ...
      sl_btmesh_evt_ncp_fw_list_fw_all_deleted_t
        data = evt->data.evt_ncp_fw_list_fw_all_deleted;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" client_address="); log_append_uint16_t(data.client_address);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_ncp_fw_list_fw_added_id: {
      ...
      sl_btmesh_evt_ncp_fw_list_fw_added_t
        data = evt->data.evt_ncp_fw_list_fw_added;
      app_log_append(" elem_index="); log_append_uint16_t(data.elem_index);
      app_log_append(" size="); log_append_uint32_t(data.size);
      app_log_append(" blob_id="); log_append_sl_bt_uuid_64_t(data.blob_id);
      app_log_append(" fwid="); log_append_uint8array(data.fwid);
    ...
    case sl_btmesh_evt_sar_config_server_sar_transmitter_set_id: {
      ...
      sl_btmesh_evt_sar_config_server_sar_transmitter_set_t
        data = evt->data.evt_sar_config_server_sar_transmitter_set;
      app_log_append(" segment_interval_step="); log_append_uint8_t(data.segment_interval_step);
      app_log_append(" unicast_retrans_count="); log_append_uint8_t(data.unicast_retrans_count);
      app_log_append(" unicast_retrans_wo_progress_count="); log_append_uint8_t(data.unicast_retrans_wo_progress_count);
      app_log_append(" unicast_retrans_interval_step="); log_append_uint16_t(data.unicast_retrans_interval_step);
    ...
    case sl_btmesh_evt_sar_config_server_sar_receiver_set_id: {
      ...
      sl_btmesh_evt_sar_config_server_sar_receiver_set_t
        data = evt->data.evt_sar_config_server_sar_receiver_set;
      app_log_append(" segments_threshold="); log_append_uint8_t(data.segments_threshold);
      app_log_append(" ack_delay_increment="); log_append_uint8_t(data.ack_delay_increment);
      app_log_append(" discard_timeout="); log_append_uint32_t(data.discard_timeout);
      app_log_append(" segment_interval_step="); log_append_uint8_t(data.segment_interval_step);
    ...
    case sl_btmesh_evt_private_beacon_client_gatt_proxy_status_id: {
      ...
      sl_btmesh_evt_private_beacon_client_gatt_proxy_status_t
        data = evt->data.evt_private_beacon_client_gatt_proxy_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" state="); log_append_uint8_t(data.state);
      app_log_append(" )" NL);
    ...
    case sl_btmesh_evt_private_beacon_client_identity_status_id: {
      ...
      sl_btmesh_evt_private_beacon_client_identity_status_t
        data = evt->data.evt_private_beacon_client_identity_status;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" status="); log_append_uint8_t(data.status);
      app_log_append(" netkey_index="); log_append_uint16_t(data.netkey_index);
    ...
    case sl_btmesh_evt_lcd_client_data_header_id: {
      ...
      sl_btmesh_evt_lcd_client_data_header_t
        data = evt->data.evt_lcd_client_data_header;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
    ...
    case sl_btmesh_evt_lcd_client_data_id: {
      ...
      sl_btmesh_evt_lcd_client_data_t
        data = evt->data.evt_lcd_client_data;
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" data="); log_append_uint8array(data.data);
      app_log_append(" )" NL);
    } break;
    case sl_btmesh_evt_lcd_client_data_end_id: {
      ...
      sl_btmesh_evt_lcd_client_data_end_t
        data = evt->data.evt_lcd_client_data_end;
      app_log_append(" result="); log_append_uint16_t(data.result);
      app_log_append(" handle="); log_append_uint32_t(data.handle);
      app_log_append(" )" NL);
    } break;
    ...
    case sl_btmesh_evt_solicitation_config_client_items_status_id: {
      ...
      sl_btmesh_evt_solicitation_config_client_items_status_t
        data = evt->data.evt_solicitation_config_client_items_status;
    ...
    case sl_btmesh_evt_silabs_config_server_tx_changed_id: {
      ...
      sl_btmesh_evt_silabs_config_server_tx_changed_t
        data = evt->data.evt_silabs_config_server_tx_changed;
