...
// <h> Remote Provisioning Client configuration

// <q SL_BTMESH_REMOTE_PROVISIONING_CLIENT_LOGGING_CFG_VAL> Enable Logging
// <i> Default: 0
// <i> Enable / disable Logging for remote provisioning client model specific messages for this component
