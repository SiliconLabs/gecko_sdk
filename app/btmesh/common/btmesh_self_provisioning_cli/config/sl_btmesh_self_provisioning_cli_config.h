...
// <h> Self Provisioning configuration

// <e SL_BTMESH_SELF_PROVISIONING_CLI_LOGGING_CFG_VAL> Enable Logging
// <i> Default: 1
// <i> Enable / disable UART Logging for Self Provisioning specific messages for this component.
