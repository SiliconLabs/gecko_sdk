...
## Testing the Bluetooth Mesh - SoC Light CTL Application

To test the application, do the following:

1. Make sure a bootloader is installed. See the Troubleshooting section.
2. Build and flash the **Bluetooth Mesh - SoC Light CTL** example to your device.
