/***************************************************************************//**
 * @file
 * @brief i2cspm micriumos examples functions
 *******************************************************************************
 * # License
...
static OS_TCB tcb;
static CPU_STK stack[I2CSPM_TASK_STACK_SIZE];
...
void i2cspm_init(void)
{
  ...
  printf("\r\nWelcome to the I2C SPM sample application using Micrium OS\r\n\r\n");
