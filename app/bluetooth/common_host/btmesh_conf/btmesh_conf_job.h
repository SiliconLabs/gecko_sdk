...
struct btmesh_conf_job_t {
  ...
  /// BTMESH_CONF_JOB_AUTO_DESTROY_ON_SUBMIT_FAILURE is turned on
 ...
 *   - @a auto_destroy: @ref BTMESH_CONF_JOB_AUTO_DESTROY
 *   - @a job_id: NULL
 ******************************************************************************/
 ...
 *   If @ref btmesh_conf_submit_job operation fails and the definition
 *   @ref BTMESH_CONF_JOB_AUTO_DESTROY_ON_SUBMIT_FAILURE is turned on then the
