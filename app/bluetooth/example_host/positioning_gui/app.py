...
#      self.w.addItem(ygrid)
  ...
  def plot_marker(self, tag_id):
    ...
    if "marker" not in self.tags[tag_id]:
      # Draw new marker
      if PLOT_VIEW_3D:
        self.tags[tag_id]["marker"] = gl.GLScatterPlotItem(pos=pos, color=color, size=40)
        ...
        self.tags[tag_id]["marker"] = pg.ScatterPlotItem(pen=pg.mkPen(width=1), brush=brushColor, symbol='o', size=40)
