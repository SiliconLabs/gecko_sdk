...
/// MAC address length in AABBCCDD format
#define MAC_LEN_WITHOUT_SEPARATORS  12
/// MAC address length in AA:BB:CC:DD format
#define MAC_LEN_WITH_SEPARATORS     17
...
/***************************************************************************/ /**
 * Parse MAC address from the given string
 *
 * @param[in] input The string to parse
 * @param[in] length Length of the string
 * @param[out] mac The variable to fill with the parsed data
 ******************************************************************************/
