...
#ifndef SL_SENSOR_LIGHT_LUX_MOCK_H
#define SL_SENSOR_LIGHT_LUX_MOCK_H
 ...
 * @param[in] lux Ambient light illuminance (in lux).
 * @param[in] uvi UV index.
 *****************************************************************************/
...
#endif // SL_SENSOR_LIGHT_LUX_MOCK_H
