...
// <o SENSOR_LIGHT_POSITIVE_TOLERANCE> Positive tolerance of sensor.
// <0-4095:1>
...
#define SENSOR_LIGHT_POSITIVE_TOLERANCE 0

// <o SENSOR_LIGHT_NEGATIVE_TOLERANCE> Negative tolerance of sensor.
// <0-4095:1>
// <i> Default: 0 (Unspecified)
// <i> 12-bit Negative Tolerance value (1 - 4095) or Unspecified (0). The value is derived as ERR_N [%] = 100 [%] * x / 4095
#define SENSOR_LIGHT_NEGATIVE_TOLERANCE 0

// <o SENSOR_LIGHT_SAMPLING_FUNCTION> Sampling function
...
#define SENSOR_LIGHT_SAMPLING_FUNCTION       SAMPLING_UNSPECIFIED

// <o SENSOR_LIGHT_MEASUREMENT_PERIOD> Measurement Period of sensor.
// <0-255:1>
// <i> Default: 0 (Not Applicable)
// <i> 8 bit value (1 - 255) or Not Applicable (0). Time period in seconds is derived as T [s] = 1.1 ^ (x - 64)
#define SENSOR_LIGHT_MEASUREMENT_PERIOD 0

// <o SENSOR_LIGHT_UPDATE_INTERVAL> Update Interval of sensor.
// <0-255:1>
// <i> Default: 0 (Not Applicable)
// <i> 8 bit value (1 - 255) or Not Applicable (0). Update interval in seconds is derived as I [s] = 1.1 ^ (x - 64)
#define SENSOR_LIGHT_UPDATE_INTERVAL 0
