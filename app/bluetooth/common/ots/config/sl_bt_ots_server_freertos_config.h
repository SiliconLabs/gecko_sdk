/***************************************************************************//**
 * @file
 * @brief OTS Server FreeRTOS adaptation configuration file
 *******************************************************************************
 * # License
...
// <o SL_BT_OTS_SERVER_TASK_STACK> OTS Server task stack size in words
// <i> Default: 1024
// <i> Define the stack size of the OTS Server task in words.
#define SL_BT_OTS_SERVER_TASK_STACK        1024
