...
#define SL_BT_OTS_OBJECT_PROPERTY_RFU_MASK                                              ~(SL_BT_OTS_OBJECT_PROPERTY_DELETE_MASK     \
...
SL_ENUM(sl_bt_ots_oacp_opcode_t) {
  SL_BT_OTS_OACP_OPCODE_INVALID            = 0x00, ///< Invalid OACP opcode
...
SL_ENUM(sl_bt_ots_transfer_result_t) {
  ...
  SL_BT_OTS_TRANSFER_FINISHED_RESPONSE_CODE_ABORTED         = 0x04  ///< Aborted.
};
