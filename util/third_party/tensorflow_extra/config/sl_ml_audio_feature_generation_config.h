...
#ifdef SL_DEFAULT_MODEL_FE_SAMPLE_RATE_HZ
// Use configurations from tflite model file 
#define SL_ML_FRONTEND_SAMPLE_RATE_HZ                         SL_DEFAULT_MODEL_FE_SAMPLE_RATE_HZ
#define SL_ML_FRONTEND_SAMPLE_LENGTH_MS                       SL_DEFAULT_MODEL_FE_SAMPLE_LENGTH_MS
#define SL_ML_FRONTEND_WINDOW_SIZE_MS                         SL_DEFAULT_MODEL_FE_WINDOW_SIZE_MS
#define SL_ML_FRONTEND_WINDOW_STEP_MS                         SL_DEFAULT_MODEL_FE_WINDOW_STEP_MS
#define SL_ML_FRONTEND_FFT_LENGTH                             SL_DEFAULT_MODEL_FE_FFT_LENGTH
#define SL_ML_FRONTEND_FILTERBANK_N_CHANNELS                  SL_DEFAULT_MODEL_FE_FILTERBANK_N_CHANNELS
#define SL_ML_FRONTEND_FILTERBANK_LOWER_BAND_LIMIT            SL_DEFAULT_MODEL_FE_FILTERBANK_LOWER_BAND_LIMIT
#define SL_ML_FRONTEND_FILTERBANK_UPPER_BAND_LIMIT            SL_DEFAULT_MODEL_FE_FILTERBANK_UPPER_BAND_LIMIT
#define SL_ML_FRONTEND_NOISE_REDUCTION_ENABLE                 SL_DEFAULT_MODEL_FE_NOISE_REDUCTION_ENABLE
#define SL_ML_FRONTEND_NOISE_REDUCTION_SMOOTHING_BITS         SL_DEFAULT_MODEL_FE_NOISE_REDUCTION_SMOOTHING_BITS
#define SL_ML_FRONTEND_NOISE_REDUCTION_EVEN_SMOOTHING         SL_DEFAULT_MODEL_FE_NOISE_REDUCTION_EVEN_SMOOTHING
#define SL_ML_FRONTEND_NOISE_REDUCTION_ODD_SMOOTHING          SL_DEFAULT_MODEL_FE_NOISE_REDUCTION_ODD_SMOOTHING
#define SL_ML_FRONTEND_NOISE_REDUCTION_MIN_SIGNAL_REMAINING   SL_DEFAULT_MODEL_FE_NOISE_REDUCTION_MIN_SIGNAL_REMAINING
#define SL_ML_FRONTEND_PCAN_ENABLE                            SL_DEFAULT_MODEL_FE_PCAN_ENABLE
#define SL_ML_FRONTEND_PCAN_STRENGTH                          SL_DEFAULT_MODEL_FE_PCAN_STRENGTH
#define SL_ML_FRONTEND_PCAN_OFFSET                            SL_DEFAULT_MODEL_FE_PCAN_OFFSET
#define SL_ML_FRONTEND_PCAN_GAIN_BITS                         SL_DEFAULT_MODEL_FE_PCAN_GAIN_BITS
#define SL_ML_FRONTEND_LOG_SCALE_ENABLE                       SL_DEFAULT_MODEL_FE_LOG_SCALE_ENABLE
#define SL_ML_FRONTEND_LOG_SCALE_SHIFT                        SL_DEFAULT_MODEL_FE_LOG_SCALE_SHIFT
#else 
#error No frontend configurations were found in the model, enable manual configurations in "sl_ml_audio_feature_generation_config.h"
#endif // SL_DEFAULT_MODEL_FE_SAMPLE_RATE
