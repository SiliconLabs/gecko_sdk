 ...
 * flatbuffer file given in the configuration. This includes an opsResolver 
...
/***************************************************************************//**
 * @brief
 *  Get a pointer to the opcode resolver for the flatbuffer given by the configuraton.
 *
