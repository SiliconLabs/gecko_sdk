...
static psa_status_t psa_validate_tag_length( psa_key_attributes_t *attributes,
                                             psa_algorithm_t alg ) {
    uint8_t tag_len = PSA_AEAD_TAG_LENGTH(psa_get_key_type(attributes),
                                    ...
                                    psa_algorithm_t alg )
{
    ...
    if( ( status = psa_validate_tag_length( &attributes, alg ) ) != PSA_SUCCESS )
        goto exit;
