...
static const app_enum_t app_settings_wisun_channel_mask_enum[] =
{
  { "none", APP_SETTINGS_WISUN_CHANNEL_MASK_NONE },
  { "all", APP_SETTINGS_WISUN_CHANNEL_MASK_ALL },
  { NULL, 0 }
};
...
static sl_status_t app_settings_get_phy(char *value_str,
                                        const char *key_str,
                                        const app_settings_entry_t *entry);
static sl_status_t app_settings_set_unicast_channel_mask(const char *value_str,
                                                         const char *key_str,
                                                         const app_settings_entry_t *entry);
static sl_status_t app_settings_get_unicast_channel_mask(char *value_str,
                                                         const char *key_str,
                                                         const app_settings_entry_t *entry);
...
const app_settings_entry_t app_settings_entries[] =
{
  ...
  },
  {
    ...
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = NULL,
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_unicast_channel_mask,
    .get_handler = app_settings_get_unicast_channel_mask,
    .description = "Excluded channel list, 1 bit per channel"
  },
  {
    .key = "phy",
...
static const app_settings_entry_t app_unicast_channel_mask_entries[] = {
  {
    .key = "000-031",
    .domain = app_settings_domain_wisun,
    .value_size = APP_SETTINGS_VALUE_SIZE_UINT32,
    ...
    .value = &app_settings_wisun.channel_mask.mask[0],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 000-031 [uint32]"
  },
  {
    .key = "032-063",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[4],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 032-063 [uint32]"
  },
  {
    .key = "064-095",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[8],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 064-095 [uint32]"
  },
  {
    .key = "096-127",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[12],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 096-127 [uint32]"
  },
  {
    .key = "128-159",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[16],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 128-159 [uint32]"
  },
  {
    .key = "160-191",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[20],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 160-191 [uint32]"
  },
  {
    .key = "192-223",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[24],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 192-223 [uint32]"
  },
  {
    .key = "224-255",
    .domain = app_settings_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT | APP_SETTINGS_OUTPUT_FLAG_HEX | APP_SETTINGS_OUTPUT_FLAG_FIXEDSIZE,
    .value = &app_settings_wisun.channel_mask.mask[28],
    .input_enum_list = app_settings_wisun_channel_mask_enum,
    .output_enum_list = NULL,
    .set_handler = app_settings_set_integer,
    .get_handler = app_settings_get_integer,
    .description = "Channel mask 224-255 [uint32]"
  },
  {
    .key = NULL,
    .domain = 0,
...
static const app_settings_entry_t app_statistics_entries[] =
{
  ...
  },
  {
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = &app_statistics.wisun.asynch_rx_count,
    .input_enum_list = NULL,
    .output_enum_list = NULL,
    .set_handler = NULL,
    .get_handler = app_settings_get_integer,
    .description = "Asynch rx count"
  },
  {
    .key = "asynch_tx_count",
    .domain = app_statistics_domain_wisun,
    ...
    .input = APP_SETTINGS_INPUT_FLAG_DEFAULT,
    .output = APP_SETTINGS_OUTPUT_FLAG_DEFAULT,
    .value = &app_statistics.wisun.asynch_tx_count,
    .input_enum_list = NULL,
    .output_enum_list = NULL,
    .set_handler = NULL,
    .get_handler = app_settings_get_integer,
    .description = "Asynch tx count"
  },
  {
    .key = "ip_rx_count",
                                               ...
                                               const app_settings_entry_t *entry)
{
  ...
  if (ret != SL_STATUS_OK) {
    printf("[Failed to retrieve statistics: %lu", ret);
    return SL_STATUS_FAIL;
  }
    ...
    if (!strcmp(entry->key, app_statistics_domain_str[iter->domain])) {
      if (!key_str || !strcmp(iter->key, key_str)) {
        if (iter->get_handler) {
          ...
          if (ret == SL_STATUS_OK) {
            printf("%s.%s.%s = %s\r\n", app_settings_domain_str[entry->domain], app_statistics_domain_str[iter->domain], iter->key, stat_value_str);
          }
        }
      }
    }
                                                         ...
                                                         const app_settings_entry_t *entry)
{
  ...
  if (!key_str) {
    value_enum = app_util_get_enum_by_string(entry->input_enum_list, value_str);
    if (value_enum) {
      // Enumeration applies to all channel mask entries, just
      // fall through.
    } else {
      // Not an enumeration, attempt to use it as a single channel value.
      ret = app_util_get_integer(&channel, value_str, NULL, false);
      if (ret != SL_STATUS_OK) {
        // Not a valid channel value
        return SL_STATUS_INVALID_TYPE;
      }
      // Enable only the single channel.
      memset(&app_settings_wisun.channel_mask, 0, sizeof(app_settings_wisun.channel_mask));
      app_settings_wisun.channel_mask.mask[channel / 8] = (1 << (channel % 8));
      return SL_STATUS_OK;
    }
  }

  iter = app_unicast_channel_mask_entries;
  while (iter->key) {
    if (!key_str || !strcmp(iter->key, key_str)) {
      if (iter->set_handler) {
                                                         ...
                                                         const app_settings_entry_t *entry)
{
  sl_status_t ret;
  const app_settings_entry_t *iter;
  char channel_mask_value_str[128];
  (void)value_str;
  ...
  while (iter->key) {
    if (!key_str || !strcmp(iter->key, key_str)) {
      if (iter->get_handler) {
        ret = iter->get_handler(channel_mask_value_str, NULL, iter);
        if (ret == SL_STATUS_OK) {
          printf("%s.%s.%s = %s\r\n", app_settings_domain_str[entry->domain], entry->key, iter->key, channel_mask_value_str);
        }
      }
    }
    iter++;
