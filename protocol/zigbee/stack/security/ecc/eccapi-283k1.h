...
#ifndef ECCAPI_283K1_H
#define ECCAPI_283K1_H
...
// these bits are in strange places because the cert is "ASN1 encoded per RFC 3728" ...
#define CERT_DIGITAL_SIGNATURE 0x80
#define CERT_KEY_AGREEMENT 0x08

// Begin Ember modifications
#define MCE_LIBRARY_NOT_PRESENT_283K1    0xFF
#define STUB_ECC_LIBRARY_283K1           0xFFFFFFFFL
#define NO_YIELDING                0x0
// End of Ember modificiations
 ...
 *
   ...
   @retval MCE_SUCCESS Indicates successful completion.
 */
typedef int HashFunc (unsigned char *digest, unsigned long sz, unsigned char *data) MCE_FUNCTION_TYPE;
 ...
 */
int aesMmoHash(unsigned char *digest, unsigned long sz, unsigned char *data) MCE_FUNCTION_TYPE;
