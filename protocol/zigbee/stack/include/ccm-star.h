...
/**
 * @brief  Perform aes-ccm encryption and tagging, producing an encrypted
 *         message and a MIC
...
/**
 * @brief  Perform an authenticated decryption on an encrypted message,
...
/**
 * @brief  Calculate a message integrity code and performs ccm encryption
...
/**
 * @brief  Perform an authenticated decryption on a flat packet, assuming the
...
/**
 * @brief  Calculate the CCM* MIC of a given message without outputting
 *         the ciphertext.
...
void emberCcmCalculateAndEncryptMic(uint8_t *nonce,
                                    ...
                                    uint8_t *micResult);
/**
 * @brief  Perform a CCM* encryption in place without tag (tag length zero).
