 ...
 */
WEAK(void emberAfGroupsClusterClearGroupTableCallback(int8u endpoint))
{
}
 ...
 * @param endpoint The endpoint.  Ver.: always
 */
WEAK(void emberAfScenesClusterClearSceneTableCallback(int8u endpoint))
{
}
 ...
 */
WEAK(EmberAfStatus emberAfScenesClusterMakeInvalidCallback(int8u endpoint))
{
 ...
 */
WEAK(EmberAfStatus emberAfScenesClusterRecallSavedSceneCallback(int8u endpoint,
                                                                int16u groupId,
                                                                int8u sceneId))
{
 ...
 */
WEAK(void emberAfScenesClusterRemoveScenesInGroupCallback(int8u endpoint,
                                                          int16u groupId))
{
}
 ...
 * @param sceneId The scene identifier.  Ver.: always
 */
WEAK(EmberAfStatus emberAfScenesClusterStoreCurrentSceneCallback(int8u endpoint,
                                                                 int16u groupId,
                                                                 int8u sceneId))
{
  return EMBER_ZCL_STATUS_FAILURE;
