...
// <o SL_ZIGBEE_OS_STACK_TASK_SIZE> Zigbee stack task stack size in bytes <1000-20000>
// <i> Default: 5600
// <i> Defines the stack size of the Zibgee RTOS stack task. The value is in bytes and
// <i> and will be word aligned when it is applied at the task creation.
#define SL_ZIGBEE_OS_STACK_TASK_SIZE 5600
