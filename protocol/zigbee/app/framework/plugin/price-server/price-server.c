                                    ...
                                    EmberAfScheduledPrice *price)
{
  ...
  if (index < EMBER_AF_PLUGIN_PRICE_SERVER_PRICE_TABLE_SIZE) {
    (void) MEMMOVE(price, &priceTable[ep][index], sizeof(EmberAfScheduledPrice));
                                    ...
                                    const EmberAfScheduledPrice *price)
{
  ...
  if (index < EMBER_AF_PLUGIN_PRICE_SERVER_PRICE_TABLE_SIZE) {
    ...
    (void) MEMMOVE(&priceTable[ep][index], price, sizeof(EmberAfScheduledPrice));
...
void emberAfPriceServerSendGetScheduledPrices(uint8_t endpoint)
{
  ...
  while ( partner.index < EMBER_AF_PLUGIN_PRICE_SERVER_PRICE_TABLE_SIZE ) {
    ...
    if (isCurrentOrScheduled) {
      ...
      emberAfPriceGetPriceTableEntry(endpoint, partner.index - 1u, &price);
                                                  ...
                                                  uint8_t tariffIndex)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishTariffInformation(tariff.providerId,
                         ...
                         uint8_t validEntryCount)
{
  ...
  for (i = 0; i < validEntryCount; i++) {
    ...
    if (cmdId == ZCL_PUBLISH_CONVERSION_FACTOR_COMMAND_ID) {
      ...
      (void) emberAfFillCommandPriceClusterPublishConversionFactor(priceServerInfo.conversionFactorTable.commonInfos[endpoint][tableIndex].issuerEventId,
      ...
      (void) emberAfFillCommandPriceClusterPublishCalorificValue(priceServerInfo.calorificValueTable.commonInfos[endpoint][tableIndex].issuerEventId,
      ...
      (void) emberAfFillCommandPriceClusterPublishCO2Value(priceServerInfo.co2ValueTable.co2Values[endpoint][tableIndex].providerId,
      ...
      for ( j = 0; j < priceServerInfo.tierLabelTable.entry[endpoint][tableIndex].numberOfTiers; j++ ) {
        (void) emberAfPutInt8uInResp(priceServerInfo.tierLabelTable.entry[endpoint][tableIndex].tierIds[j]);
        (void) emberAfPutStringInResp(priceServerInfo.tierLabelTable.entry[endpoint][tableIndex].tierLabels[j]);
      }
    } else if (cmdId == ZCL_PUBLISH_BILLING_PERIOD_COMMAND_ID) {
      emberAfPriceClusterPrintln("Sending billing period: table[%d]", tableIndex);
      (void) emberAfFillCommandPriceClusterPublishBillingPeriod(priceServerInfo.billingPeriodTable.billingPeriods[endpoint][tableIndex].providerId,
      ...
      (void) emberAfFillCommandPriceClusterPublishConsolidatedBill(priceServerInfo.consolidatedBillsTable.consolidatedBills[endpoint][tableIndex].providerId,
      ...
      (void) emberAfFillCommandPriceClusterPublishCreditPayment(priceServerInfo.creditPaymentTable.creditPayment[endpoint][tableIndex].providerId,
      ...
      (void) emberAfFillCommandPriceClusterPublishBlockPeriod(priceServerInfo.blockPeriodTable.blockPeriods[endpoint][tableIndex].providerId,
                                                          ...
                                                          uint8_t conversionFactorTrailingDigit)
{
  ...
  emberAfPluginPriceCommonSort(priceServerInfo.conversionFactorTable.commonInfos[ep],
                               ...
                               (uint16_t)sizeof(EmberAfPriceConversionFactor),
                               EMBER_AF_PLUGIN_PRICE_SERVER_CONVERSION_FACTOR_TABLE_SIZE);
...
static void emberAfPriceUpdateConversionFactorAttribs(uint8_t endpoint, uint32_t conversionFactor, uint8_t conversionFactorTrailingDigit)
{
  ...
  (void) emberAfWriteServerAttribute(endpoint,
                                     ZCL_PRICE_CLUSTER_ID,
...
void emberAfPriceServerRefreshConversionFactor(uint8_t endpoint)
{
  ...
  if ( 0u == emberAfPluginPriceCommonSecondsUntilSecondIndexActive(priceServerInfo.conversionFactorTable.commonInfos[ep],
                                                                   EMBER_AF_PLUGIN_PRICE_SERVER_CONVERSION_FACTOR_TABLE_SIZE) ) {
                                                        ...
                                                        uint8_t calorificValueTrailingDigit)
{
  ...
  emberAfPluginPriceCommonSort(priceServerInfo.calorificValueTable.commonInfos[ep],
                               ...
                               (uint16_t)sizeof(EmberAfPriceCalorificValue),
                               EMBER_AF_PLUGIN_PRICE_SERVER_CALORIFIC_VALUE_TABLE_SIZE);
...
void emberAfPriceServerRefreshCalorificValue(uint8_t endpoint)
{
  ...
  if ( 0u == emberAfPluginPriceCommonSecondsUntilSecondIndexActive(priceServerInfo.calorificValueTable.commonInfos[ep],
                                                                   EMBER_AF_PLUGIN_PRICE_SERVER_CALORIFIC_VALUE_TABLE_SIZE) ) {
    // Replace current with next.
...
void emberAfPluginPriceServerCalorificValueClear(uint8_t endpoint)
{
  ...
  (void) MEMSET(&priceServerInfo.calorificValueTable, 0, sizeof(EmberAfPriceCalorificValueTable));
}
...
void emberAfPluginPriceServerConversionFactorClear(uint8_t endpoint)
{
  ...
  (void) MEMSET(&priceServerInfo.conversionFactorTable, 0, sizeof(EmberAfPriceConversionFactorTable));
}
...
void emberAfPluginPriceServerCo2ValueClear(uint8_t endpoint)
{
  ...
  (void) MEMSET(&priceServerInfo.co2ValueTable, 0, sizeof(EmberAfPriceCO2Table));
}
                                                 ...
                                                 uint8_t dstEndpoint)
{
  ...
  emberAfSetCommandEndpoints(srcEndpoint, dstEndpoint);
  (void) emberAfFillCommandPriceClusterPublishConversionFactor(priceServerInfo.conversionFactorTable.commonInfos[ep][tableIndex].issuerEventId,
                                          ...
                                          uint8_t* tierLabel)
{
  ...
  (void) MEMCOPY(priceServerInfo.tierLabelTable.entry[ep][index].tierLabels[0], tierLabel, (TIER_LABEL_SIZE + 1));
}
...
void emberAfPluginPriceServerTierLabelAddLabel(uint8_t endpoint, uint32_t issuerTariffId, uint8_t tierId, uint8_t *tierLabel)
{
  ...
  for ( i = 0; i < EMBER_AF_PLUGIN_PRICE_SERVER_TIER_LABELS_TABLE_SIZE; i++ ) {
    if ( (priceServerInfo.tierLabelTable.entry[ep][i].issuerTariffId == issuerTariffId)
      ...
      (void) MEMCOPY(priceServerInfo.tierLabelTable.entry[ep][i].tierLabels[numberOfTiers], tierLabel, (TIER_LABEL_SIZE + 1));
...
void emberAfPluginPriceServerTierLabelPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint, uint8_t index)
{
  ...
  for ( i = 0; i < priceServerInfo.tierLabelTable.entry[ep][index].numberOfTiers; i++ ) {
    (void) emberAfPutInt8uInResp(priceServerInfo.tierLabelTable.entry[ep][index].tierIds[i]);
    (void) emberAfPutStringInResp(priceServerInfo.tierLabelTable.entry[ep][index].tierLabels[i]);
  }
...
void emberAfPriceServerRefreshCO2Value(uint8_t endpoint)
{
  ...
  if ( 0 == emberAfPluginPriceCommonSecondsUntilSecondIndexActive(priceServerInfo.co2ValueTable.commonInfos[ep],
    ...
    emberAfPluginPriceCommonSort(priceServerInfo.co2ValueTable.commonInfos[ep],
                                 ...
                                 (uint16_t)sizeof(EmberAfPriceCo2Value),
                                 EMBER_AF_PLUGIN_PRICE_SERVER_CO2_VALUE_TABLE_SIZE);
...
void emberAfPluginPriceServerCo2LabelPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint, uint8_t index)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishCO2Value(priceServerInfo.co2ValueTable.co2Values[ep][index].providerId,
...
void emberAfPriceServerRefreshBillingPeriod(uint8_t endpoint, bool force)
{
  ...
  if (secondsUntilSecondIndexActive == 0u) {
    ...
    emberAfPluginPriceCommonSort(priceServerInfo.billingPeriodTable.commonInfos[ep],
                                 ...
                                 (uint16_t)sizeof(EmberAfPriceBillingPeriod),
                                 EMBER_AF_PLUGIN_PRICE_SERVER_BILLING_PERIOD_TABLE_SIZE);
...
void emberAfPluginPriceServerBillingPeriodPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint, uint8_t index)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishBillingPeriod(priceServerInfo.billingPeriodTable.billingPeriods[ep][index].providerId,
                                                 ...
                                                 uint8_t billTrailingDigit)
{
  ...
  emberAfPluginPriceCommonSort(priceServerInfo.consolidatedBillsTable.commonInfos[ep],
                               ...
                               (uint16_t)sizeof(EmberAfPriceConsolidatedBills),
                               EMBER_AF_PLUGIN_PRICE_SERVER_CONSOLIDATED_BILL_TABLE_SIZE);
...
void emberAfPluginPriceServerConsolidatedBillPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint, uint8_t index)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishConsolidatedBill(pbill->providerId,
...
void emberAfPluginPriceServerCppEventPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishCppEvent(cppEvent->providerId, priceServerInfo.cppTable.commonInfos[ep].issuerEventId,
...
void sortCreditPaymentEntries(uint8_t *entries, uint8_t numValidEntries, EmberAfPriceCreditPayment *table)
{
  ...
  (void) MEMCOPY(entries, sortedEntries, numValidEntries);
}
...
void emberAfPluginPriceServerCreditPaymentPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint, uint8_t index)
{
  ...
  (void) emberAfFillCommandPriceClusterPublishCreditPayment(pcredit->providerId,
...
void emberAfPluginPriceServerCurrencyConversionPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint)
{
  ...
  if ( priceServerInfo.currencyConversionTable.commonInfos[ep].valid ) {
    (void) emberAfFillCommandPriceClusterPublishCurrencyConversion(priceServerInfo.currencyConversionTable.currencyConversion[ep].providerId,
...
void emberAfPluginPriceServerTariffCancellationPub(uint16_t nodeId, uint8_t srcEndpoint, uint8_t dstEndpoint)
{
  ...
  if ( priceServerInfo.cancelTariffTable.cancelTariff[ep].valid ) {
    (void) emberAfFillCommandPriceClusterCancelTariff(priceServerInfo.cancelTariffTable.cancelTariff[ep].providerId,
                                            ...
                                            uint8_t tariffResolutionPeriod)
{
  ...
  if ( index < EMBER_AF_PLUGIN_PRICE_SERVER_BLOCK_PERIOD_TABLE_SIZE ) {
    EmberAfPriceCommonInfo *curInfo = &priceServerInfo.blockPeriodTable.commonInfos[ep][index];
    EmberAfPriceBlockPeriod *curBlockPeriod = &priceServerInfo.blockPeriodTable.blockPeriods[ep][index];
    curInfo->valid = true;
    ...
    emberAfPluginPriceCommonSort(priceServerInfo.blockPeriodTable.commonInfos[ep],
                                 ...
                                 (uint16_t)sizeof(EmberAfPriceBlockPeriod),
                                 EMBER_AF_PLUGIN_PRICE_SERVER_BLOCK_PERIOD_TABLE_SIZE);
                                            ...
                                            uint8_t index)
{
  ...
  if ( (index < EMBER_AF_PLUGIN_PRICE_SERVER_BLOCK_PERIOD_TABLE_SIZE)
    ...
    (void) emberAfFillCommandPriceClusterPublishBlockPeriod(priceServerInfo.blockPeriodTable.blockPeriods[ep][index].providerId,
...
void emberAfPriceServerRefreshBlockPeriod(uint8_t endpoint, bool repeat)
{
  ...
  EmberAfPriceCommonInfo *curInfo = &priceServerInfo.blockPeriodTable.commonInfos[ep][i];
  EmberAfPriceBlockPeriod *curBlockPeriod = &priceServerInfo.blockPeriodTable.blockPeriods[ep][i];
  ...
  if (repeat) {
    ...
    if (curInfo->valid
        && ((curBlockPeriod->blockPeriodControl
             & EMBER_AF_BLOCK_PERIOD_CONTROL_REPEATING_BLOCK) != 0u)) {
      // The .startTime and .durationSec members are both UTC values measured
      // in seconds. The nextStartTime is therefore a UTC value. Set the start
      // time of the next period to the end time of the current period.
...
void emberAfPriceServerRefreshPriceMatrixInformation(uint8_t endpoint)
{
  ...
  // Notify application
  EmberAfPriceCommonInfo *curInfo = &priceServerInfo.scheduledPriceMatrixTable.commonInfos[ep][i];
  EmberAfScheduledPriceMatrix *curPm = &priceServerInfo.scheduledPriceMatrixTable.scheduledPriceMatrix[ep][i];
...
void emberAfPriceServerRefreshBlockThresholdsInformation(uint8_t endpoint)
{
  ...
  // Notify application
  EmberAfPriceCommonInfo *curInfo = &priceServerInfo.scheduledBlockThresholdsTable.commonInfos[ep][i];
  EmberAfScheduledBlockThresholds *curBt = &priceServerInfo.scheduledBlockThresholdsTable.scheduledBlockThresholds[ep][i];
...
void emberAfPriceServerRefreshTariffInformation(uint8_t endpoint)
{
  ...
  EmberAfScheduledTariff *tariff = &priceServerInfo.scheduledTariffTable.scheduledTariffs[ep][i];
  EmberAfTariffType tariffType = (EmberAfTariffType) tariff->tariffTypeChargingScheme & TARIFF_TYPE_MASK;
  ...
  if ((tariffType == EMBER_ZCL_TARIFF_TYPE_DELIVERED_TARIFF)
    ...
    (void) emberAfWriteAttribute(endpoint, ZCL_PRICE_CLUSTER_ID,
...
bool emberAfPriceClusterGetCurrentPriceCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfPriceClusterPrintln("RX: GetCurrentPrice 0x%X", cmd_data.commandOptions);
...
bool emberAfPriceClusterGetScheduledPricesCallback(EmberAfClusterCommand *cmd)
{
  ...
  if (partner.numberOfEvents == 0u) {
    ...
    sli_zigbee_af_price_server_schedule_get_scheduled_prices(emberAfCurrentEndpoint());
  }
  return true;
}

bool emberAfPriceClusterPriceAcknowledgementCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetBlockPeriodsCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetConversionFactorCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetCalorificValueCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetCO2ValueCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetTierLabelsCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterGetBillingPeriodCallback(EmberAfClusterCommand *cmd)
{
  ...
  if ( cmd_data.earliestStartTime == 0u ) {
    cmd_data.earliestStartTime = emberAfGetCurrentTime();
  }

  (void) MEMSET(validEntries, 0xFF, EMBER_AF_PLUGIN_PRICE_SERVER_BILLING_PERIOD_TABLE_SIZE);
...
bool emberAfPriceClusterGetConsolidatedBillCallback(EmberAfClusterCommand *cmd)
{
...
bool emberAfPriceClusterCppEventResponseCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfPriceClusterPrintln("Rx: Cpp Event Response, issuerEventId=0x%4x, auth=%d,   storedCppAuth=%d", cmd_data.issuerEventId, cmd_data.cppAuth,
...
//    priceServerInfo.cppEvent.commonInfos.issuerEventId++;    // Test 12.68 Item 5 requires this message have a different event ID than
    ...
    emberAfPriceClusterPrintln("Send CPP Event, stat=%d", cmd_data.cppAuth);
    (void) emberAfFillCommandPriceClusterPublishCppEvent(priceServerInfo.cppTable.cppEvent[ep].providerId,
...
bool emberAfPriceClusterGetCreditPaymentCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfPriceClusterPrintln("Rx: GetCreditPayment, endTime=%d, nr=%d", cmd_data.latestEndTime, cmd_data.numberOfRecords);
  if ( cmd_data.numberOfRecords == 0u ) {
    cmd_data.numberOfRecords = EMBER_AF_PLUGIN_PRICE_SERVER_CREDIT_PAYMENT_TABLE_SIZE;
  }
  if ( cmd_data.latestEndTime == 0u ) {
    cmd_data.latestEndTime = emberAfGetCurrentTime();
  }
...
bool emberAfPriceClusterGetPriceMatrixCallback(EmberAfClusterCommand *cmd);
bool emberAfPriceClusterGetBlockThresholdsCallback(EmberAfClusterCommand *cmd);

uint32_t emberAfPriceClusterServerCommandParse(sl_service_opcode_t opcode,
                                               sl_service_function_context_t *context)
{
  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      ...
      {
        wasHandled = emberAfPriceClusterGetCurrentPriceCallback(cmd);
        break;
      }
      case ZCL_GET_SCHEDULED_PRICES_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetScheduledPricesCallback(cmd);
        break;
      }
      case ZCL_PRICE_ACKNOWLEDGEMENT_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterPriceAcknowledgementCallback(cmd);
        break;
      }
      case ZCL_GET_BLOCK_PERIODS_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetBlockPeriodsCallback(cmd);
        break;
      }
      case ZCL_GET_CONVERSION_FACTOR_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetConversionFactorCallback(cmd);
        break;
      }
      case ZCL_GET_CALORIFIC_VALUE_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetCalorificValueCallback(cmd);
        break;
      }
      case ZCL_GET_TARIFF_INFORMATION_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetTariffInformationCallback(cmd);
        break;
      }
      case ZCL_GET_PRICE_MATRIX_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetPriceMatrixCallback(cmd);
        break;
      }
      case ZCL_GET_BLOCK_THRESHOLDS_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetBlockThresholdsCallback(cmd);
        break;
      }
      case ZCL_GET_CO2_VALUE_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetCO2ValueCallback(cmd);
        break;
      }
      case ZCL_GET_TIER_LABELS_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetTierLabelsCallback(cmd);
        break;
      }
      case ZCL_GET_BILLING_PERIOD_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetBillingPeriodCallback(cmd);
        break;
      }
      case ZCL_GET_CONSOLIDATED_BILL_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetConsolidatedBillCallback(cmd);
        break;
      }
      case ZCL_CPP_EVENT_RESPONSE_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterCppEventResponseCallback(cmd);
        break;
      }
      case ZCL_GET_CREDIT_PAYMENT_COMMAND_ID:
      {
        wasHandled = emberAfPriceClusterGetCreditPaymentCallback(cmd);
        break;
      }
