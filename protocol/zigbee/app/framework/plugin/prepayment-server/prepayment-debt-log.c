...
bool emberAfPrepaymentClusterChangeDebtCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfPluginPrepaymentServerScheduleDebtRepayment(endpoint, cmd_data.issuerEventId, debtType, cmd_data.debtRecoveryCollectionTime,
...
bool emberAfPrepaymentClusterGetDebtRepaymentLogCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfPrepaymentClusterPrintln("RX: GetDebtLog, endTime=0x%4x, numDebts=%d, debtType=%d",
  ...
  emberAfPluginSendPublishDebtLog(nodeId, srcEndpoint, dstEndpoint, cmd_data.latestEndTime, cmd_data.numberOfDebts, cmd_data.debtType);
