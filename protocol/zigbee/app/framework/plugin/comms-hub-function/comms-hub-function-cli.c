...
#ifdef UC_BUILD
void emAfPluginCommsHubFunctionCliPrintSupportedUseCases(sl_cli_command_arg_t *arguments);
#else
...
void emAfPluginCommsHubFunctionCliSimulateGbzMsg(sl_cli_command_arg_t *arguments)
{
  ...
  if (index >= GBCS_NUM_USE_CASES) {
    ...
    emAfPluginCommsHubFunctionCliPrintSupportedUseCases(arguments);
    return;
  }
...
void emAfPluginCommsHubFunctionCliSend(sl_cli_command_arg_t *arguments)
{
  EmberEUI64 deviceId;
  uint8_t length;
  uint8_t message[255];
...
void emAfPluginCommsHubFunctionCliTimeout(sl_cli_command_arg_t *arguments)
{
...
void emAfPluginCommsHubFunctionCliGetTunnelEndpoint(sl_cli_command_arg_t *arguments)
{
  uint8_t  endpoint;
  uint16_t nodeId;
...
void emAfPluginCommsHubFunctionCliCloseTunnel(sl_cli_command_arg_t *arguments)
{
  EmberEUI64 deviceId;
...
void emAfPluginCommsHubFunctionCliCreateTunnel(sl_cli_command_arg_t *arguments)
{
  EmberEUI64 deviceId;
  uint8_t endpoint;
...
void emAfPluginCommsHubFunctionCliPrint(sl_cli_command_arg_t *arguments)
{
