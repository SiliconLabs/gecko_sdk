...
// TODO: EMBER_AF_PLUGIN_OTA_CLIENT_SET_IMAGE_STAMP is no longer a
...
#if (EMBER_TEST_BLOCK_PERIOD_IN_SECONDS == 1)
                                             ...
                                             sl_service_function_context_t *context)
{
  ...
  bool wasHandled = emberAfOtaClientIncomingMessageRawCallback(cmd);
