...
#define ZAP_GENERATED_ATTRIBUTE_SIZES {  \
    ...
    ZCL_BITMAP40_ATTRIBUTE_TYPE, 5,      \
    ZCL_BITMAP48_ATTRIBUTE_TYPE, 6,      \
    ZCL_BITMAP56_ATTRIBUTE_TYPE, 7,      \
    ...
    ZCL_FLOAT_SEMI_ATTRIBUTE_TYPE, 2,    \
    ZCL_FLOAT_SINGLE_ATTRIBUTE_TYPE, 4,  \
    ZCL_FLOAT_DOUBLE_ATTRIBUTE_TYPE, 8,  \
...
// Enum for DoorLockAlarmCode
typedef enum {
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_DEADBOLT_JAMMED = 0,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_RESET_TO_FACTORY_DEFAULTS = 1,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_RF_MODULE_POWER_CYCLED = 3,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_TAMPER_WRONG_CODE_ENTRY_LIMIT = 4,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_TAMPER_FRONT_ESCUTCHEON = 5,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_FORCED_DOOR_OPEN = 6,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_DOOR_AJAR = 7,
  EMBER_ZCL_DOOR_LOCK_ALARM_CODE_COERCED = 8,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_EVENT_SOURCE_BIOMETRIC_CRED = 4,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_OPERATING_MODE_PASSAGE_MODE = 4,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_UNLOCK_COERCED_USER = 16,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_FINGERPINT_UNLOCK = 17,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_FACE_ID_UNLOCK = 18,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_FINGERVEIN_UNLOCK = 19,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_AUTO_UNLOCK = 20,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_APPLICATION_UNLOCK = 21,
  EMBER_ZCL_DOOR_LOCK_OPERATION_EVENT_CODE_UNLOCK_DISPOSABLE_USER = 22,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FINGERPRINT_ADDED = 7,
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FINGERPRINT_DELETED = 8,
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FACE_ID_ADDED = 9,
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FACE_ID_DELETED = 10,
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FINGERVEIN_ADDED = 11,
  EMBER_ZCL_DOOR_LOCK_PROGRAMMING_EVENT_CODE_FINGERVEIN_DELETED = 12,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_SOUND_VOLUME_MEDIUM = 3,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_TYPE_OTHER = 2,
  EMBER_ZCL_DOOR_LOCK_TYPE_MORTISE = 3,
  EMBER_ZCL_DOOR_LOCK_TYPE_RIM = 4,
  EMBER_ZCL_DOOR_LOCK_TYPE_LATCH_BOLT = 5,
  EMBER_ZCL_DOOR_LOCK_TYPE_CYLINDRICAL = 6,
  EMBER_ZCL_DOOR_LOCK_TYPE_TUBULAR = 7,
  EMBER_ZCL_DOOR_LOCK_TYPE_INTERCONNECTED = 8,
  EMBER_ZCL_DOOR_LOCK_TYPE_DEAD_LATCH = 9,
  EMBER_ZCL_DOOR_LOCK_TYPE_DOOR_FURNITURE = 10,
} EmberAfDoorLockType;
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_LOCK_USER_TYPE_COERCED_USER = 5,
  EMBER_ZCL_DOOR_LOCK_USER_TYPE_DISPOSABLE_USER = 6,
...
typedef enum {
  ...
  EMBER_ZCL_DOOR_STATE_ERROR_AJAR = 5,
} EmberAfDoorState;
...
typedef enum {
  EMBER_ZCL_REPORTING_DIRECTION_REPORTED = 0,
  EMBER_ZCL_REPORTING_DIRECTION_RECEIVED = 1,
...
typedef enum {
  ...
  EMBER_ZCL_STATUS_UNSUP_COMMAND = 129,
  ...
  EMBER_ZCL_STATUS_ACTION_DENIED = 147,
  EMBER_ZCL_STATUS_TIMEOUT = 148,
  ...
  EMBER_ZCL_STATUS_NOTIFICATION_PENDING = 154,
  EMBER_ZCL_STATUS_HARDWARE_FAILURE = 192,
  EMBER_ZCL_STATUS_SOFTWARE_FAILURE = 193,
  EMBER_ZCL_STATUS_UNSUPPORTED_CLUSTER = 195,
  EMBER_ZCL_STATUS_LIMIT_REACHED = 196,
} EmberAfStatus;
...
typedef enum {
  ...
  EMBER_ZCL_THERMOSTAT_SYSTEM_MODE_DRY = 8,
  EMBER_ZCL_THERMOSTAT_SYSTEM_MODE_SLEEP = 9,
