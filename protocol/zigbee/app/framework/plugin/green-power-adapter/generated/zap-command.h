...
#define emberAfFillCommandColorControlClusterEnhancedMoveToHue(     \
    enhancedHue, direction, transitionTime)                         \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_COLOR_CONTROL_CLUSTER_ID,           \
...
#define emberAfFillCommandColorControlClusterEnhancedMoveToHueAndSaturation(    \
    enhancedHue, saturation, transitionTime)                                    \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND                       \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER),             \
                            ZCL_COLOR_CONTROL_CLUSTER_ID,                       \
...
/** @brief TODO
 * Cluster: Network Provisioning, TODO
 * Command: ScanNetworks*/
// @param SSID uint8_t *

// @param Breadcrumb uint8_t *

// @param TimeoutMs uint32_t

#define emberAfFillCommandNwprovClusterScanNetworks(                \
    SSID, Breadcrumb, TimeoutMs)                                    \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
...
// @param DebugText uint8_t *

// @param WiFiScanResults /* TYPE WARNING: array array defaults to */ uint8_t *
// @param WiFiScanResultsLen uint16_t
// @param ThreadScanResults /* TYPE WARNING: array array defaults to */ uint8_t *
// @param ThreadScanResultsLen uint16_t
#define emberAfFillCommandNwprovClusterScanNetworksResp(                                                \
    ErrorCode, DebugText, WiFiScanResults, WiFiScanResultsLen, ThreadScanResults, ThreadScanResultsLen) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND                                               \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER),                                     \
                            ZCL_NWPROV_CLUSTER_ID,                                                      \
                            ZCL_SCAN_NETWORKS_RESP_COMMAND_ID,                                          \
                            "usbb",                                                                     \
                            ErrorCode, DebugText, WiFiScanResults, WiFiScanResultsLen, ThreadScanResults, ThreadScanResultsLen);
...
// @param Credentials uint8_t *

// @param Breadcrumb uint8_t *

// @param TimeoutMs uint32_t

#define emberAfFillCommandNwprovClusterAddWiFiNetwork(              \
...
#define emberAfFillCommandNwprovClusterAddWiFiNetworkResp(          \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_ADD_WI_FI_NETWORK_RESP_COMMAND_ID,  \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterUpdateWiFiNetwork(           \
    SSID, Credentials, Breadcrumb, TimeoutMs)                       \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
...
#define emberAfFillCommandNwprovClusterUpdateWiFiNetworkResp(         \
    ErrorCode, DebugText)                                             \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND             \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER),   \
                            ZCL_NWPROV_CLUSTER_ID,                    \
                            ZCL_UPDATE_WI_FI_NETWORK_RESP_COMMAND_ID, \
                            "us",                                     \
                            ErrorCode, DebugText);
...
// @param OperationalDataset uint8_t *

// @param Breadcrumb uint8_t *

// @param TimeoutMs uint32_t

#define emberAfFillCommandNwprovClusterAddThreadNetwork(            \
...
#define emberAfFillCommandNwprovClusterAddThreadNetworkResp(        \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_ADD_THREAD_NETWORK_RESP_COMMAND_ID, \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterUpdateThreadNetwork(         \
    OperationalDataset, Breadcrumb, TimeoutMs)                      \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
...
#define emberAfFillCommandNwprovClusterUpdateThreadNetworkResp(        \
    ErrorCode, DebugText)                                              \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND              \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER),    \
                            ZCL_NWPROV_CLUSTER_ID,                     \
                            ZCL_UPDATE_THREAD_NETWORK_RESP_COMMAND_ID, \
                            "us",                                      \
                            ErrorCode, DebugText);
...
// @param NetworkID uint8_t *

// @param Breadcrumb uint8_t *

// @param TimeoutMs uint32_t

#define emberAfFillCommandNwprovClusterRemoveNetwork(               \
...
#define emberAfFillCommandNwprovClusterRemoveNetworkResp(           \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_REMOVE_NETWORK_RESP_COMMAND_ID,     \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterEnableNetwork(               \
    NetworkID, Breadcrumb, TimeoutMs)                               \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
...
#define emberAfFillCommandNwprovClusterEnableNetworkResp(           \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_ENABLE_NETWORK_RESP_COMMAND_ID,     \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterDisableNetwork(              \
    NetworkID, Breadcrumb, TimeoutMs)                               \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
...
#define emberAfFillCommandNwprovClusterDisableNetworkResp(          \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_DISABLE_NETWORK_RESP_COMMAND_ID,    \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterTestNetwork(                 \
    NetworkID, Breadcrumb, TimeoutMs)                               \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_TEST_NETWORK_COMMAND_ID,            \
                            "s8w",                                  \
                            NetworkID, Breadcrumb, TimeoutMs);
...
#define emberAfFillCommandNwprovClusterTestNetworkResp(             \
    ErrorCode, DebugText)                                           \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_NWPROV_CLUSTER_ID,                  \
                            ZCL_TEST_NETWORK_RESP_COMMAND_ID,       \
                            "us",                                   \
                            ErrorCode, DebugText);
...
#define emberAfFillCommandNwprovClusterGetLastNetworkProvisioningResult(         \
    TimeoutMs)                                                                   \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND                        \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER),              \
                            ZCL_NWPROV_CLUSTER_ID,                               \
                            ZCL_GET_LAST_NETWORK_PROVISIONING_RESULT_COMMAND_ID, \
                            "w",                                                 \
                            TimeoutMs);

/** @brief Send a hello command to the server
 * Cluster: Demo, The Demo Cluster is used to show how to define a simple cluster for the CHIP codebase
 * Command: SayHelloFromClient*/
// @param numberOfTimes uint8_t

#define emberAfFillCommandDemoClusterSayHelloFromClient(            \
    numberOfTimes)                                                  \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND           \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_DEMO_CLUSTER_ID,                    \
                            ZCL_SAY_HELLO_FROM_CLIENT_COMMAND_ID,   \
                            "u",                                    \
                            numberOfTimes);

/** @brief Send a hello command to the client
 * Cluster: Demo, The Demo Cluster is used to show how to define a simple cluster for the CHIP codebase
 * Command: SayHelloFromClient*/
// @param numberOfTimes uint8_t
