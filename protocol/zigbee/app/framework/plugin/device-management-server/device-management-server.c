...
bool emberAfDeviceManagementClusterReportEventConfigurationCallback(EmberAfClusterCommand *cmd)
{
  (void)cmd;
                                                          ...
                                                          sl_service_function_context_t *context)
{
  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      ...
      {
        wasHandled = emberAfDeviceManagementClusterRequestNewPasswordCallback(cmd);
        break;
      }
      ...
      {
        wasHandled = emberAfDeviceManagementClusterReportEventConfigurationCallback(cmd);
        break;
      }
