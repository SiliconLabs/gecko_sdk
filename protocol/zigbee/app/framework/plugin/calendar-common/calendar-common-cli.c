...
void emberAfPluginCalendarCommonPrintSummaryCommand(sl_cli_command_arg_t *arguments)
{
...
void emberAfPluginCalendarCommonSelectCommand(sl_cli_command_arg_t *arguments)
{
...
void emberAfPluginCalendarCommonPrintWeeksCommand(sl_cli_command_arg_t *arguments)
{
  uint8_t i;
...
void emberAfPluginCalendarCommonPrintDaysCommand(sl_cli_command_arg_t *arguments)
{
  if (!printSelectedCalendar()) {
    return;
  }
...
void emberAfPluginCalendarCommonClearCalendarsCommand(sl_cli_command_arg_t *arguments)
{
  uint8_t i;
...
void emberAfPluginCalendarCommonLoadSimpleCalendarCommand(sl_cli_command_arg_t *arguments)
{
  ...
  if (index < EMBER_AF_PLUGIN_CALENDAR_COMMON_TOTAL_CALENDARS) {
    ...
    length = sl_zigbee_copy_string_arg(arguments,
                                       ...
                                       EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH, false);
...
void emberAfCalendarCommonCliSetCalInfo(sl_cli_command_arg_t *arguments)
{
  ...
  calName[0] = length;
  emberAfCalendarCommonSetCalInfo(sl_cli_get_argument_uint8(arguments, 0),
...
//                                     <numberOfWeekProfiles:1>
//                                     <numberOfDayProfiles:1>
void emberAfCalendarCommonCliAddCalInfo(sl_cli_command_arg_t *arguments)
{
  uint8_t calName[EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH + 1];
  uint8_t length;
  length = sl_zigbee_copy_string_arg(arguments,
                                     ...
                                     EMBER_AF_PLUGIN_CALENDAR_MAX_CALENDAR_NAME_LENGTH, false);
  calName[0] = length;
  emberAfCalendarCommonAddCalInfo(sl_cli_get_argument_uint32(arguments, 0),
                                  sl_cli_get_argument_uint32(arguments, 1),
                                  sl_cli_get_argument_uint32(arguments, 2),
                                  sl_cli_get_argument_uint32(arguments, 3),
...
void emberAfCalendarCommonCliSetDayProfInfo(sl_cli_command_arg_t *arguments)
{
  emberAfCalendarCommonSetDayProfInfo(sl_cli_get_argument_uint8(arguments, 0),
...
void emberAfCalendarCommonCliSetWeekProfInfo(sl_cli_command_arg_t *arguments)
{
  emberAfCalendarServerSetWeekProfInfo(sl_cli_get_argument_uint8(arguments, 0),
                                       sl_cli_get_argument_uint8(arguments, 1),
                                       sl_cli_get_argument_uint8(arguments, 2),
...
void emberAfCalendarCommonCliSetSeasonsInfo(sl_cli_command_arg_t *arguments)
{
  EmberAfDate date;
  uint32_t tmp = sl_cli_get_argument_uint32(arguments, 2);
  MEMSET(&date, tmp, sizeof(EmberAfDate));
  emberAfCalendarServerSetSeasonsInfo(sl_cli_get_argument_uint8(arguments, 0),
                                      sl_cli_get_argument_uint8(arguments, 1),
                                      date,
                                      sl_cli_get_argument_uint8(arguments, 3));
}
