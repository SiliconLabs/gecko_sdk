...
const ZclStatusToStringMap zclStatusToStringMap[] = {
  ...
  { EMBER_ZCL_STATUS_UNSUP_COMMAND, "Unsup Cmd       " },
  ...
  { EMBER_ZCL_STATUS_ACTION_DENIED, "Action Denied   " },
  { EMBER_ZCL_STATUS_TIMEOUT, "Timeout         " },
  ...
  { EMBER_ZCL_STATUS_NOTIFICATION_PENDING, "Notif Pending   " },
  { EMBER_ZCL_STATUS_HARDWARE_FAILURE, "Hardware failure" },
  { EMBER_ZCL_STATUS_SOFTWARE_FAILURE, "Software failure" },
  { EMBER_ZCL_STATUS_UNSUPPORTED_CLUSTER, "Unsup Cluster   " },
  { EMBER_ZCL_STATUS_LIMIT_REACHED, "Limit Reached   " },
