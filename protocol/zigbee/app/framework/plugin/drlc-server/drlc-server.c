...
bool emberAfDemandResponseLoadControlClusterReportEventStatusCallback(EmberAfClusterCommand *cmd)
{
  ...
  emberAfDemandResponseLoadControlClusterPrintln("   es: %x", cmd_data.eventStatus);
  emberAfDemandResponseLoadControlClusterPrintln("  est: T%4x", cmd_data.eventStatusTime);
  emberAfDemandResponseLoadControlClusterFlush();
  emberAfDemandResponseLoadControlClusterPrintln("  cla: %x", cmd_data.criticalityLevelApplied);
  emberAfDemandResponseLoadControlClusterFlush();
  ...
  emberAfDemandResponseLoadControlClusterPrintln("   dc: %x", cmd_data.dutyCycleApplied);
                                                                   ...
                                                                   sl_service_function_context_t *context)
{
  ...
  if (!cmd->mfgSpecific) {
    switch (cmd->commandId) {
      ...
      {
        wasHandled = emberAfDemandResponseLoadControlClusterReportEventStatusCallback(cmd);
        break;
      }
      case ZCL_GET_SCHEDULED_EVENTS_COMMAND_ID:
      {
        wasHandled = emberAfDemandResponseLoadControlClusterGetScheduledEventsCallback(cmd);
        break;
      }
      default:
        break;
