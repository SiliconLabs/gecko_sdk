...
#define configUSE_MUTEXES               1  // Required by some FreeRTOS functionality.
#define configUSE_RECURSIVE_MUTEXES     1  // Do we use mutexes in such way?
#define configUSE_COUNTING_SEMAPHORES   1  // Do we use semaphores at all?
...
#define INCLUDE_vTaskPrioritySet            0  // Not allowed
#define INCLUDE_uxTaskPriorityGet           0  // Not needed
#define INCLUDE_vTaskDelete                 0  // Not allowed
#define INCLUDE_vTaskCleanUpResources       0
#define INCLUDE_vTaskSuspend                1
#define INCLUDE_vTaskDelayUntil             1  // Useful for Real-Time applications, like data acquisition.
#define INCLUDE_vTaskDelay                  1  // Good in-line delay, but drifts. (not suitable for Real-Time applications)
#define INCLUDE_xTimerPendFunctionCall      1
#define INCLUDE_xTaskGetSchedulerState      1
#define INCLUDE_xTaskGetCurrentTaskHandle   1  // Task Handles are passed to tasks as parameter
