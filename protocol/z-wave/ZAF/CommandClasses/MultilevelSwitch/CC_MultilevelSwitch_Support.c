...
static void init_and_reset(bool force_write)
{
  ...
  mp_switches = cc_multilevel_switch_support_get_switches();
  m_switch_count = cc_multilevel_switch_support_get_length_switches();

  default_duration = cc_multilevel_switch_support_get_default_duration();
...
)
{
  ...
  switch (pCmd->ZW_Common.cmd)
  {
    ...
    case SWITCH_MULTILEVEL_SET:
    {
      ...
      if (0 == pCmd->ZW_SwitchMultilevelSetV3Frame.duration) {
        /*
 ...
 */
REGISTER_CC_V4(COMMAND_CLASS_SWITCH_MULTILEVEL, SWITCH_MULTILEVEL_VERSION_V4, CC_MultilevelSwitch_handler, basic_set_mapper, basic_get_mapper, lifeline_reporting, 0, init, reset);
