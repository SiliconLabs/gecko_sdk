...
uint8_t cc_central_scene_get_supported_key_attributes(ZW_CENTRAL_SCENE_SUPPORTED_REPORT_1BYTE_V3_FRAME * pData)
{
  ...
  pData->properties1 = CC_CENTRAL_SCENE_PROPERTIES;  //Indicates that all keys are identical.
  uint8_t size_of_supported_key_attributes = CC_CENTRAL_SCENE_SUPPORTED_SCENES; // This value is hardcoded to work with WallController.
