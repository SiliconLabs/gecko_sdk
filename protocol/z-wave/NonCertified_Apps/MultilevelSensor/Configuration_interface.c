...
static const cc_config_parameter_metadata_t parameter_pool[] = {
  {
    .number            = sl_configuration_index_minimum_celsius_temperature_limit,
    .next_number       = sl_configuration_index_maximum_celsius_temperature_limit,
  ...
  {
    .number            = sl_configuration_index_maximum_celsius_temperature_limit,
    .next_number       = 0x0000,
...
sl_configuration_get_configuration_pool(void)
{
