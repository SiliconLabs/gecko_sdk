 ...
 */
typedef enum {
  sl_configuration_index_minimum_celsius_temperature_limit = 1,
  sl_configuration_index_maximum_celsius_temperature_limit,
  sl_configuration_index_count
} sl_configuration_index;
