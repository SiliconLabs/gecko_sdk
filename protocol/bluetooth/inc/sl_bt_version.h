 ...
 */
#define SL_BT_VERSION_BUILD 238

/**
 * @brief The hash value of the build the Bluetooth SDK was created from
 */
#define SL_BT_VERSION_HASH {0xca,0xb1,0x00,0x22,0x8a,0x23,0xe5,0x12,0xad,0x8d,0x61,0x83,0x14,0x43,0x1c,0x61,0xbf,0x06,0xff,0xc0}
