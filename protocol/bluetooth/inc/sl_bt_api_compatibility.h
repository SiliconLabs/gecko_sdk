...
typedef enum
{
  ...
  system_linklayer_config_key_active_scanner_backoff_upper_limit = 0x11,
  system_linklayer_config_key_afh_rssi_threshold                 = 0x12,
  system_linklayer_config_key_afh_channel_cooldown               = 0x13,
  system_linklayer_config_key_set_report_all_scan_rsps           = 0x14
...
/*
 * Deprecated and replaced by sl_bt_external_bondingdb_data_t.
 */
typedef enum
{
  external_bondingdb_data_remote_address       = 0x0,
  external_bondingdb_data_remote_address_type  = 0x1,
  external_bondingdb_data_remote_ltk           = 0x2,
  external_bondingdb_data_local_ltk            = 0x3,
  external_bondingdb_data_remote_central_inf   = 0x4,
  external_bondingdb_data_local_central_inf    = 0x5,
  external_bondingdb_data_irk                  = 0x6,
  external_bondingdb_data_meta                 = 0x7,
  external_bondingdb_data_gatt_client_config   = 0x8,
  external_bondingdb_data_gatt_client_features = 0x9,
  external_bondingdb_data_gatt_db_hash         = 0xa
