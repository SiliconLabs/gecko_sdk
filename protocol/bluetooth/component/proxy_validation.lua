...
local proxy_server_present = slc.is_selected('btmesh_stack_proxy_client')
local proxy_client_present = slc.is_selected('btmesh_stack_proxy_server')
local proxy_present = slc.is_selected('btmesh_stack_proxy')
