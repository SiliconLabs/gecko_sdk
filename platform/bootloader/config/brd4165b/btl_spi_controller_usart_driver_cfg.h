...
#define SL_USART_EXTFLASH_TX_PIN                       5
#define SL_USART_EXTFLASH_TX_LOC                       29

// USART1 RX on PC9
#define SL_USART_EXTFLASH_RX_PORT                      gpioPortC
#define SL_USART_EXTFLASH_RX_PIN                       9
#define SL_USART_EXTFLASH_RX_LOC                       13

// USART1 CLK on PF4
#define SL_USART_EXTFLASH_CLK_PORT                     gpioPortF
#define SL_USART_EXTFLASH_CLK_PIN                      4
#define SL_USART_EXTFLASH_CLK_LOC                      26
