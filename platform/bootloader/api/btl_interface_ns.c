...
extern int32_t bootloader_nsc_getInfo(psa_invec *in_vec, size_t in_len,
...
extern int32_t bootloader_nsc_parseImageInfo(psa_invec *in_vec, size_t in_len,
                                             psa_outvec *out_vec, size_t out_len);
...
extern int32_t bootloader_nsc_getUpgradeLocation(psa_invec *in_vec, size_t in_len,
                                                 psa_outvec *out_vec, size_t out_len);
extern uint32_t bootloader_nsc_remainingApplicationUpgrades(void);
extern int32_t bootloader_nsc_getCertificateVersion(psa_invec *in_vec, size_t in_len,
                                                    psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_getStorageInfo(psa_invec *in_vec, size_t in_len,
                                             psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_getStorageSlotInfo(psa_invec *in_vec, size_t in_len,
                                                 psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_readStorage(psa_invec *in_vec, size_t in_len,
                                          psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_writeStorage(psa_invec *in_vec, size_t in_len,
                                           psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_eraseWriteStorage(psa_invec *in_vec, size_t in_len,
                                                psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_eraseStorageSlot(uint32_t slotId, uint32_t notUsed);
extern int32_t bootloader_nsc_initChunkedEraseStorageSlot(psa_invec *in_vec, size_t in_len,
                                                          psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_chunkedEraseStorageSlot(psa_invec *in_vec, size_t in_len,
                                                      psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_setImageToBootload(int32_t slotId, uint32_t notUsed);
extern int32_t bootloader_nsc_setImagesToBootload(psa_invec *in_vec, size_t in_len,
                                                  psa_outvec *out_vec, size_t out_len);
extern int32_t bootloader_nsc_getImagesToBootload(psa_invec *in_vec, size_t in_len,
                                                  psa_outvec *out_vec, size_t out_len);
...
extern int32_t bootloader_nsc_getImageInfo(psa_invec *in_vec, size_t in_len,
                                           psa_outvec *out_vec, size_t out_len);
