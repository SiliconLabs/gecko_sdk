 ...
 *
 ******************************************************************************/
#ifndef SL_MATH_MVP_VECTOR_NEGATE_H
#define SL_MATH_MVP_VECTOR_NEGATE_H
 ...
 *
 * @details
 *   This function will perform the following operation: Z = - A.
 *   Vectors must be of equal length. If both vector buffers are 4-byte
 ...
 *   In-place negation is supported (input and output reference same buffer).
 *
...
#endif // SL_MATH_MVP_VECTOR_NEGATE_H
