 ...
 *
 ******************************************************************************/
#ifndef SL_MATH_MVP_VECTOR_MULT_H
#define SL_MATH_MVP_VECTOR_MULT_H
 ...
 *
 * @details
 *   This function will perform the following operation: Z[i] = A[i] * B[i].
...
#endif // SL_MATH_MVP_VECTOR_MULT_H
