...
// <o SL_UARTDRV_LEUART_INSTANCE_MAX_CONCURRENT_RX_BUFS> Size of the receive operation queue
// <i> Default: 6
#define SL_UARTDRV_LEUART_INSTANCE_RX_BUFFER_SIZE 6

// <o SL_UARTDRV_LEUART_INSTANCE_MAX_CONCURRENT_TX_BUFS> Size of the transmit operation queue
// <i> Default: 6
