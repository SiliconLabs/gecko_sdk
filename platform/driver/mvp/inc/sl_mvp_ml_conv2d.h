/***************************************************************************//**
 * @file
 * @brief MVP Conv2d kernel driver.
 *******************************************************************************
 * # License
...
#ifndef SL_MVP_ML_CONV2D_H
#define SL_MVP_ML_CONV2D_H
...
/***************************************************************************//**
 * @addtogroup mvp_conv2d MVP Conv2d API
 * @{
 ******************************************************************************/

/** Conv2D data structure. */
typedef struct {
 ...
 *
 * @details
 *    2D Convolution is performed on 8-bit integer input/filter with float16_t
 *    bias and output scalers. Operation output is 8-bit integer.
 *
 ...
 *
 * @details
 *    Check if the MVP hardware is capable of Conv2D with given matrix
 *    parameters.
 *
 * @param[in] params Pointer to a data structure containing information on
 *                   input data, refer to @ref sli_mvp_ml_conv2d_s8_params_t.
 *
 * @return
...
/** @} (end addtogroup mvp_conv2d) */

#ifdef __cplusplus
}
#endif

#endif // SL_MVP_ML_CONV2D_H
