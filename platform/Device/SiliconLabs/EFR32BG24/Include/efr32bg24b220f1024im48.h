...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_VDAC1_S)) || SL_TRUSTZONE_PERIPHERAL_VDAC1_S)
...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_MVP_S)) || SL_TRUSTZONE_PERIPHERAL_MVP_S)
