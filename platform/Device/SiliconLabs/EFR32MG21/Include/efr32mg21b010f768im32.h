...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_USART2_S)) || SL_TRUSTZONE_PERIPHERAL_USART2_S)
...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_LVGD_S)) || SL_TRUSTZONE_PERIPHERAL_LVGD_S)
...
#if ((defined(SL_TRUSTZONE_SECURE) && !defined(SL_TRUSTZONE_PERIPHERAL_PRORTC_S)) || SL_TRUSTZONE_PERIPHERAL_PRORTC_S)
