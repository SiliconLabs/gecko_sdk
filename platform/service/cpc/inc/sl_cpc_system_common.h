...
#ifndef SL_CPC_SYSTEM_COMMON_H_
#define SL_CPC_SYSTEM_COMMON_H_
 ...
 * enum value.
 ******************************************************************************/
#define EP_ID_TO_PROPERTY_ID(ep_id)  ((sl_cpc_property_id_t)((0x00001000 | ((ep_id) & 0x000000FF))))
 ...
 *
 ******************************************************************************/
SL_ENUM_GENERIC(sl_cpc_system_reboot_mode_t, uint32_t)
{
 ...
 ******************************************************************************/
SL_ENUM(sl_cpc_system_cmd_id_t)
{
...
typedef struct {
  sl_cpc_system_cmd_header_t header;                      ///< Command header
