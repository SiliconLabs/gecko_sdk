...
#endif
#if (_SILICON_LABS_SECURITY_FEATURE != _SILICON_LABS_SECURITY_FEATURE_VAULT)
static inline void store_otp_configuration(void);
static inline void store_se_otp_version(void);
#endif // (_SILICON_LABS_SECURITY_FEATURE != _SILICON_LABS_SECURITY_FEATURE_VAULT)
...
#if defined(SLI_TZ_SECURE_MAIN_CONFIG_TEST)
extern void tz_secure_main_config_test(void);
#if defined(CRYPTOACC_PRESENT)
...
int main(void)
{
  ...
  #if defined(SLI_TZ_SECURE_MAIN_CONFIG_TEST)
  tz_secure_main_config_test();
  #endif // SLI_TZ_SECURE_MAIN_CONFIG_TEST
...
static inline void store_otp_configuration(void)
{
  #if defined(SLI_TZ_ATTESTATION_TEST)
  otp_configuration.enable_secure_boot = true;
