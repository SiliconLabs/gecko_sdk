// Static Mbed TLS config file intended for native builds. Enables a superset of
// all algorithms accelerated on series-2 EFRs. Used by the primary in a SE over
// CPC project.
