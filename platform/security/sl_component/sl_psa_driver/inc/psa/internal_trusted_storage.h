...
#define PSA_STORAGE_FLAG_WRITE_ONCE (1 << 0) /**< The data associated with the uid will not be able to be modified or deleted. Intended to be used to set bits in `psa_storage_create_flags_t`*/
  ...
  #define PSA_STORAGE_FLAG_WRITE_ONCE_SECURE_ACCESSIBLE (1u << 3) /**< The data associated with the uid will not be able to be modified or deleted and can only be set or read from the secure domain `*/
