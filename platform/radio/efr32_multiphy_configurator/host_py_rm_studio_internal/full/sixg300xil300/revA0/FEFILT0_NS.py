...
class RM_Peripheral_FEFILT0_NS(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.ADPC3 = RM_Register_FEFILT0_NS_ADPC3(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC3'] = self.ADPC3
        self.ADPC4 = RM_Register_FEFILT0_NS_ADPC4(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC4'] = self.ADPC4
        self.ADPC5 = RM_Register_FEFILT0_NS_ADPC5(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC5'] = self.ADPC5
        self.ADPC6 = RM_Register_FEFILT0_NS_ADPC6(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC6'] = self.ADPC6
        self.ADPC7 = RM_Register_FEFILT0_NS_ADPC7(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC7'] = self.ADPC7
        self.ADPC9 = RM_Register_FEFILT0_NS_ADPC9(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADPC9'] = self.ADPC9
        self.ADPC10 = RM_Register_FEFILT0_NS_ADPC10(self.zz_rmio, self.zz_label)
