...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_SIXG300XIL300XFULL_RevA0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_SIXG300XIL300XFULL_RevA0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_SIXG300XIL300XFULL_RevA0' ]
...
class RM_Device_SIXG300XIL300XFULL_RevA0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_SIXG300XIL300XFULL_RevA0, self).__init__(rmio, label,
            'SIXG300XIL300XFULL',
            RM_SVD_Info('SIXG300XIL300XFULL_SEQ.svd', '2d0a0333f912799d4dd8015be04d15ca'))
