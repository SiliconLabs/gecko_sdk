...
class RM_Field_AGC_NS_LNABOOST_LNABOOSTGAIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_LNABOOST_LNABOOSTGAIN, self).__init__(register,
            'LNABOOSTGAIN', 'AGC_NS.LNABOOST.LNABOOSTGAIN', 'read-write',
            u"",
            9, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_NS_SMFIF_RSSIVALIDSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSIVALIDSFMIF, self).__init__(register,
            'RSSIVALIDSFMIF', 'AGC_NS.SMFIF.RSSIVALIDSFMIF', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_CCASFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_CCASFMIF, self).__init__(register,
            'CCASFMIF', 'AGC_NS.SMFIF.CCASFMIF', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RSSIPOSSTEPSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSIPOSSTEPSFMIF, self).__init__(register,
            'RSSIPOSSTEPSFMIF', 'AGC_NS.SMFIF.RSSIPOSSTEPSFMIF', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RSSINEGSTEPSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSINEGSTEPSFMIF, self).__init__(register,
            'RSSINEGSTEPSFMIF', 'AGC_NS.SMFIF.RSSINEGSTEPSFMIF', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RSSIDONESFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSIDONESFMIF, self).__init__(register,
            'RSSIDONESFMIF', 'AGC_NS.SMFIF.RSSIDONESFMIF', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_SHORTRSSIPOSSTEPSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_SHORTRSSIPOSSTEPSFMIF, self).__init__(register,
            'SHORTRSSIPOSSTEPSFMIF', 'AGC_NS.SMFIF.SHORTRSSIPOSSTEPSFMIF', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RFPKDPRDDONESFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RFPKDPRDDONESFMIF, self).__init__(register,
            'RFPKDPRDDONESFMIF', 'AGC_NS.SMFIF.RFPKDPRDDONESFMIF', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RFPKDCNTDONESFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RFPKDCNTDONESFMIF, self).__init__(register,
            'RFPKDCNTDONESFMIF', 'AGC_NS.SMFIF.RFPKDCNTDONESFMIF', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RSSIHIGHSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSIHIGHSFMIF, self).__init__(register,
            'RSSIHIGHSFMIF', 'AGC_NS.SMFIF.RSSIHIGHSFMIF', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_RSSILOWSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_RSSILOWSFMIF, self).__init__(register,
            'RSSILOWSFMIF', 'AGC_NS.SMFIF.RSSILOWSFMIF', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_CCANODETSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_CCANODETSFMIF, self).__init__(register,
            'CCANODETSFMIF', 'AGC_NS.SMFIF.CCANODETSFMIF', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_GAINBELOWGAINTHDSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_GAINBELOWGAINTHDSFMIF, self).__init__(register,
            'GAINBELOWGAINTHDSFMIF', 'AGC_NS.SMFIF.GAINBELOWGAINTHDSFMIF', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_GAINUPDATEFRZSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_GAINUPDATEFRZSFMIF, self).__init__(register,
            'GAINUPDATEFRZSFMIF', 'AGC_NS.SMFIF.GAINUPDATEFRZSFMIF', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_PNATTENSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_PNATTENSFMIF, self).__init__(register,
            'PNATTENSFMIF', 'AGC_NS.SMFIF.PNATTENSFMIF', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_COLLDETRSSIMAPRESFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_COLLDETRSSIMAPRESFMIF, self).__init__(register,
            'COLLDETRSSIMAPRESFMIF', 'AGC_NS.SMFIF.COLLDETRSSIMAPRESFMIF', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SMFIF_COLLDETRSSIMASYNCSFMIF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SMFIF_COLLDETRSSIMASYNCSFMIF, self).__init__(register,
            'COLLDETRSSIMASYNCSFMIF', 'AGC_NS.SMFIF.COLLDETRSSIMASYNCSFMIF', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSIVALIDSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSIVALIDSFMIEN, self).__init__(register,
            'RSSIVALIDSFMIEN', 'AGC_NS.SFMIEN.RSSIVALIDSFMIEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_CCASFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_CCASFMIEN, self).__init__(register,
            'CCASFMIEN', 'AGC_NS.SFMIEN.CCASFMIEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSIPOSSTEPSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSIPOSSTEPSFMIEN, self).__init__(register,
            'RSSIPOSSTEPSFMIEN', 'AGC_NS.SFMIEN.RSSIPOSSTEPSFMIEN', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSINEGSTEPSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSINEGSTEPSFMIEN, self).__init__(register,
            'RSSINEGSTEPSFMIEN', 'AGC_NS.SFMIEN.RSSINEGSTEPSFMIEN', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSIDONESFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSIDONESFMIEN, self).__init__(register,
            'RSSIDONESFMIEN', 'AGC_NS.SFMIEN.RSSIDONESFMIEN', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_SHORTRSSIPOSSTEPSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_SHORTRSSIPOSSTEPSFMIEN, self).__init__(register,
            'SHORTRSSIPOSSTEPSFMIEN', 'AGC_NS.SFMIEN.SHORTRSSIPOSSTEPSFMIEN', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RFPKDPRDDONESFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RFPKDPRDDONESFMIEN, self).__init__(register,
            'RFPKDPRDDONESFMIEN', 'AGC_NS.SFMIEN.RFPKDPRDDONESFMIEN', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RFPKDCNTDONESFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RFPKDCNTDONESFMIEN, self).__init__(register,
            'RFPKDCNTDONESFMIEN', 'AGC_NS.SFMIEN.RFPKDCNTDONESFMIEN', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSIHIGHSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSIHIGHSFMIEN, self).__init__(register,
            'RSSIHIGHSFMIEN', 'AGC_NS.SFMIEN.RSSIHIGHSFMIEN', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_RSSILOWSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_RSSILOWSFMIEN, self).__init__(register,
            'RSSILOWSFMIEN', 'AGC_NS.SFMIEN.RSSILOWSFMIEN', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_CCANODETSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_CCANODETSFMIEN, self).__init__(register,
            'CCANODETSFMIEN', 'AGC_NS.SFMIEN.CCANODETSFMIEN', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_GAINBELOWGAINTHDSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_GAINBELOWGAINTHDSFMIEN, self).__init__(register,
            'GAINBELOWGAINTHDSFMIEN', 'AGC_NS.SFMIEN.GAINBELOWGAINTHDSFMIEN', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_GAINUPDATEFRZSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_GAINUPDATEFRZSFMIEN, self).__init__(register,
            'GAINUPDATEFRZSFMIEN', 'AGC_NS.SFMIEN.GAINUPDATEFRZSFMIEN', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_PNATTENSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_PNATTENSFMIEN, self).__init__(register,
            'PNATTENSFMIEN', 'AGC_NS.SFMIEN.PNATTENSFMIEN', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_COLLDETRSSIMAPRESFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_COLLDETRSSIMAPRESFMIEN, self).__init__(register,
            'COLLDETRSSIMAPRESFMIEN', 'AGC_NS.SFMIEN.COLLDETRSSIMAPRESFMIEN', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_AGC_NS_SFMIEN_COLLDETRSSIMASYNCSFMIEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_NS_SFMIEN_COLLDETRSSIMASYNCSFMIEN, self).__init__(register,
            'COLLDETRSSIMASYNCSFMIEN', 'AGC_NS.SFMIEN.COLLDETRSSIMASYNCSFMIEN', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True
