...
class RM_Field_FEFILT0_S_CFG_CMUENRECONFIG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_CFG_CMUENRECONFIG, self).__init__(register,
            'CMUENRECONFIG', 'FEFILT0_S.CFG.CMUENRECONFIG', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FEFILT0_S_DIGIGAINCTRL_DEC1LOG2X4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_DIGIGAINCTRL_DEC1LOG2X4, self).__init__(register,
            'DEC1LOG2X4', 'FEFILT0_S.DIGIGAINCTRL.DEC1LOG2X4', 'read-write',
            u"",
            16, 6)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FEFILT0_S_CHFCTRL_GAINREDUCTION(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_CHFCTRL_GAINREDUCTION, self).__init__(register,
            'GAINREDUCTION', 'FEFILT0_S.CHFCTRL.GAINREDUCTION', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FEFILT0_S_DCCOMPFILTINIT_DCCOMPFORCEINIT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_DCCOMPFILTINIT_DCCOMPFORCEINIT, self).__init__(register,
            'DCCOMPFORCEINIT', 'FEFILT0_S.DCCOMPFILTINIT.DCCOMPFORCEINIT', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FEFILT0_S_ADPC3_ADBBSSEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSEN, self).__init__(register,
            'ADBBSSEN', 'FEFILT0_S.ADPC3.ADBBSSEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSFILTLENGTH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSFILTLENGTH, self).__init__(register,
            'ADBBSSFILTLENGTH', 'FEFILT0_S.ADPC3.ADBBSSFILTLENGTH', 'read-write',
            u"",
            1, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGEN, self).__init__(register,
            'ADBBSSAVGEN', 'FEFILT0_S.ADPC3.ADBBSSAVGEN', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGPER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGPER, self).__init__(register,
            'ADBBSSAVGPER', 'FEFILT0_S.ADPC3.ADBBSSAVGPER', 'read-write',
            u"",
            5, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAMPMANT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAMPMANT, self).__init__(register,
            'ADBBSSAMPMANT', 'FEFILT0_S.ADPC3.ADBBSSAMPMANT', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAMPEXP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAMPEXP, self).__init__(register,
            'ADBBSSAMPEXP', 'FEFILT0_S.ADPC3.ADBBSSAMPEXP', 'read-write',
            u"",
            12, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGWAIT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGWAIT, self).__init__(register,
            'ADBBSSAVGWAIT', 'FEFILT0_S.ADPC3.ADBBSSAVGWAIT', 'read-write',
            u"",
            16, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGFREEZE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSAVGFREEZE, self).__init__(register,
            'ADBBSSAVGFREEZE', 'FEFILT0_S.ADPC3.ADBBSSAVGFREEZE', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC3_ADBBSSSELWRDATA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC3_ADBBSSSELWRDATA, self).__init__(register,
            'ADBBSSSELWRDATA', 'FEFILT0_S.ADPC3.ADBBSSSELWRDATA', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT0, self).__init__(register,
            'ADBBSSAMPLUT0', 'FEFILT0_S.ADPC4.ADBBSSAMPLUT0', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT1, self).__init__(register,
            'ADBBSSAMPLUT1', 'FEFILT0_S.ADPC4.ADBBSSAMPLUT1', 'read-write',
            u"",
            8, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT2, self).__init__(register,
            'ADBBSSAMPLUT2', 'FEFILT0_S.ADPC4.ADBBSSAMPLUT2', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT3(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC4_ADBBSSAMPLUT3, self).__init__(register,
            'ADBBSSAMPLUT3', 'FEFILT0_S.ADPC4.ADBBSSAMPLUT3', 'read-write',
            u"",
            24, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT4(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT4, self).__init__(register,
            'ADBBSSAMPLUT4', 'FEFILT0_S.ADPC5.ADBBSSAMPLUT4', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT5(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT5, self).__init__(register,
            'ADBBSSAMPLUT5', 'FEFILT0_S.ADPC5.ADBBSSAMPLUT5', 'read-write',
            u"",
            8, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT6(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT6, self).__init__(register,
            'ADBBSSAMPLUT6', 'FEFILT0_S.ADPC5.ADBBSSAMPLUT6', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT7(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC5_ADBBSSAMPLUT7, self).__init__(register,
            'ADBBSSAMPLUT7', 'FEFILT0_S.ADPC5.ADBBSSAMPLUT7', 'read-write',
            u"",
            24, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT8(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT8, self).__init__(register,
            'ADBBSSAMPLUT8', 'FEFILT0_S.ADPC6.ADBBSSAMPLUT8', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT9(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT9, self).__init__(register,
            'ADBBSSAMPLUT9', 'FEFILT0_S.ADPC6.ADBBSSAMPLUT9', 'read-write',
            u"",
            8, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT10(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT10, self).__init__(register,
            'ADBBSSAMPLUT10', 'FEFILT0_S.ADPC6.ADBBSSAMPLUT10', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC6_ADBBSSAMPLUT11, self).__init__(register,
            'ADBBSSAMPLUT11', 'FEFILT0_S.ADPC6.ADBBSSAMPLUT11', 'read-write',
            u"",
            24, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT12(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT12, self).__init__(register,
            'ADBBSSAMPLUT12', 'FEFILT0_S.ADPC7.ADBBSSAMPLUT12', 'read-write',
            u"",
            0, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT13(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT13, self).__init__(register,
            'ADBBSSAMPLUT13', 'FEFILT0_S.ADPC7.ADBBSSAMPLUT13', 'read-write',
            u"",
            8, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT14(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT14, self).__init__(register,
            'ADBBSSAMPLUT14', 'FEFILT0_S.ADPC7.ADBBSSAMPLUT14', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT15(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC7_ADBBSSAMPLUT15, self).__init__(register,
            'ADBBSSAMPLUT15', 'FEFILT0_S.ADPC7.ADBBSSAMPLUT15', 'read-write',
            u"",
            24, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC9_ADBBSSAMPAVGLIM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC9_ADBBSSAMPAVGLIM, self).__init__(register,
            'ADBBSSAMPAVGLIM', 'FEFILT0_S.ADPC9.ADBBSSAMPAVGLIM', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC9_ADBBSSAMPTHR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC9_ADBBSSAMPTHR, self).__init__(register,
            'ADBBSSAMPTHR', 'FEFILT0_S.ADPC9.ADBBSSAMPTHR', 'read-write',
            u"",
            8, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC9_ADBBSSSYNCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC9_ADBBSSSYNCEN, self).__init__(register,
            'ADBBSSSYNCEN', 'FEFILT0_S.ADPC9.ADBBSSSYNCEN', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC9_ADBBSSUPTHR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC9_ADBBSSUPTHR, self).__init__(register,
            'ADBBSSUPTHR', 'FEFILT0_S.ADPC9.ADBBSSUPTHR', 'read-write',
            u"",
            17, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC9_ADBBSSDNTHR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC9_ADBBSSDNTHR, self).__init__(register,
            'ADBBSSDNTHR', 'FEFILT0_S.ADPC9.ADBBSSDNTHR', 'read-write',
            u"",
            21, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC10_ADBBSSAMPJUMP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC10_ADBBSSAMPJUMP, self).__init__(register,
            'ADBBSSAMPJUMP', 'FEFILT0_S.ADPC10.ADBBSSAMPJUMP', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC10_ADBBSSCHANGEEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC10_ADBBSSCHANGEEN, self).__init__(register,
            'ADBBSSCHANGEEN', 'FEFILT0_S.ADPC10.ADBBSSCHANGEEN', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC10_ADBBSSCHGUPTHR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC10_ADBBSSCHGUPTHR, self).__init__(register,
            'ADBBSSCHGUPTHR', 'FEFILT0_S.ADPC10.ADBBSSCHGUPTHR', 'read-write',
            u"",
            9, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_FEFILT0_S_ADPC10_ADBBSSCHGDNTHR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FEFILT0_S_ADPC10_ADBBSSCHGDNTHR, self).__init__(register,
            'ADBBSSCHGDNTHR', 'FEFILT0_S.ADPC10.ADBBSSCHGDNTHR', 'read-write',
            u"",
            13, 4)
        self.__dict__['zz_frozen'] = True
