...
class RM_Register_AGC_S_PNRFATT1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT3 = RM_Field_AGC_S_PNRFATT1_LNAMIXRFATT3(self)
...
class RM_Register_AGC_S_PNRFATT2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT5 = RM_Field_AGC_S_PNRFATT2_LNAMIXRFATT5(self)
        self.zz_fdict['LNAMIXRFATT5'] = self.LNAMIXRFATT5
        self.LNAMIXRFATT6 = RM_Field_AGC_S_PNRFATT2_LNAMIXRFATT6(self)
...
class RM_Register_AGC_S_PNRFATT3(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT7 = RM_Field_AGC_S_PNRFATT3_LNAMIXRFATT7(self)
        self.zz_fdict['LNAMIXRFATT7'] = self.LNAMIXRFATT7
        self.LNAMIXRFATT8 = RM_Field_AGC_S_PNRFATT3_LNAMIXRFATT8(self)
...
class RM_Register_AGC_S_PNRFATT4(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT9 = RM_Field_AGC_S_PNRFATT4_LNAMIXRFATT9(self)
        self.zz_fdict['LNAMIXRFATT9'] = self.LNAMIXRFATT9
        self.LNAMIXRFATT10 = RM_Field_AGC_S_PNRFATT4_LNAMIXRFATT10(self)
...
class RM_Register_AGC_S_PNRFATT5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT11 = RM_Field_AGC_S_PNRFATT5_LNAMIXRFATT11(self)
        self.zz_fdict['LNAMIXRFATT11'] = self.LNAMIXRFATT11
        self.LNAMIXRFATT12 = RM_Field_AGC_S_PNRFATT5_LNAMIXRFATT12(self)
...
class RM_Register_AGC_S_PNRFATT6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT13 = RM_Field_AGC_S_PNRFATT6_LNAMIXRFATT13(self)
        self.zz_fdict['LNAMIXRFATT13'] = self.LNAMIXRFATT13
        self.LNAMIXRFATT14 = RM_Field_AGC_S_PNRFATT6_LNAMIXRFATT14(self)
...
class RM_Register_AGC_S_PNRFATT7(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXRFATT15 = RM_Field_AGC_S_PNRFATT7_LNAMIXRFATT15(self)
        self.zz_fdict['LNAMIXRFATT15'] = self.LNAMIXRFATT15
        self.LNAMIXRFATT16 = RM_Field_AGC_S_PNRFATT7_LNAMIXRFATT16(self)
        self.zz_fdict['LNAMIXRFATT16'] = self.LNAMIXRFATT16
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNRFATT8(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNRFATT8, self).__init__(rmio, label,
            0xa800c000, 0x094,
            'PNRFATT8', 'AGC_S.PNRFATT8', 'read-write',
            u"",
            0x1BF815FE, 0x3FFF3FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXRFATT17 = RM_Field_AGC_S_PNRFATT8_LNAMIXRFATT17(self)
        self.zz_fdict['LNAMIXRFATT17'] = self.LNAMIXRFATT17
        self.LNAMIXRFATT18 = RM_Field_AGC_S_PNRFATT8_LNAMIXRFATT18(self)
        self.zz_fdict['LNAMIXRFATT18'] = self.LNAMIXRFATT18
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNRFATT9(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNRFATT9, self).__init__(rmio, label,
            0xa800c000, 0x098,
            'PNRFATT9', 'AGC_S.PNRFATT9', 'read-write',
            u"",
            0x2DB423DC, 0x3FFF3FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXRFATT19 = RM_Field_AGC_S_PNRFATT9_LNAMIXRFATT19(self)
        self.zz_fdict['LNAMIXRFATT19'] = self.LNAMIXRFATT19
        self.LNAMIXRFATT20 = RM_Field_AGC_S_PNRFATT9_LNAMIXRFATT20(self)
        self.zz_fdict['LNAMIXRFATT20'] = self.LNAMIXRFATT20
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNRFATT10(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNRFATT10, self).__init__(rmio, label,
            0xa800c000, 0x09C,
            'PNRFATT10', 'AGC_S.PNRFATT10', 'read-write',
            u"",
            0x3FFF39D0, 0x3FFF3FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXRFATT21 = RM_Field_AGC_S_PNRFATT10_LNAMIXRFATT21(self)
        self.zz_fdict['LNAMIXRFATT21'] = self.LNAMIXRFATT21
        self.LNAMIXRFATT22 = RM_Field_AGC_S_PNRFATT10_LNAMIXRFATT22(self)
        self.zz_fdict['LNAMIXRFATT22'] = self.LNAMIXRFATT22
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_PNRFATT11(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_PNRFATT11, self).__init__(rmio, label,
            0xa800c000, 0x0A0,
            'PNRFATT11', 'AGC_S.PNRFATT11', 'read-write',
            u"",
            0x00003FFF, 0x00003FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXRFATT23 = RM_Field_AGC_S_PNRFATT11_LNAMIXRFATT23(self)
...
class RM_Register_AGC_S_SMFIF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_SMFIF, self).__init__(rmio, label,
            0xa800c000, 0x120,
            'SMFIF', 'AGC_S.SMFIF', 'read-write',
            u"",
            0x00000000, 0x0003FF7D,
            0x00001000, 0x00002000,
            0x00003000)

        self.RSSIVALIDSFMIF = RM_Field_AGC_S_SMFIF_RSSIVALIDSFMIF(self)
        self.zz_fdict['RSSIVALIDSFMIF'] = self.RSSIVALIDSFMIF
        self.CCASFMIF = RM_Field_AGC_S_SMFIF_CCASFMIF(self)
        self.zz_fdict['CCASFMIF'] = self.CCASFMIF
        self.RSSIPOSSTEPSFMIF = RM_Field_AGC_S_SMFIF_RSSIPOSSTEPSFMIF(self)
        self.zz_fdict['RSSIPOSSTEPSFMIF'] = self.RSSIPOSSTEPSFMIF
        self.RSSINEGSTEPSFMIF = RM_Field_AGC_S_SMFIF_RSSINEGSTEPSFMIF(self)
        self.zz_fdict['RSSINEGSTEPSFMIF'] = self.RSSINEGSTEPSFMIF
        self.RSSIDONESFMIF = RM_Field_AGC_S_SMFIF_RSSIDONESFMIF(self)
        self.zz_fdict['RSSIDONESFMIF'] = self.RSSIDONESFMIF
        self.SHORTRSSIPOSSTEPSFMIF = RM_Field_AGC_S_SMFIF_SHORTRSSIPOSSTEPSFMIF(self)
        self.zz_fdict['SHORTRSSIPOSSTEPSFMIF'] = self.SHORTRSSIPOSSTEPSFMIF
        self.RFPKDPRDDONESFMIF = RM_Field_AGC_S_SMFIF_RFPKDPRDDONESFMIF(self)
        self.zz_fdict['RFPKDPRDDONESFMIF'] = self.RFPKDPRDDONESFMIF
        self.RFPKDCNTDONESFMIF = RM_Field_AGC_S_SMFIF_RFPKDCNTDONESFMIF(self)
        self.zz_fdict['RFPKDCNTDONESFMIF'] = self.RFPKDCNTDONESFMIF
        self.RSSIHIGHSFMIF = RM_Field_AGC_S_SMFIF_RSSIHIGHSFMIF(self)
        self.zz_fdict['RSSIHIGHSFMIF'] = self.RSSIHIGHSFMIF
        self.RSSILOWSFMIF = RM_Field_AGC_S_SMFIF_RSSILOWSFMIF(self)
        self.zz_fdict['RSSILOWSFMIF'] = self.RSSILOWSFMIF
        self.CCANODETSFMIF = RM_Field_AGC_S_SMFIF_CCANODETSFMIF(self)
        self.zz_fdict['CCANODETSFMIF'] = self.CCANODETSFMIF
        self.GAINBELOWGAINTHDSFMIF = RM_Field_AGC_S_SMFIF_GAINBELOWGAINTHDSFMIF(self)
        self.zz_fdict['GAINBELOWGAINTHDSFMIF'] = self.GAINBELOWGAINTHDSFMIF
        self.GAINUPDATEFRZSFMIF = RM_Field_AGC_S_SMFIF_GAINUPDATEFRZSFMIF(self)
        self.zz_fdict['GAINUPDATEFRZSFMIF'] = self.GAINUPDATEFRZSFMIF
        self.PNATTENSFMIF = RM_Field_AGC_S_SMFIF_PNATTENSFMIF(self)
        self.zz_fdict['PNATTENSFMIF'] = self.PNATTENSFMIF
        self.COLLDETRSSIMAPRESFMIF = RM_Field_AGC_S_SMFIF_COLLDETRSSIMAPRESFMIF(self)
        self.zz_fdict['COLLDETRSSIMAPRESFMIF'] = self.COLLDETRSSIMAPRESFMIF
        self.COLLDETRSSIMASYNCSFMIF = RM_Field_AGC_S_SMFIF_COLLDETRSSIMASYNCSFMIF(self)
        self.zz_fdict['COLLDETRSSIMASYNCSFMIF'] = self.COLLDETRSSIMASYNCSFMIF
        self.__dict__['zz_frozen'] = True


class RM_Register_AGC_S_SFMIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_AGC_S_SFMIEN, self).__init__(rmio, label,
            0xa800c000, 0x124,
            'SFMIEN', 'AGC_S.SFMIEN', 'read-write',
            u"",
            0x00000000, 0x0003FF7D,
            0x00001000, 0x00002000,
            0x00003000)

        self.RSSIVALIDSFMIEN = RM_Field_AGC_S_SFMIEN_RSSIVALIDSFMIEN(self)
        self.zz_fdict['RSSIVALIDSFMIEN'] = self.RSSIVALIDSFMIEN
        self.CCASFMIEN = RM_Field_AGC_S_SFMIEN_CCASFMIEN(self)
        self.zz_fdict['CCASFMIEN'] = self.CCASFMIEN
        self.RSSIPOSSTEPSFMIEN = RM_Field_AGC_S_SFMIEN_RSSIPOSSTEPSFMIEN(self)
        self.zz_fdict['RSSIPOSSTEPSFMIEN'] = self.RSSIPOSSTEPSFMIEN
        self.RSSINEGSTEPSFMIEN = RM_Field_AGC_S_SFMIEN_RSSINEGSTEPSFMIEN(self)
        self.zz_fdict['RSSINEGSTEPSFMIEN'] = self.RSSINEGSTEPSFMIEN
        self.RSSIDONESFMIEN = RM_Field_AGC_S_SFMIEN_RSSIDONESFMIEN(self)
        self.zz_fdict['RSSIDONESFMIEN'] = self.RSSIDONESFMIEN
        self.SHORTRSSIPOSSTEPSFMIEN = RM_Field_AGC_S_SFMIEN_SHORTRSSIPOSSTEPSFMIEN(self)
        self.zz_fdict['SHORTRSSIPOSSTEPSFMIEN'] = self.SHORTRSSIPOSSTEPSFMIEN
        self.RFPKDPRDDONESFMIEN = RM_Field_AGC_S_SFMIEN_RFPKDPRDDONESFMIEN(self)
        self.zz_fdict['RFPKDPRDDONESFMIEN'] = self.RFPKDPRDDONESFMIEN
        self.RFPKDCNTDONESFMIEN = RM_Field_AGC_S_SFMIEN_RFPKDCNTDONESFMIEN(self)
        self.zz_fdict['RFPKDCNTDONESFMIEN'] = self.RFPKDCNTDONESFMIEN
        self.RSSIHIGHSFMIEN = RM_Field_AGC_S_SFMIEN_RSSIHIGHSFMIEN(self)
        self.zz_fdict['RSSIHIGHSFMIEN'] = self.RSSIHIGHSFMIEN
        self.RSSILOWSFMIEN = RM_Field_AGC_S_SFMIEN_RSSILOWSFMIEN(self)
        self.zz_fdict['RSSILOWSFMIEN'] = self.RSSILOWSFMIEN
        self.CCANODETSFMIEN = RM_Field_AGC_S_SFMIEN_CCANODETSFMIEN(self)
        self.zz_fdict['CCANODETSFMIEN'] = self.CCANODETSFMIEN
        self.GAINBELOWGAINTHDSFMIEN = RM_Field_AGC_S_SFMIEN_GAINBELOWGAINTHDSFMIEN(self)
        self.zz_fdict['GAINBELOWGAINTHDSFMIEN'] = self.GAINBELOWGAINTHDSFMIEN
        self.GAINUPDATEFRZSFMIEN = RM_Field_AGC_S_SFMIEN_GAINUPDATEFRZSFMIEN(self)
        self.zz_fdict['GAINUPDATEFRZSFMIEN'] = self.GAINUPDATEFRZSFMIEN
        self.PNATTENSFMIEN = RM_Field_AGC_S_SFMIEN_PNATTENSFMIEN(self)
        self.zz_fdict['PNATTENSFMIEN'] = self.PNATTENSFMIEN
        self.COLLDETRSSIMAPRESFMIEN = RM_Field_AGC_S_SFMIEN_COLLDETRSSIMAPRESFMIEN(self)
        self.zz_fdict['COLLDETRSSIMAPRESFMIEN'] = self.COLLDETRSSIMAPRESFMIEN
        self.COLLDETRSSIMASYNCSFMIEN = RM_Field_AGC_S_SFMIEN_COLLDETRSSIMASYNCSFMIEN(self)
