...
class RM_Field_MODEM_NS_CTRL5_INTOSR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CTRL5_INTOSR, self).__init__(register,
            'INTOSR', 'MODEM_NS.CTRL5.INTOSR', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_PHDMODANTDIV_SKIPTHDSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PHDMODANTDIV_SKIPTHDSEL, self).__init__(register,
            'SKIPTHDSEL', 'MODEM_NS.PHDMODANTDIV.SKIPTHDSEL', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_PHDMODANTDIV_RECHKCORREN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PHDMODANTDIV_RECHKCORREN, self).__init__(register,
            'RECHKCORREN', 'MODEM_NS.PHDMODANTDIV.RECHKCORREN', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_PHDMODANTDIV_ANTDECRSTBYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PHDMODANTDIV_ANTDECRSTBYP, self).__init__(register,
            'ANTDECRSTBYP', 'MODEM_NS.PHDMODANTDIV.ANTDECRSTBYP', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
