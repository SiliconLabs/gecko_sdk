...
class RM_Register_SYNTH_S_STATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CAPCALRUNNING = RM_Field_SYNTH_S_STATUS_CAPCALRUNNING(self)
        self.zz_fdict['CAPCALRUNNING'] = self.CAPCALRUNNING
        self.CAPCALBITRESULT = RM_Field_SYNTH_S_STATUS_CAPCALBITRESULT(self)
        self.zz_fdict['CAPCALBITRESULT'] = self.CAPCALBITRESULT
        self.CAPCALFULLWAIT = RM_Field_SYNTH_S_STATUS_CAPCALFULLWAIT(self)
        self.zz_fdict['CAPCALFULLWAIT'] = self.CAPCALFULLWAIT
        self.CAPCALERROR = RM_Field_SYNTH_S_STATUS_CAPCALERROR(self)
        ...
        self.CHPALLOWTRISTATE = RM_Field_SYNTH_S_STATUS_CHPALLOWTRISTATE(self)
...
class RM_Register_SYNTH_S_CTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TRISTATEPOSTPONE = RM_Field_SYNTH_S_CTRL_TRISTATEPOSTPONE(self)
...
class RM_Register_SYNTH_S_CALCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_CALCTRL, self).__init__(rmio, label,
            0xa8018000, 0x014,
            'CALCTRL', 'SYNTH_S.CALCTRL', 'read-write',
            u"",
            0x00002801, 0x0F007FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.NUMCYCLES = RM_Field_SYNTH_S_CALCTRL_NUMCYCLES(self)
        self.zz_fdict['NUMCYCLES'] = self.NUMCYCLES
        self.CAPCALSIDE = RM_Field_SYNTH_S_CALCTRL_CAPCALSIDE(self)
        self.zz_fdict['CAPCALSIDE'] = self.CAPCALSIDE
        self.CAPCALENDMODE = RM_Field_SYNTH_S_CALCTRL_CAPCALENDMODE(self)
        self.zz_fdict['CAPCALENDMODE'] = self.CAPCALENDMODE
        self.CAPCALCYCLEWAIT = RM_Field_SYNTH_S_CALCTRL_CAPCALCYCLEWAIT(self)
        self.zz_fdict['CAPCALCYCLEWAIT'] = self.CAPCALCYCLEWAIT
        self.CAPCALWAITMODE = RM_Field_SYNTH_S_CALCTRL_CAPCALWAITMODE(self)
        self.zz_fdict['CAPCALWAITMODE'] = self.CAPCALWAITMODE
        self.CAPCALSINGLESTEP = RM_Field_SYNTH_S_CALCTRL_CAPCALSINGLESTEP(self)
        self.zz_fdict['CAPCALSINGLESTEP'] = self.CAPCALSINGLESTEP
        self.STARTUPTIMING = RM_Field_SYNTH_S_CALCTRL_STARTUPTIMING(self)
        self.zz_fdict['STARTUPTIMING'] = self.STARTUPTIMING
        self.SYNTHOVERRIDEEN = RM_Field_SYNTH_S_CALCTRL_SYNTHOVERRIDEEN(self)
        self.zz_fdict['SYNTHOVERRIDEEN'] = self.SYNTHOVERRIDEEN
        self.CLKLOADDENOMVAL = RM_Field_SYNTH_S_CALCTRL_CLKLOADDENOMVAL(self)
        self.zz_fdict['CLKLOADDENOMVAL'] = self.CLKLOADDENOMVAL
        self.PRESCALERRESETVAL = RM_Field_SYNTH_S_CALCTRL_PRESCALERRESETVAL(self)
        self.zz_fdict['PRESCALERRESETVAL'] = self.PRESCALERRESETVAL
        self.COUNTERRESETVAL = RM_Field_SYNTH_S_CALCTRL_COUNTERRESETVAL(self)
...
class RM_Register_SYNTH_S_VCDACCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LPFEN = RM_Field_SYNTH_S_VCDACCTRL_LPFEN(self)
        self.zz_fdict['LPFEN'] = self.LPFEN
        self.LPFQSEN = RM_Field_SYNTH_S_VCDACCTRL_LPFQSEN(self)
...
class RM_Register_SYNTH_S_CHPDACCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_CHPDACCTRL, self).__init__(rmio, label,
            0xa8018000, 0x068,
            'CHPDACCTRL', 'SYNTH_S.CHPDACCTRL', 'read-write',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.CHPDACVAL = RM_Field_SYNTH_S_CHPDACCTRL_CHPDACVAL(self)
        self.zz_fdict['CHPDACVAL'] = self.CHPDACVAL
        self.OVERRIDE = RM_Field_SYNTH_S_CHPDACCTRL_OVERRIDE(self)
        self.zz_fdict['OVERRIDE'] = self.OVERRIDE
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_CAPCALCYCLECNT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_CAPCALCYCLECNT, self).__init__(rmio, label,
            0xa8018000, 0x06C,
            'CAPCALCYCLECNT', 'SYNTH_S.CAPCALCYCLECNT', 'read-only',
            u"",
            0x00000000, 0x000003FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.CAPCALCYCLECNT = RM_Field_SYNTH_S_CAPCALCYCLECNT_CAPCALCYCLECNT(self)
...
class RM_Register_SYNTH_S_MMDDENOMINIT(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DENOMINIT2 = RM_Field_SYNTH_S_MMDDENOMINIT_DENOMINIT2(self)
        self.zz_fdict['DENOMINIT2'] = self.DENOMINIT2
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_CHPDACINIT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_CHPDACINIT, self).__init__(rmio, label,
            0xa8018000, 0x098,
            'CHPDACINIT', 'SYNTH_S.CHPDACINIT', 'read-write',
            u"",
            0x00000000, 0x00000FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.DACINIT = RM_Field_SYNTH_S_CHPDACINIT_DACINIT(self)
        self.zz_fdict['DACINIT'] = self.DACINIT
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_LPFCTRL1CAL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_LPFCTRL1CAL, self).__init__(rmio, label,
            0xa8018000, 0x09C,
            'LPFCTRL1CAL', 'SYNTH_S.LPFCTRL1CAL', 'read-write',
            u"",
            0x00000000, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.OP1BWCAL = RM_Field_SYNTH_S_LPFCTRL1CAL_OP1BWCAL(self)
        self.zz_fdict['OP1BWCAL'] = self.OP1BWCAL
        self.OP1COMPCAL = RM_Field_SYNTH_S_LPFCTRL1CAL_OP1COMPCAL(self)
        self.zz_fdict['OP1COMPCAL'] = self.OP1COMPCAL
        self.RFBVALCAL = RM_Field_SYNTH_S_LPFCTRL1CAL_RFBVALCAL(self)
        self.zz_fdict['RFBVALCAL'] = self.RFBVALCAL
        self.RPVALCAL = RM_Field_SYNTH_S_LPFCTRL1CAL_RPVALCAL(self)
        self.zz_fdict['RPVALCAL'] = self.RPVALCAL
        self.RZVALCAL = RM_Field_SYNTH_S_LPFCTRL1CAL_RZVALCAL(self)
        self.zz_fdict['RZVALCAL'] = self.RZVALCAL
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_LPFCTRL1RX(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_LPFCTRL1RX, self).__init__(rmio, label,
            0xa8018000, 0x0A0,
            'LPFCTRL1RX', 'SYNTH_S.LPFCTRL1RX', 'read-write',
            u"",
            0x00000000, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.OP1BWRX = RM_Field_SYNTH_S_LPFCTRL1RX_OP1BWRX(self)
        self.zz_fdict['OP1BWRX'] = self.OP1BWRX
        self.OP1COMPRX = RM_Field_SYNTH_S_LPFCTRL1RX_OP1COMPRX(self)
        self.zz_fdict['OP1COMPRX'] = self.OP1COMPRX
        self.RFBVALRX = RM_Field_SYNTH_S_LPFCTRL1RX_RFBVALRX(self)
        self.zz_fdict['RFBVALRX'] = self.RFBVALRX
        self.RPVALRX = RM_Field_SYNTH_S_LPFCTRL1RX_RPVALRX(self)
        self.zz_fdict['RPVALRX'] = self.RPVALRX
        self.RZVALRX = RM_Field_SYNTH_S_LPFCTRL1RX_RZVALRX(self)
        self.zz_fdict['RZVALRX'] = self.RZVALRX
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_LPFCTRL1TX(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_LPFCTRL1TX, self).__init__(rmio, label,
            0xa8018000, 0x0A4,
            'LPFCTRL1TX', 'SYNTH_S.LPFCTRL1TX', 'read-write',
            u"",
            0x00000000, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.OP1BWTX = RM_Field_SYNTH_S_LPFCTRL1TX_OP1BWTX(self)
        self.zz_fdict['OP1BWTX'] = self.OP1BWTX
        self.OP1COMPTX = RM_Field_SYNTH_S_LPFCTRL1TX_OP1COMPTX(self)
        self.zz_fdict['OP1COMPTX'] = self.OP1COMPTX
        self.RFBVALTX = RM_Field_SYNTH_S_LPFCTRL1TX_RFBVALTX(self)
        self.zz_fdict['RFBVALTX'] = self.RFBVALTX
        self.RPVALTX = RM_Field_SYNTH_S_LPFCTRL1TX_RPVALTX(self)
        self.zz_fdict['RPVALTX'] = self.RPVALTX
        self.RZVALTX = RM_Field_SYNTH_S_LPFCTRL1TX_RZVALTX(self)
        self.zz_fdict['RZVALTX'] = self.RZVALTX
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_LPFCTRL2RX(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_LPFCTRL2RX, self).__init__(rmio, label,
            0xa8018000, 0x0A8,
            'LPFCTRL2RX', 'SYNTH_S.LPFCTRL2RX', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LPFSWENRX = RM_Field_SYNTH_S_LPFCTRL2RX_LPFSWENRX(self)
        self.zz_fdict['LPFSWENRX'] = self.LPFSWENRX
        self.LPFINCAPRX = RM_Field_SYNTH_S_LPFCTRL2RX_LPFINCAPRX(self)
        self.zz_fdict['LPFINCAPRX'] = self.LPFINCAPRX
        self.LPFGNDSWENRX = RM_Field_SYNTH_S_LPFCTRL2RX_LPFGNDSWENRX(self)
        self.zz_fdict['LPFGNDSWENRX'] = self.LPFGNDSWENRX
        self.CALCRX = RM_Field_SYNTH_S_LPFCTRL2RX_CALCRX(self)
        self.zz_fdict['CALCRX'] = self.CALCRX
        self.CASELRX = RM_Field_SYNTH_S_LPFCTRL2RX_CASELRX(self)
        self.zz_fdict['CASELRX'] = self.CASELRX
        self.CAVALRX = RM_Field_SYNTH_S_LPFCTRL2RX_CAVALRX(self)
        self.zz_fdict['CAVALRX'] = self.CAVALRX
        self.CFBSELRX = RM_Field_SYNTH_S_LPFCTRL2RX_CFBSELRX(self)
        self.zz_fdict['CFBSELRX'] = self.CFBSELRX
        self.CZSELRX = RM_Field_SYNTH_S_LPFCTRL2RX_CZSELRX(self)
        self.zz_fdict['CZSELRX'] = self.CZSELRX
        self.CZVALRX = RM_Field_SYNTH_S_LPFCTRL2RX_CZVALRX(self)
        self.zz_fdict['CZVALRX'] = self.CZVALRX
        self.MODESELRX = RM_Field_SYNTH_S_LPFCTRL2RX_MODESELRX(self)
        self.zz_fdict['MODESELRX'] = self.MODESELRX
        self.VCMLVLRX = RM_Field_SYNTH_S_LPFCTRL2RX_VCMLVLRX(self)
        self.zz_fdict['VCMLVLRX'] = self.VCMLVLRX
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_LPFCTRL2TX(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_LPFCTRL2TX, self).__init__(rmio, label,
            0xa8018000, 0x0AC,
            'LPFCTRL2TX', 'SYNTH_S.LPFCTRL2TX', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LPFSWENTX = RM_Field_SYNTH_S_LPFCTRL2TX_LPFSWENTX(self)
        self.zz_fdict['LPFSWENTX'] = self.LPFSWENTX
        self.LPFINCAPTX = RM_Field_SYNTH_S_LPFCTRL2TX_LPFINCAPTX(self)
        self.zz_fdict['LPFINCAPTX'] = self.LPFINCAPTX
        self.LPFGNDSWENTX = RM_Field_SYNTH_S_LPFCTRL2TX_LPFGNDSWENTX(self)
        self.zz_fdict['LPFGNDSWENTX'] = self.LPFGNDSWENTX
        self.CALCTX = RM_Field_SYNTH_S_LPFCTRL2TX_CALCTX(self)
        self.zz_fdict['CALCTX'] = self.CALCTX
        self.CASELTX = RM_Field_SYNTH_S_LPFCTRL2TX_CASELTX(self)
        self.zz_fdict['CASELTX'] = self.CASELTX
        self.CAVALTX = RM_Field_SYNTH_S_LPFCTRL2TX_CAVALTX(self)
        self.zz_fdict['CAVALTX'] = self.CAVALTX
        self.CFBSELTX = RM_Field_SYNTH_S_LPFCTRL2TX_CFBSELTX(self)
        self.zz_fdict['CFBSELTX'] = self.CFBSELTX
        self.CZSELTX = RM_Field_SYNTH_S_LPFCTRL2TX_CZSELTX(self)
        self.zz_fdict['CZSELTX'] = self.CZSELTX
        self.CZVALTX = RM_Field_SYNTH_S_LPFCTRL2TX_CZVALTX(self)
        self.zz_fdict['CZVALTX'] = self.CZVALTX
        self.MODESELTX = RM_Field_SYNTH_S_LPFCTRL2TX_MODESELTX(self)
        self.zz_fdict['MODESELTX'] = self.MODESELTX
        self.VCMLVLTX = RM_Field_SYNTH_S_LPFCTRL2TX_VCMLVLTX(self)
...
class RM_Register_SYNTH_S_DSMCTRLRX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DITHERDSMINPUTRX = RM_Field_SYNTH_S_DSMCTRLRX_DITHERDSMINPUTRX(self)
        self.zz_fdict['DITHERDSMINPUTRX'] = self.DITHERDSMINPUTRX
        self.DITHERDSMOUTPUTRX = RM_Field_SYNTH_S_DSMCTRLRX_DITHERDSMOUTPUTRX(self)
        ...
        self.DSMMODERX = RM_Field_SYNTH_S_DSMCTRLRX_DSMMODERX(self)
        ...
        self.MASHORDERRX = RM_Field_SYNTH_S_DSMCTRLRX_MASHORDERRX(self)
...
class RM_Register_SYNTH_S_DSMCTRLTX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DITHERDSMINPUTTX = RM_Field_SYNTH_S_DSMCTRLTX_DITHERDSMINPUTTX(self)
        self.zz_fdict['DITHERDSMINPUTTX'] = self.DITHERDSMINPUTTX
        self.DITHERDSMOUTPUTTX = RM_Field_SYNTH_S_DSMCTRLTX_DITHERDSMOUTPUTTX(self)
        ...
        self.DSMMODETX = RM_Field_SYNTH_S_DSMCTRLTX_DSMMODETX(self)
        ...
        self.MASHORDERTX = RM_Field_SYNTH_S_DSMCTRLTX_MASHORDERTX(self)
...
class RM_Register_SYNTH_S_SFMIF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_SFMIF, self).__init__(rmio, label,
            0xa8018000, 0x0C0,
            'SFMIF', 'SYNTH_S.SFMIF', 'read-write',
            u"",
            0x00000000, 0x00000237,
            0x00001000, 0x00002000,
            0x00003000)

        self.LOCKEDSFMIF = RM_Field_SYNTH_S_SFMIF_LOCKEDSFMIF(self)
        self.zz_fdict['LOCKEDSFMIF'] = self.LOCKEDSFMIF
        self.UNLOCKEDSFMIF = RM_Field_SYNTH_S_SFMIF_UNLOCKEDSFMIF(self)
        self.zz_fdict['UNLOCKEDSFMIF'] = self.UNLOCKEDSFMIF
        self.SYRDYSFMIF = RM_Field_SYNTH_S_SFMIF_SYRDYSFMIF(self)
        self.zz_fdict['SYRDYSFMIF'] = self.SYRDYSFMIF
        self.VCOHIGHSFMIF = RM_Field_SYNTH_S_SFMIF_VCOHIGHSFMIF(self)
        self.zz_fdict['VCOHIGHSFMIF'] = self.VCOHIGHSFMIF
        self.VCOLOWSFMIF = RM_Field_SYNTH_S_SFMIF_VCOLOWSFMIF(self)
        self.zz_fdict['VCOLOWSFMIF'] = self.VCOLOWSFMIF
        self.LOCNTDONESFMIF = RM_Field_SYNTH_S_SFMIF_LOCNTDONESFMIF(self)
        self.zz_fdict['LOCNTDONESFMIF'] = self.LOCNTDONESFMIF
        self.__dict__['zz_frozen'] = True


class RM_Register_SYNTH_S_SFMIEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_SYNTH_S_SFMIEN, self).__init__(rmio, label,
            0xa8018000, 0x0C4,
            'SFMIEN', 'SYNTH_S.SFMIEN', 'read-write',
            u"",
            0x00000000, 0x00000237,
            0x00001000, 0x00002000,
            0x00003000)

        self.LOCKEDSFMIEN = RM_Field_SYNTH_S_SFMIEN_LOCKEDSFMIEN(self)
        self.zz_fdict['LOCKEDSFMIEN'] = self.LOCKEDSFMIEN
        self.UNLOCKEDSFMIEN = RM_Field_SYNTH_S_SFMIEN_UNLOCKEDSFMIEN(self)
        self.zz_fdict['UNLOCKEDSFMIEN'] = self.UNLOCKEDSFMIEN
        self.SYRDYSFMIEN = RM_Field_SYNTH_S_SFMIEN_SYRDYSFMIEN(self)
        self.zz_fdict['SYRDYSFMIEN'] = self.SYRDYSFMIEN
        self.VCOHIGHSFMIEN = RM_Field_SYNTH_S_SFMIEN_VCOHIGHSFMIEN(self)
        self.zz_fdict['VCOHIGHSFMIEN'] = self.VCOHIGHSFMIEN
        self.VCOLOWSFMIEN = RM_Field_SYNTH_S_SFMIEN_VCOLOWSFMIEN(self)
        self.zz_fdict['VCOLOWSFMIEN'] = self.VCOLOWSFMIEN
        self.LOCNTDONESFMIEN = RM_Field_SYNTH_S_SFMIEN_LOCNTDONESFMIEN(self)
