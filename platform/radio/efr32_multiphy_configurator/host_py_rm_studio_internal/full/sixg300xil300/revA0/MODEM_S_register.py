...
class RM_Register_MODEM_S_CTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.INTOSR = RM_Field_MODEM_S_CTRL5_INTOSR(self)
...
class RM_Register_MODEM_S_PHDMODANTDIV(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SKIPTHDSEL = RM_Field_MODEM_S_PHDMODANTDIV_SKIPTHDSEL(self)
        self.zz_fdict['SKIPTHDSEL'] = self.SKIPTHDSEL
        self.RECHKCORREN = RM_Field_MODEM_S_PHDMODANTDIV_RECHKCORREN(self)
        ...
        self.ANTDECRSTBYP = RM_Field_MODEM_S_PHDMODANTDIV_ANTDECRSTBYP(self)
...
class RM_Register_MODEM_S_PHDMODCTRL1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_PHDMODCTRL1, self).__init__(rmio, label,
            0xa8014000, 0x250,
            'PHDMODCTRL1', 'MODEM_S.PHDMODCTRL1', 'read-write',
            u"",
            0x00000000, 0x00000001,
            0x00001000, 0x00002000,
            0x00003000)

        self.TRECSFREQESTSEL = RM_Field_MODEM_S_PHDMODCTRL1_TRECSFREQESTSEL(self)
...
class RM_Register_MODEM_S_LOG2X4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_LOG2X4, self).__init__(rmio, label,
            0xa8014000, 0x270,
            'LOG2X4', 'MODEM_S.LOG2X4', 'read-write',
            u"",
            0x00000000, 0x000000FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LOG2X4 = RM_Field_MODEM_S_LOG2X4_LOG2X4(self)
        self.zz_fdict['LOG2X4'] = self.LOG2X4
        self.LOG2X4FWSEL = RM_Field_MODEM_S_LOG2X4_LOG2X4FWSEL(self)
...
class RM_Register_MODEM_S_BCRDEMODCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RSTEXTEN = RM_Field_MODEM_S_BCRDEMODCTRL_RSTEXTEN(self)
