...
class RM_Register_MODEM_S_AFCADJRX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_MODEM_S_AFCADJRX, self).__init__(rmio, label,
            0xa8014000, 0x014,
            'AFCADJRX', 'MODEM_S.AFCADJRX', 'read-only',
            u"",
...
class RM_Register_MODEM_S_AFCADJTX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        super(RM_Register_MODEM_S_AFCADJTX, self).__init__(rmio, label,
            0xa8014000, 0x018,
            'AFCADJTX', 'MODEM_S.AFCADJTX', 'read-only',
            u"",
            0x00000000, 0x0007FFFF,
            0x00001000, 0x00002000,
            0x00003000)
...
class RM_Register_MODEM_S_MIXCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.ANAMIXMODE = RM_Field_MODEM_S_MIXCTRL_ANAMIXMODE(self)
...
class RM_Register_MODEM_S_CTRL5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PRSDEBUG = RM_Field_MODEM_S_CTRL5_PRSDEBUG(self)
        ...
        self.XINGDEBUG = RM_Field_MODEM_S_CTRL5_XINGDEBUG(self)
...
class RM_Register_MODEM_S_CF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RESYNCRESETTIMING = RM_Field_MODEM_S_CF_RESYNCRESETTIMING(self)
        self.zz_fdict['RESYNCRESETTIMING'] = self.RESYNCRESETTIMING
        self.RESYNCBYPASS = RM_Field_MODEM_S_CF_RESYNCBYPASS(self)
...
class RM_Register_MODEM_S_AFC(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.AFCSCALEM = RM_Field_MODEM_S_AFC_AFCSCALEM(self)
        self.zz_fdict['AFCSCALEM'] = self.AFCSCALEM
        self.AFCSCALEE = RM_Field_MODEM_S_AFC_AFCSCALEE(self)
...
class RM_Register_MODEM_S_SHAPING4(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.COEFF20 = RM_Field_MODEM_S_SHAPING4_COEFF20(self)
        self.zz_fdict['COEFF20'] = self.COEFF20
        self.COEFF21 = RM_Field_MODEM_S_SHAPING4_COEFF21(self)
...
class RM_Register_MODEM_S_SHAPING5(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.COEFF24 = RM_Field_MODEM_S_SHAPING5_COEFF24(self)
        self.zz_fdict['COEFF24'] = self.COEFF24
        self.COEFF25 = RM_Field_MODEM_S_SHAPING5_COEFF25(self)
        self.zz_fdict['COEFF25'] = self.COEFF25
        self.COEFF26 = RM_Field_MODEM_S_SHAPING5_COEFF26(self)
        self.zz_fdict['COEFF26'] = self.COEFF26
        self.COEFF27 = RM_Field_MODEM_S_SHAPING5_COEFF27(self)
        self.zz_fdict['COEFF27'] = self.COEFF27
        self.COEFF28 = RM_Field_MODEM_S_SHAPING5_COEFF28(self)
        self.zz_fdict['COEFF28'] = self.COEFF28
        self.COEFF29 = RM_Field_MODEM_S_SHAPING5_COEFF29(self)
...
class RM_Register_MODEM_S_SHAPING6(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.COEFF30 = RM_Field_MODEM_S_SHAPING6_COEFF30(self)
        self.zz_fdict['COEFF30'] = self.COEFF30
        self.COEFF31 = RM_Field_MODEM_S_SHAPING6_COEFF31(self)
        self.zz_fdict['COEFF31'] = self.COEFF31
        self.COEFF32 = RM_Field_MODEM_S_SHAPING6_COEFF32(self)
        self.zz_fdict['COEFF32'] = self.COEFF32
        self.COEFF33 = RM_Field_MODEM_S_SHAPING6_COEFF33(self)
        self.zz_fdict['COEFF33'] = self.COEFF33
        self.COEFF34 = RM_Field_MODEM_S_SHAPING6_COEFF34(self)
        self.zz_fdict['COEFF34'] = self.COEFF34
        self.COEFF35 = RM_Field_MODEM_S_SHAPING6_COEFF35(self)
        self.zz_fdict['COEFF35'] = self.COEFF35
        self.COEFF36 = RM_Field_MODEM_S_SHAPING6_COEFF36(self)
        self.zz_fdict['COEFF36'] = self.COEFF36
        self.COEFF37 = RM_Field_MODEM_S_SHAPING6_COEFF37(self)
        self.zz_fdict['COEFF37'] = self.COEFF37
        self.COEFF38 = RM_Field_MODEM_S_SHAPING6_COEFF38(self)
        self.zz_fdict['COEFF38'] = self.COEFF38
        self.COEFF39 = RM_Field_MODEM_S_SHAPING6_COEFF39(self)
...
class RM_Register_MODEM_S_SRCCHF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SRCRATIO1 = RM_Field_MODEM_S_SRCCHF_SRCRATIO1(self)
        self.zz_fdict['SRCRATIO1'] = self.SRCRATIO1
        self.SRCENABLE1 = RM_Field_MODEM_S_SRCCHF_SRCENABLE1(self)
        ...
        self.BWSEL = RM_Field_MODEM_S_SRCCHF_BWSEL(self)
...
class RM_Register_MODEM_S_VITERBIDEMOD(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DISDEMODOF = RM_Field_MODEM_S_VITERBIDEMOD_DISDEMODOF(self)
...
class RM_Register_MODEM_S_VTCORRCFG1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CORRSHFTLEN = RM_Field_MODEM_S_VTCORRCFG1_CORRSHFTLEN(self)
        ...
        self.BUFFHEAD = RM_Field_MODEM_S_VTCORRCFG1_BUFFHEAD(self)
...
class RM_Register_MODEM_S_VTTRACK(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TIMCHK = RM_Field_MODEM_S_VTTRACK_TIMCHK(self)
        self.zz_fdict['TIMCHK'] = self.TIMCHK
        self.TIMEOUTMODE = RM_Field_MODEM_S_VTTRACK_TIMEOUTMODE(self)
...
class RM_Register_MODEM_S_LONGRANGE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LRCORRTHDDYNEN = RM_Field_MODEM_S_LONGRANGE_LRCORRTHDDYNEN(self)
...
class RM_Register_MODEM_S_BLEIQDSA(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_BLEIQDSA, self).__init__(rmio, label,
            0xa8014000, 0x230,
            'BLEIQDSA', 'MODEM_S.BLEIQDSA', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.BLEIQDSAEN = RM_Field_MODEM_S_BLEIQDSA_BLEIQDSAEN(self)
        self.zz_fdict['BLEIQDSAEN'] = self.BLEIQDSAEN
        self.BLEIQDSATH = RM_Field_MODEM_S_BLEIQDSA_BLEIQDSATH(self)
        self.zz_fdict['BLEIQDSATH'] = self.BLEIQDSATH
        self.BLEIQDSAIIRCOEFPWR = RM_Field_MODEM_S_BLEIQDSA_BLEIQDSAIIRCOEFPWR(self)
        self.zz_fdict['BLEIQDSAIIRCOEFPWR'] = self.BLEIQDSAIIRCOEFPWR
        self.BLEIQDSADIFFTH1 = RM_Field_MODEM_S_BLEIQDSA_BLEIQDSADIFFTH1(self)
        self.zz_fdict['BLEIQDSADIFFTH1'] = self.BLEIQDSADIFFTH1
        self.__dict__['zz_frozen'] = True


class RM_Register_MODEM_S_BLEIQDSAEXT1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_BLEIQDSAEXT1, self).__init__(rmio, label,
            0xa8014000, 0x234,
            'BLEIQDSAEXT1', 'MODEM_S.BLEIQDSAEXT1', 'read-write',
            u"",
            0x0E000000, 0x3FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.FREQSCALEIQDSA = RM_Field_MODEM_S_BLEIQDSAEXT1_FREQSCALEIQDSA(self)
        self.zz_fdict['FREQSCALEIQDSA'] = self.FREQSCALEIQDSA
        self.CHPWRFIRAVGEN = RM_Field_MODEM_S_BLEIQDSAEXT1_CHPWRFIRAVGEN(self)
        self.zz_fdict['CHPWRFIRAVGEN'] = self.CHPWRFIRAVGEN
        self.CHPWRFIRAVGVAL = RM_Field_MODEM_S_BLEIQDSAEXT1_CHPWRFIRAVGVAL(self)
        self.zz_fdict['CHPWRFIRAVGVAL'] = self.CHPWRFIRAVGVAL
        self.CORRIIRAVGMULFACT = RM_Field_MODEM_S_BLEIQDSAEXT1_CORRIIRAVGMULFACT(self)
        self.zz_fdict['CORRIIRAVGMULFACT'] = self.CORRIIRAVGMULFACT
        self.BLEIQDSAADDRBIAS = RM_Field_MODEM_S_BLEIQDSAEXT1_BLEIQDSAADDRBIAS(self)
        self.zz_fdict['BLEIQDSAADDRBIAS'] = self.BLEIQDSAADDRBIAS
        self.BLEIQDSATHCOMB = RM_Field_MODEM_S_BLEIQDSAEXT1_BLEIQDSATHCOMB(self)
        self.zz_fdict['BLEIQDSATHCOMB'] = self.BLEIQDSATHCOMB
        self.MAXCORRCNTIQDSA = RM_Field_MODEM_S_BLEIQDSAEXT1_MAXCORRCNTIQDSA(self)
        self.zz_fdict['MAXCORRCNTIQDSA'] = self.MAXCORRCNTIQDSA
        self.IIRRST = RM_Field_MODEM_S_BLEIQDSAEXT1_IIRRST(self)
...
class RM_Register_MODEM_S_SYNCPROPERTIES(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYNCCORRCLR = RM_Field_MODEM_S_SYNCPROPERTIES_SYNCCORRCLR(self)
        self.zz_fdict['SYNCCORRCLR'] = self.SYNCCORRCLR
        self.SYNCSECPEAKTH = RM_Field_MODEM_S_SYNCPROPERTIES_SYNCSECPEAKTH(self)
...
class RM_Register_MODEM_S_PADEBUG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.MANPAAMPCTRL = RM_Field_MODEM_S_PADEBUG_MANPAAMPCTRL(self)
        self.zz_fdict['MANPAAMPCTRL'] = self.MANPAAMPCTRL
        self.ENMANPAAMPCTRL = RM_Field_MODEM_S_PADEBUG_ENMANPAAMPCTRL(self)
        ...
        self.ENMANPATRIMPASLICE0DBM = RM_Field_MODEM_S_PADEBUG_ENMANPATRIMPASLICE0DBM(self)
