...
class RM_Field_AGC_S_STATUS0_ADCINDEX(Base_RM_Field):
    def __init__(self, register):
        ...
        super(RM_Field_AGC_S_STATUS0_ADCINDEX, self).__init__(register,
            'ADCINDEX', 'AGC_S.STATUS0.ADCINDEX', 'read-write',
            u"",
            23, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_AGC_S_CTRL0_AGCCLKUNDIVREQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_S_CTRL0_AGCCLKUNDIVREQ, self).__init__(register,
            'AGCCLKUNDIVREQ', 'AGC_S.CTRL0.AGCCLKUNDIVREQ', 'read-write',
            u"",
            21, 1)
        self.__dict__['zz_frozen'] = True
