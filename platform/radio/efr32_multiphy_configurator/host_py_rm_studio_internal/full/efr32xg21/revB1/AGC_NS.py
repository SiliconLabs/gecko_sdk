...
class RM_Peripheral_AGC_NS(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.AGCPERIOD = RM_Register_AGC_NS_AGCPERIOD(self.zz_rmio, self.zz_label)
        self.zz_rdict['AGCPERIOD'] = self.AGCPERIOD
        self.HICNTREGION = RM_Register_AGC_NS_HICNTREGION(self.zz_rmio, self.zz_label)
        ...
        self.GAINSTEPLIM = RM_Register_AGC_NS_GAINSTEPLIM(self.zz_rmio, self.zz_label)
