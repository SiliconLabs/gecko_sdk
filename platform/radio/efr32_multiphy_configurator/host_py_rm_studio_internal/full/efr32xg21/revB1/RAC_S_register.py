...
class RM_Register_RAC_S_IF(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.BUSERROR = RM_Field_RAC_S_IF_BUSERROR(self)
...
class RM_Register_RAC_S_IEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.zz_fdict['STIMCMPEV'] = self.STIMCMPEV
        self.BUSERROR = RM_Field_RAC_S_IEN_BUSERROR(self)
        self.zz_fdict['BUSERROR'] = self.BUSERROR
...
class RM_Register_RAC_S_TESTCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.AUX2RFSENSE = RM_Field_RAC_S_TESTCTRL_AUX2RFSENSE(self)
        self.zz_fdict['AUX2RFSENSE'] = self.AUX2RFSENSE
        self.LOOPBACK2LNAINPUT = RM_Field_RAC_S_TESTCTRL_LOOPBACK2LNAINPUT(self)
        self.zz_fdict['LOOPBACK2LNAINPUT'] = self.LOOPBACK2LNAINPUT
        self.LOOPBACK2LNAOUTPUT = RM_Field_RAC_S_TESTCTRL_LOOPBACK2LNAOUTPUT(self)
        self.zz_fdict['LOOPBACK2LNAOUTPUT'] = self.LOOPBACK2LNAOUTPUT
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_SEQSTATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_SEQSTATUS, self).__init__(rmio, label,
            0xa8020000, 0x028,
            'SEQSTATUS', 'RAC_S.SEQSTATUS', 'read-only',
            u"",
            0x00000010, 0x000005FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.STOPPED = RM_Field_RAC_S_SEQSTATUS_STOPPED(self)
        self.zz_fdict['STOPPED'] = self.STOPPED
        self.BKPT = RM_Field_RAC_S_SEQSTATUS_BKPT(self)
        self.zz_fdict['BKPT'] = self.BKPT
        self.WAITING = RM_Field_RAC_S_SEQSTATUS_WAITING(self)
        self.zz_fdict['WAITING'] = self.WAITING
        self.WAITMODE = RM_Field_RAC_S_SEQSTATUS_WAITMODE(self)
        self.zz_fdict['WAITMODE'] = self.WAITMODE
        self.DONE = RM_Field_RAC_S_SEQSTATUS_DONE(self)
        self.zz_fdict['DONE'] = self.DONE
        self.NEG = RM_Field_RAC_S_SEQSTATUS_NEG(self)
        self.zz_fdict['NEG'] = self.NEG
        self.POS = RM_Field_RAC_S_SEQSTATUS_POS(self)
        self.zz_fdict['POS'] = self.POS
        self.ZERO = RM_Field_RAC_S_SEQSTATUS_ZERO(self)
        self.zz_fdict['ZERO'] = self.ZERO
        self.CARRY = RM_Field_RAC_S_SEQSTATUS_CARRY(self)
        self.zz_fdict['CARRY'] = self.CARRY
        self.ABORTEN = RM_Field_RAC_S_SEQSTATUS_ABORTEN(self)
        self.zz_fdict['ABORTEN'] = self.ABORTEN
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_SEQCMD(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_SEQCMD, self).__init__(rmio, label,
            0xa8020000, 0x02C,
            'SEQCMD', 'RAC_S.SEQCMD', 'write-only',
            u"",
            0x00000000, 0x000000FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.HALT = RM_Field_RAC_S_SEQCMD_HALT(self)
        self.zz_fdict['HALT'] = self.HALT
        self.STEP = RM_Field_RAC_S_SEQCMD_STEP(self)
        self.zz_fdict['STEP'] = self.STEP
        self.RESUME = RM_Field_RAC_S_SEQCMD_RESUME(self)
        self.zz_fdict['RESUME'] = self.RESUME
        self.BKPTEN = RM_Field_RAC_S_SEQCMD_BKPTEN(self)
        self.zz_fdict['BKPTEN'] = self.BKPTEN
        self.BKPTDIS = RM_Field_RAC_S_SEQCMD_BKPTDIS(self)
        self.zz_fdict['BKPTDIS'] = self.BKPTDIS
        self.ABORT = RM_Field_RAC_S_SEQCMD_ABORT(self)
        self.zz_fdict['ABORT'] = self.ABORT
        self.ABORTENSET = RM_Field_RAC_S_SEQCMD_ABORTENSET(self)
        self.zz_fdict['ABORTENSET'] = self.ABORTENSET
        self.ABORTENCLEAR = RM_Field_RAC_S_SEQCMD_ABORTENCLEAR(self)
        self.zz_fdict['ABORTENCLEAR'] = self.ABORTENCLEAR
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_BREAKPOINT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_BREAKPOINT, self).__init__(rmio, label,
            0xa8020000, 0x030,
            'BREAKPOINT', 'RAC_S.BREAKPOINT', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.BKPADDR = RM_Field_RAC_S_BREAKPOINT_BKPADDR(self)
        self.zz_fdict['BKPADDR'] = self.BKPADDR
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R0(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R0, self).__init__(rmio, label,
            0xa8020000, 0x034,
            'R0', 'RAC_S.R0', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R0 = RM_Field_RAC_S_R0_R0(self)
        self.zz_fdict['R0'] = self.R0
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R1(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R1, self).__init__(rmio, label,
            0xa8020000, 0x038,
            'R1', 'RAC_S.R1', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R1 = RM_Field_RAC_S_R1_R1(self)
        self.zz_fdict['R1'] = self.R1
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R2, self).__init__(rmio, label,
            0xa8020000, 0x03C,
            'R2', 'RAC_S.R2', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R2 = RM_Field_RAC_S_R2_R2(self)
        self.zz_fdict['R2'] = self.R2
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R3(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R3, self).__init__(rmio, label,
            0xa8020000, 0x040,
            'R3', 'RAC_S.R3', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R3 = RM_Field_RAC_S_R3_R3(self)
        self.zz_fdict['R3'] = self.R3
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R4(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R4, self).__init__(rmio, label,
            0xa8020000, 0x044,
            'R4', 'RAC_S.R4', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R4 = RM_Field_RAC_S_R4_R4(self)
        self.zz_fdict['R4'] = self.R4
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R5(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R5, self).__init__(rmio, label,
            0xa8020000, 0x048,
            'R5', 'RAC_S.R5', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R5 = RM_Field_RAC_S_R5_R5(self)
        self.zz_fdict['R5'] = self.R5
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R6(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R6, self).__init__(rmio, label,
            0xa8020000, 0x04C,
            'R6', 'RAC_S.R6', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R6 = RM_Field_RAC_S_R6_R6(self)
        self.zz_fdict['R6'] = self.R6
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_R7(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_R7, self).__init__(rmio, label,
            0xa8020000, 0x050,
            'R7', 'RAC_S.R7', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.R7 = RM_Field_RAC_S_R7_R7(self)
        self.zz_fdict['R7'] = self.R7
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_WAITMASK(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_WAITMASK, self).__init__(rmio, label,
            0xa8020000, 0x054,
            'WAITMASK', 'RAC_S.WAITMASK', 'read-only',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.STCMP = RM_Field_RAC_S_WAITMASK_STCMP(self)
        self.zz_fdict['STCMP'] = self.STCMP
        self.FRCRX = RM_Field_RAC_S_WAITMASK_FRCRX(self)
        self.zz_fdict['FRCRX'] = self.FRCRX
        self.FRCTX = RM_Field_RAC_S_WAITMASK_FRCTX(self)
        self.zz_fdict['FRCTX'] = self.FRCTX
        self.PRSEVENT = RM_Field_RAC_S_WAITMASK_PRSEVENT(self)
        self.zz_fdict['PRSEVENT'] = self.PRSEVENT
        self.DEMODRXREQCLR = RM_Field_RAC_S_WAITMASK_DEMODRXREQCLR(self)
        self.zz_fdict['DEMODRXREQCLR'] = self.DEMODRXREQCLR
        self.SYNTHRDY = RM_Field_RAC_S_WAITMASK_SYNTHRDY(self)
        self.zz_fdict['SYNTHRDY'] = self.SYNTHRDY
        self.RAMPDONE = RM_Field_RAC_S_WAITMASK_RAMPDONE(self)
        self.zz_fdict['RAMPDONE'] = self.RAMPDONE
        self.FRCPAUSED = RM_Field_RAC_S_WAITMASK_FRCPAUSED(self)
        self.zz_fdict['FRCPAUSED'] = self.FRCPAUSED
        self.ANTSWITCH = RM_Field_RAC_S_WAITMASK_ANTSWITCH(self)
        self.zz_fdict['ANTSWITCH'] = self.ANTSWITCH
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_WAITSNSH(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_WAITSNSH, self).__init__(rmio, label,
            0xa8020000, 0x058,
            'WAITSNSH', 'RAC_S.WAITSNSH', 'read-only',
            u"",
            0x00000000, 0x000003FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.WAITSNSH = RM_Field_RAC_S_WAITSNSH_WAITSNSH(self)
...
class RM_Register_RAC_S_VECTADDR(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_VECTADDR, self).__init__(rmio, label,
            0xa8020000, 0x064,
            'VECTADDR', 'RAC_S.VECTADDR', 'read-write',
            u"",
            0x00000000, 0xFFFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.VECTADDR = RM_Field_RAC_S_VECTADDR_VECTADDR(self)
...
class RM_Register_RAC_S_SEQCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CPUHALTREQEN = RM_Field_RAC_S_SEQCTRL_CPUHALTREQEN(self)
        self.zz_fdict['CPUHALTREQEN'] = self.CPUHALTREQEN
        self.SEQHALTUPONCPUHALTEN = RM_Field_RAC_S_SEQCTRL_SEQHALTUPONCPUHALTEN(self)
...
class RM_Register_RAC_S_WUREQ(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_WUREQ, self).__init__(rmio, label,
            0xa8020000, 0x080,
            'WUREQ', 'RAC_S.WUREQ', 'read-write',
            u"",
            0x00000000, 0x00000007,
            0x00001000, 0x00002000,
            0x00003000)

        self.MANUAL = RM_Field_RAC_S_WUREQ_MANUAL(self)
        self.zz_fdict['MANUAL'] = self.MANUAL
        self.OVERRIDE = RM_Field_RAC_S_WUREQ_OVERRIDE(self)
        self.zz_fdict['OVERRIDE'] = self.OVERRIDE
        self.STATUS = RM_Field_RAC_S_WUREQ_STATUS(self)
...
class RM_Register_RAC_S_VCOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.VCODETAMPLITUDE = RM_Field_RAC_S_VCOCTRL_VCODETAMPLITUDE(self)
...
class RM_Register_RAC_S_SYNTHCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_SYNTHCTRL, self).__init__(rmio, label,
            0xa8020000, 0x094,
            'SYNTHCTRL', 'RAC_S.SYNTHCTRL', 'read-write',
            u"",
            0x00000000, 0x00000400,
            0x00001000, 0x00002000,
            0x00003000)

        self.MMDPOWERBALANCEDISABLE = RM_Field_RAC_S_SYNTHCTRL_MMDPOWERBALANCEDISABLE(self)
...
class RM_Register_RAC_S_AUXADCCTRL0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.INPUTRESSEL = RM_Field_RAC_S_AUXADCCTRL0_INPUTRESSEL(self)
...
class RM_Register_RAC_S_CLKMULTEN0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.CLKMULTENDRVDIFF = RM_Field_RAC_S_CLKMULTEN0_CLKMULTENDRVDIFF(self)
...
class RM_Register_RAC_S_IFADCTRIM(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCTRIM, self).__init__(rmio, label,
            0xa8020000, 0x0D4,
            'IFADCTRIM', 'RAC_S.IFADCTRIM', 'read-write',
            u"",
            0x08965290, 0x0FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCCLKSEL = RM_Field_RAC_S_IFADCTRIM_IFADCCLKSEL(self)
        self.zz_fdict['IFADCCLKSEL'] = self.IFADCCLKSEL
        self.IFADCENHALFMODE = RM_Field_RAC_S_IFADCTRIM_IFADCENHALFMODE(self)
        self.zz_fdict['IFADCENHALFMODE'] = self.IFADCENHALFMODE
        self.IFADCLDOSERIESAMPLVL = RM_Field_RAC_S_IFADCTRIM_IFADCLDOSERIESAMPLVL(self)
        self.zz_fdict['IFADCLDOSERIESAMPLVL'] = self.IFADCLDOSERIESAMPLVL
        self.IFADCLDOSHUNTAMPLVL = RM_Field_RAC_S_IFADCTRIM_IFADCLDOSHUNTAMPLVL(self)
        self.zz_fdict['IFADCLDOSHUNTAMPLVL'] = self.IFADCLDOSHUNTAMPLVL
        self.IFADCLDOSHUNTCURLP = RM_Field_RAC_S_IFADCTRIM_IFADCLDOSHUNTCURLP(self)
        self.zz_fdict['IFADCLDOSHUNTCURLP'] = self.IFADCLDOSHUNTCURLP
        self.IFADCLDOSHUNTCURLVL = RM_Field_RAC_S_IFADCTRIM_IFADCLDOSHUNTCURLVL(self)
        self.zz_fdict['IFADCLDOSHUNTCURLVL'] = self.IFADCLDOSHUNTCURLVL
        self.IFADCOTAST1CURRENT = RM_Field_RAC_S_IFADCTRIM_IFADCOTAST1CURRENT(self)
        self.zz_fdict['IFADCOTAST1CURRENT'] = self.IFADCOTAST1CURRENT
        self.IFADCOTAST2CURRENT = RM_Field_RAC_S_IFADCTRIM_IFADCOTAST2CURRENT(self)
        self.zz_fdict['IFADCOTAST2CURRENT'] = self.IFADCOTAST2CURRENT
        self.IFADCREFBUFAMPLVL = RM_Field_RAC_S_IFADCTRIM_IFADCREFBUFAMPLVL(self)
        self.zz_fdict['IFADCREFBUFAMPLVL'] = self.IFADCREFBUFAMPLVL
        self.IFADCREFBUFCURLVL = RM_Field_RAC_S_IFADCTRIM_IFADCREFBUFCURLVL(self)
        self.zz_fdict['IFADCREFBUFCURLVL'] = self.IFADCREFBUFCURLVL
        self.IFADCSIDETONEAMP = RM_Field_RAC_S_IFADCTRIM_IFADCSIDETONEAMP(self)
        self.zz_fdict['IFADCSIDETONEAMP'] = self.IFADCSIDETONEAMP
        self.IFADCSIDETONEFREQ = RM_Field_RAC_S_IFADCTRIM_IFADCSIDETONEFREQ(self)
        self.zz_fdict['IFADCSIDETONEFREQ'] = self.IFADCSIDETONEFREQ
        self.IFADCTUNEZERO = RM_Field_RAC_S_IFADCTRIM_IFADCTUNEZERO(self)
        self.zz_fdict['IFADCTUNEZERO'] = self.IFADCTUNEZERO
        self.IFADCVCMLVL = RM_Field_RAC_S_IFADCTRIM_IFADCVCMLVL(self)
...
class RM_Register_RAC_S_LNAMIXDEBUG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXDISMXR2 = RM_Field_RAC_S_LNAMIXDEBUG_LNAMIXDISMXR2(self)
...
class RM_Register_RAC_S_LNAMIXTRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXCURCTRL = RM_Field_RAC_S_LNAMIXTRIM0_LNAMIXCURCTRL(self)
        self.zz_fdict['LNAMIXCURCTRL'] = self.LNAMIXCURCTRL
        self.LNAMIXHIGHCUR = RM_Field_RAC_S_LNAMIXTRIM0_LNAMIXHIGHCUR(self)
        self.zz_fdict['LNAMIXHIGHCUR'] = self.LNAMIXHIGHCUR
        self.LNAMIXLOWCUR = RM_Field_RAC_S_LNAMIXTRIM0_LNAMIXLOWCUR(self)
        ...
        self.LNAMIXRFPKDCALCM = RM_Field_RAC_S_LNAMIXTRIM0_LNAMIXRFPKDCALCM(self)
        self.zz_fdict['LNAMIXRFPKDCALCM'] = self.LNAMIXRFPKDCALCM
        self.LNAMIXRFPKDCALDM = RM_Field_RAC_S_LNAMIXTRIM0_LNAMIXRFPKDCALDM(self)
...
class RM_Register_RAC_S_LNAMIXTRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXIBIAS1ADJ = RM_Field_RAC_S_LNAMIXTRIM1_LNAMIXIBIAS1ADJ(self)
        ...
        self.LNAMIXPCAS1ADJ = RM_Field_RAC_S_LNAMIXTRIM1_LNAMIXPCAS1ADJ(self)
...
class RM_Register_RAC_S_LNAMIXTRIM2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXIBIAS2ADJ = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXIBIAS2ADJ(self)
        self.zz_fdict['LNAMIXIBIAS2ADJ'] = self.LNAMIXIBIAS2ADJ
        self.LNAMIXLNA2CAPSEL = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXLNA2CAPSEL(self)
        self.zz_fdict['LNAMIXLNA2CAPSEL'] = self.LNAMIXLNA2CAPSEL
        self.LNAMIXMXRBIAS2 = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXMXRBIAS2(self)
        self.zz_fdict['LNAMIXMXRBIAS2'] = self.LNAMIXMXRBIAS2
        self.LNAMIXNCAS2ADJ = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXNCAS2ADJ(self)
        self.zz_fdict['LNAMIXNCAS2ADJ'] = self.LNAMIXNCAS2ADJ
        self.LNAMIXPCAS2ADJ = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXPCAS2ADJ(self)
        self.zz_fdict['LNAMIXPCAS2ADJ'] = self.LNAMIXPCAS2ADJ
        self.LNAMIXVOUT2ADJ = RM_Field_RAC_S_LNAMIXTRIM2_LNAMIXVOUT2ADJ(self)
...
class RM_Register_RAC_S_LNAMIXCAL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXENIRCAL2 = RM_Field_RAC_S_LNAMIXCAL_LNAMIXENIRCAL2(self)
        ...
        self.LNAMIXIRCAL2AMP = RM_Field_RAC_S_LNAMIXCAL_LNAMIXIRCAL2AMP(self)
...
class RM_Register_RAC_S_PATRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PATRIMDRVREGIBCORE0DBM = RM_Field_RAC_S_PATRIM0_PATRIMDRVREGIBCORE0DBM(self)
        self.zz_fdict['PATRIMDRVREGIBCORE0DBM'] = self.PATRIMDRVREGIBCORE0DBM
        self.PATRIMDRVREGIBNDIO0DBM = RM_Field_RAC_S_PATRIM0_PATRIMDRVREGIBNDIO0DBM(self)
        self.zz_fdict['PATRIMDRVREGIBNDIO0DBM'] = self.PATRIMDRVREGIBNDIO0DBM
        self.PATRIMDRVREGPSR0DBM = RM_Field_RAC_S_PATRIM0_PATRIMDRVREGPSR0DBM(self)
        self.zz_fdict['PATRIMDRVREGPSR0DBM'] = self.PATRIMDRVREGPSR0DBM
        self.PATRIMDRVSLICE0DBM = RM_Field_RAC_S_PATRIM0_PATRIMDRVSLICE0DBM(self)
        self.zz_fdict['PATRIMDRVSLICE0DBM'] = self.PATRIMDRVSLICE0DBM
        self.PATRIMFB0DBM = RM_Field_RAC_S_PATRIM0_PATRIMFB0DBM(self)
        self.zz_fdict['PATRIMFB0DBM'] = self.PATRIMFB0DBM
        self.PATRIMPABIASN0DBM = RM_Field_RAC_S_PATRIM0_PATRIMPABIASN0DBM(self)
        self.zz_fdict['PATRIMPABIASN0DBM'] = self.PATRIMPABIASN0DBM
        self.PATRIMPABIASP0DBM = RM_Field_RAC_S_PATRIM0_PATRIMPABIASP0DBM(self)
        self.zz_fdict['PATRIMPABIASP0DBM'] = self.PATRIMPABIASP0DBM
        self.PATRIMPASLICE0DBM = RM_Field_RAC_S_PATRIM0_PATRIMPASLICE0DBM(self)
        self.zz_fdict['PATRIMPASLICE0DBM'] = self.PATRIMPASLICE0DBM
        self.PATRIMVREF0DBM = RM_Field_RAC_S_PATRIM0_PATRIMVREF0DBM(self)
...
class RM_Register_RAC_S_PATRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PATRIM10DBMDUTYCYN = RM_Field_RAC_S_PATRIM1_PATRIM10DBMDUTYCYN(self)
        self.zz_fdict['PATRIM10DBMDUTYCYN'] = self.PATRIM10DBMDUTYCYN
        self.PATRIM10DBMDUTYCYP = RM_Field_RAC_S_PATRIM1_PATRIM10DBMDUTYCYP(self)
        self.zz_fdict['PATRIM10DBMDUTYCYP'] = self.PATRIM10DBMDUTYCYP
        self.PATRIM20DBMPREDRV = RM_Field_RAC_S_PATRIM1_PATRIM20DBMPREDRV(self)
        self.zz_fdict['PATRIM20DBMPREDRV'] = self.PATRIM20DBMPREDRV
        self.PATRIMANTSWBIAS = RM_Field_RAC_S_PATRIM1_PATRIMANTSWBIAS(self)
        self.zz_fdict['PATRIMANTSWBIAS'] = self.PATRIMANTSWBIAS
        self.PATRIMBLEEDAUTOPREREG = RM_Field_RAC_S_PATRIM1_PATRIMBLEEDAUTOPREREG(self)
        self.zz_fdict['PATRIMBLEEDAUTOPREREG'] = self.PATRIMBLEEDAUTOPREREG
        self.PATRIMCAPPAOUTM = RM_Field_RAC_S_PATRIM1_PATRIMCAPPAOUTM(self)
        self.zz_fdict['PATRIMCAPPAOUTM'] = self.PATRIMCAPPAOUTM
        self.PATRIMCAPPAOUTP = RM_Field_RAC_S_PATRIM1_PATRIMCAPPAOUTP(self)
        self.zz_fdict['PATRIMCAPPAOUTP'] = self.PATRIMCAPPAOUTP
        self.PATRIMCMGAIN = RM_Field_RAC_S_PATRIM1_PATRIMCMGAIN(self)
        self.zz_fdict['PATRIMCMGAIN'] = self.PATRIMCMGAIN
        self.PATRIMDLY0 = RM_Field_RAC_S_PATRIM1_PATRIMDLY0(self)
        self.zz_fdict['PATRIMDLY0'] = self.PATRIMDLY0
        self.PATRIMDLY1 = RM_Field_RAC_S_PATRIM1_PATRIMDLY1(self)
        self.zz_fdict['PATRIMDLY1'] = self.PATRIMDLY1
        self.PATRIMFBKATTPDRVLDO = RM_Field_RAC_S_PATRIM1_PATRIMFBKATTPDRVLDO(self)
        self.zz_fdict['PATRIMFBKATTPDRVLDO'] = self.PATRIMFBKATTPDRVLDO
        self.PATRIMIBIASMASTER = RM_Field_RAC_S_PATRIM1_PATRIMIBIASMASTER(self)
...
class RM_Register_RAC_S_PATRIM2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PATRIMLDOFBHVPDRVLDO = RM_Field_RAC_S_PATRIM2_PATRIMLDOFBHVPDRVLDO(self)
        self.zz_fdict['PATRIMLDOFBHVPDRVLDO'] = self.PATRIMLDOFBHVPDRVLDO
        self.PATRIMLDOFBHVPREREG = RM_Field_RAC_S_PATRIM2_PATRIMLDOFBHVPREREG(self)
        self.zz_fdict['PATRIMLDOFBHVPREREG'] = self.PATRIMLDOFBHVPREREG
        self.PATRIMLDOHVPDRVLDO = RM_Field_RAC_S_PATRIM2_PATRIMLDOHVPDRVLDO(self)
        self.zz_fdict['PATRIMLDOHVPDRVLDO'] = self.PATRIMLDOHVPDRVLDO
        self.PATRIMLDOHVPREREG = RM_Field_RAC_S_PATRIM2_PATRIMLDOHVPREREG(self)
        self.zz_fdict['PATRIMLDOHVPREREG'] = self.PATRIMLDOHVPREREG
        self.PATRIMLDOPSRPDRVLDO = RM_Field_RAC_S_PATRIM2_PATRIMLDOPSRPDRVLDO(self)
        self.zz_fdict['PATRIMLDOPSRPDRVLDO'] = self.PATRIMLDOPSRPDRVLDO
        self.PATRIMLDOPSRPREREG = RM_Field_RAC_S_PATRIM2_PATRIMLDOPSRPREREG(self)
        self.zz_fdict['PATRIMLDOPSRPREREG'] = self.PATRIMLDOPSRPREREG
        self.PATRIMLDOSLICESPDRVLDO = RM_Field_RAC_S_PATRIM2_PATRIMLDOSLICESPDRVLDO(self)
        self.zz_fdict['PATRIMLDOSLICESPDRVLDO'] = self.PATRIMLDOSLICESPDRVLDO
        self.PATRIMLDOSLICESPREREG = RM_Field_RAC_S_PATRIM2_PATRIMLDOSLICESPREREG(self)
        self.zz_fdict['PATRIMLDOSLICESPREREG'] = self.PATRIMLDOSLICESPREREG
        self.PATRIMPADACGLITCH = RM_Field_RAC_S_PATRIM2_PATRIMPADACGLITCH(self)
        self.zz_fdict['PATRIMPADACGLITCH'] = self.PATRIMPADACGLITCH
        self.PATRIMNBIAS = RM_Field_RAC_S_PATRIM2_PATRIMNBIAS(self)
        self.zz_fdict['PATRIMNBIAS'] = self.PATRIMNBIAS
        self.PATRIMNCASC = RM_Field_RAC_S_PATRIM2_PATRIMNCASC(self)
        self.zz_fdict['PATRIMNCASC'] = self.PATRIMNCASC
        self.PATRIMPBIAS = RM_Field_RAC_S_PATRIM2_PATRIMPBIAS(self)
        self.zz_fdict['PATRIMPBIAS'] = self.PATRIMPBIAS
        self.PATRIMPCASC = RM_Field_RAC_S_PATRIM2_PATRIMPCASC(self)
...
class RM_Register_RAC_S_PACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PAEN10DBMVMID = RM_Field_RAC_S_PACTRL_PAEN10DBMVMID(self)
        self.zz_fdict['PAEN10DBMVMID'] = self.PAEN10DBMVMID
        self.PAEN20DBMVMID = RM_Field_RAC_S_PACTRL_PAEN20DBMVMID(self)
        self.zz_fdict['PAEN20DBMVMID'] = self.PAEN20DBMVMID
        self.PAENCAPATT = RM_Field_RAC_S_PACTRL_PAENCAPATT(self)
        self.zz_fdict['PAENCAPATT'] = self.PAENCAPATT
        self.PAENLATCHBYPASS = RM_Field_RAC_S_PACTRL_PAENLATCHBYPASS(self)
        self.zz_fdict['PAENLATCHBYPASS'] = self.PAENLATCHBYPASS
        self.PAENPOWERRAMPINGCLK = RM_Field_RAC_S_PACTRL_PAENPOWERRAMPINGCLK(self)
        self.zz_fdict['PAENPOWERRAMPINGCLK'] = self.PAENPOWERRAMPINGCLK
        self.PAPULLDOWNVDDPA = RM_Field_RAC_S_PACTRL_PAPULLDOWNVDDPA(self)
        self.zz_fdict['PAPULLDOWNVDDPA'] = self.PAPULLDOWNVDDPA
        self.PAREGBYPASSPDRVLDO = RM_Field_RAC_S_PACTRL_PAREGBYPASSPDRVLDO(self)
        self.zz_fdict['PAREGBYPASSPDRVLDO'] = self.PAREGBYPASSPDRVLDO
        self.PAREGBYPASSPREREG = RM_Field_RAC_S_PACTRL_PAREGBYPASSPREREG(self)
        self.zz_fdict['PAREGBYPASSPREREG'] = self.PAREGBYPASSPREREG
        self.PASELLDOVDDPA = RM_Field_RAC_S_PACTRL_PASELLDOVDDPA(self)
        self.zz_fdict['PASELLDOVDDPA'] = self.PASELLDOVDDPA
        self.PASELLDOVDDRF = RM_Field_RAC_S_PACTRL_PASELLDOVDDRF(self)
        self.zz_fdict['PASELLDOVDDRF'] = self.PASELLDOVDDRF
        self.PASLICERST = RM_Field_RAC_S_PACTRL_PASLICERST(self)
        self.zz_fdict['PASLICERST'] = self.PASLICERST
        self.PAPOWER = RM_Field_RAC_S_PACTRL_PAPOWER(self)
        self.zz_fdict['PAPOWER'] = self.PAPOWER
        self.PASELSLICE = RM_Field_RAC_S_PACTRL_PASELSLICE(self)
        self.zz_fdict['PASELSLICE'] = self.PASELSLICE
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_PGADEBUG(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_PGADEBUG, self).__init__(rmio, label,
            0xa8020000, 0x10C,
            'PGADEBUG', 'RAC_S.PGADEBUG', 'read-write',
            u"",
            0x00000004, 0x00000007,
            0x00001000, 0x00002000,
            0x00003000)

        self.PGACCTRIM = RM_Field_RAC_S_PGADEBUG_PGACCTRIM(self)
...
class RM_Register_RAC_S_PGATRIM(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PGADISANTILOCK = RM_Field_RAC_S_PGATRIM_PGADISANTILOCK(self)
...
class RM_Register_RAC_S_PGACAL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PGAOFFNCALI = RM_Field_RAC_S_PGACAL_PGAOFFNCALI(self)
        self.zz_fdict['PGAOFFNCALI'] = self.PGAOFFNCALI
        self.PGAOFFNCALQ = RM_Field_RAC_S_PGACAL_PGAOFFNCALQ(self)
        self.zz_fdict['PGAOFFNCALQ'] = self.PGAOFFNCALQ
        self.PGAOFFPCALI = RM_Field_RAC_S_PGACAL_PGAOFFPCALI(self)
        self.zz_fdict['PGAOFFPCALI'] = self.PGAOFFPCALI
        self.PGAOFFPCALQ = RM_Field_RAC_S_PGACAL_PGAOFFPCALQ(self)
...
class RM_Register_RAC_S_PGACTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PGAENHYST = RM_Field_RAC_S_PGACTRL_PGAENHYST(self)
        ...
        self.PGAENOFFD = RM_Field_RAC_S_PGACTRL_PGAENOFFD(self)
        ...
        self.PGAENRCMOUT = RM_Field_RAC_S_PGACTRL_PGAENRCMOUT(self)
        ...
        self.LNAMIXRFPKDTHRESHSEL = RM_Field_RAC_S_PGACTRL_LNAMIXRFPKDTHRESHSEL(self)
...
class RM_Register_RAC_S_RFPATHEN1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.LNAMIXEN0DBMPA1 = RM_Field_RAC_S_RFPATHEN1_LNAMIXEN0DBMPA1(self)
        ...
        self.PAENANT1 = RM_Field_RAC_S_RFPATHEN1_PAENANT1(self)
        self.zz_fdict['PAENANT1'] = self.PAENANT1
        self.PAENPA10DBM = RM_Field_RAC_S_RFPATHEN1_PAENPA10DBM(self)
        self.zz_fdict['PAENPA10DBM'] = self.PAENPA10DBM
        self.PAENPAPREDRV10DBM = RM_Field_RAC_S_RFPATHEN1_PAENPAPREDRV10DBM(self)
        self.zz_fdict['PAENPAPREDRV10DBM'] = self.PAENPAPREDRV10DBM
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_RFPATHEN2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_RFPATHEN2, self).__init__(rmio, label,
            0xa8020000, 0x12C,
            'RFPATHEN2', 'RAC_S.RFPATHEN2', 'read-write',
            u"",
            0x00000004, 0x000000FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.LNAMIXEN0DBMPA2 = RM_Field_RAC_S_RFPATHEN2_LNAMIXEN0DBMPA2(self)
        self.zz_fdict['LNAMIXEN0DBMPA2'] = self.LNAMIXEN0DBMPA2
        self.LNAMIXEN2 = RM_Field_RAC_S_RFPATHEN2_LNAMIXEN2(self)
        self.zz_fdict['LNAMIXEN2'] = self.LNAMIXEN2
        self.LNAMIXRFATTDCEN2 = RM_Field_RAC_S_RFPATHEN2_LNAMIXRFATTDCEN2(self)
        self.zz_fdict['LNAMIXRFATTDCEN2'] = self.LNAMIXRFATTDCEN2
        self.LNAMIXRFPKDENRF2 = RM_Field_RAC_S_RFPATHEN2_LNAMIXRFPKDENRF2(self)
        self.zz_fdict['LNAMIXRFPKDENRF2'] = self.LNAMIXRFPKDENRF2
        self.LNAMIXTRSW2 = RM_Field_RAC_S_RFPATHEN2_LNAMIXTRSW2(self)
        self.zz_fdict['LNAMIXTRSW2'] = self.LNAMIXTRSW2
        self.PAENANT2 = RM_Field_RAC_S_RFPATHEN2_PAENANT2(self)
        self.zz_fdict['PAENANT2'] = self.PAENANT2
        self.PAENPA20DBM = RM_Field_RAC_S_RFPATHEN2_PAENPA20DBM(self)
        self.zz_fdict['PAENPA20DBM'] = self.PAENPA20DBM
        self.PAENPAPREDRV20DBM = RM_Field_RAC_S_RFPATHEN2_PAENPAPREDRV20DBM(self)
...
class RM_Register_RAC_S_RX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPBIASTRIMBUF = RM_Field_RAC_S_RX_SYCHPBIASTRIMBUF(self)
        ...
        self.SYMMDMODE = RM_Field_RAC_S_RX_SYMMDMODE(self)
        self.zz_fdict['SYMMDMODE'] = self.SYMMDMODE
        self.SYPFDCHPLPEN = RM_Field_RAC_S_RX_SYPFDCHPLPEN(self)
        self.zz_fdict['SYPFDCHPLPEN'] = self.SYPFDCHPLPEN
        self.SYPFDFPWEN = RM_Field_RAC_S_RX_SYPFDFPWEN(self)
...
class RM_Register_RAC_S_TX(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.PABLEEDDRVREG0DBM = RM_Field_RAC_S_TX_PABLEEDDRVREG0DBM(self)
        self.zz_fdict['PABLEEDDRVREG0DBM'] = self.PABLEEDDRVREG0DBM
        self.PABLEEDREG0DBM = RM_Field_RAC_S_TX_PABLEEDREG0DBM(self)
        self.zz_fdict['PABLEEDREG0DBM'] = self.PABLEEDREG0DBM
        self.PAENBIAS0DBM = RM_Field_RAC_S_TX_PAENBIAS0DBM(self)
        self.zz_fdict['PAENBIAS0DBM'] = self.PAENBIAS0DBM
        self.PAENDRVREG0DBM = RM_Field_RAC_S_TX_PAENDRVREG0DBM(self)
        self.zz_fdict['PAENDRVREG0DBM'] = self.PAENDRVREG0DBM
        self.PAENDRVREGBIAS0DBM = RM_Field_RAC_S_TX_PAENDRVREGBIAS0DBM(self)
        self.zz_fdict['PAENDRVREGBIAS0DBM'] = self.PAENDRVREGBIAS0DBM
        self.PAENLO0DBM = RM_Field_RAC_S_TX_PAENLO0DBM(self)
        self.zz_fdict['PAENLO0DBM'] = self.PAENLO0DBM
        self.PAENREG0DBM = RM_Field_RAC_S_TX_PAENREG0DBM(self)
        self.zz_fdict['PAENREG0DBM'] = self.PAENREG0DBM
        self.PAENTAPCAP0DBM = RM_Field_RAC_S_TX_PAENTAPCAP0DBM(self)
        self.zz_fdict['PAENTAPCAP0DBM'] = self.PAENTAPCAP0DBM
        self.ENPATRIMPASLICE0DBM = RM_Field_RAC_S_TX_ENPATRIMPASLICE0DBM(self)
        self.zz_fdict['ENPATRIMPASLICE0DBM'] = self.ENPATRIMPASLICE0DBM
        self.PAEN10DBMM = RM_Field_RAC_S_TX_PAEN10DBMM(self)
        self.zz_fdict['PAEN10DBMM'] = self.PAEN10DBMM
        self.PAEN10DBMP = RM_Field_RAC_S_TX_PAEN10DBMP(self)
        self.zz_fdict['PAEN10DBMP'] = self.PAEN10DBMP
        self.PAEN10DBMPDRV = RM_Field_RAC_S_TX_PAEN10DBMPDRV(self)
        self.zz_fdict['PAEN10DBMPDRV'] = self.PAEN10DBMPDRV
        self.PAEN20DBM = RM_Field_RAC_S_TX_PAEN20DBM(self)
        self.zz_fdict['PAEN20DBM'] = self.PAEN20DBM
        self.PAEN20DBMPDRV = RM_Field_RAC_S_TX_PAEN20DBMPDRV(self)
        self.zz_fdict['PAEN20DBMPDRV'] = self.PAEN20DBMPDRV
        self.PAENBLEEDPDRVLDO = RM_Field_RAC_S_TX_PAENBLEEDPDRVLDO(self)
        self.zz_fdict['PAENBLEEDPDRVLDO'] = self.PAENBLEEDPDRVLDO
        self.PAENBLEEDPREREG = RM_Field_RAC_S_TX_PAENBLEEDPREREG(self)
        self.zz_fdict['PAENBLEEDPREREG'] = self.PAENBLEEDPREREG
        self.PAENLDOHVPDRVLDO = RM_Field_RAC_S_TX_PAENLDOHVPDRVLDO(self)
        self.zz_fdict['PAENLDOHVPDRVLDO'] = self.PAENLDOHVPDRVLDO
        self.PAENLDOHVPREREG = RM_Field_RAC_S_TX_PAENLDOHVPREREG(self)
        self.zz_fdict['PAENLDOHVPREREG'] = self.PAENLDOHVPREREG
        self.PAENPAOUT = RM_Field_RAC_S_TX_PAENPAOUT(self)
        self.zz_fdict['PAENPAOUT'] = self.PAENPAOUT
        self.ENXOSQBUFFILT = RM_Field_RAC_S_TX_ENXOSQBUFFILT(self)
...
class RM_Register_RAC_S_SYDEBUG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYLODIVCLKSYNCSGEN = RM_Field_RAC_S_SYDEBUG_SYLODIVCLKSYNCSGEN(self)
...
class RM_Register_RAC_S_SYTRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPCURR = RM_Field_RAC_S_SYTRIM0_SYCHPCURR(self)
        ...
        self.SYCHPLEVPSRC = RM_Field_RAC_S_SYTRIM0_SYCHPLEVPSRC(self)
        self.zz_fdict['SYCHPLEVPSRC'] = self.SYCHPLEVPSRC
        self.SYCHPSRCEN = RM_Field_RAC_S_SYTRIM0_SYCHPSRCEN(self)
...
class RM_Register_RAC_S_SYTRIM1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYLODIVLDOTRIMCORE = RM_Field_RAC_S_SYTRIM1_SYLODIVLDOTRIMCORE(self)
        self.zz_fdict['SYLODIVLDOTRIMCORE'] = self.SYLODIVLDOTRIMCORE
        self.SYLODIVLDOTRIMNDIO = RM_Field_RAC_S_SYTRIM1_SYLODIVLDOTRIMNDIO(self)
...
class RM_Register_RAC_S_SYEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYCHPLPEN = RM_Field_RAC_S_SYEN_SYCHPLPEN(self)
        ...
        self.SYLODIVEN = RM_Field_RAC_S_SYEN_SYLODIVEN(self)
        self.zz_fdict['SYLODIVEN'] = self.SYLODIVEN
        self.SYLODIVLDOBIASEN = RM_Field_RAC_S_SYEN_SYLODIVLDOBIASEN(self)
        self.zz_fdict['SYLODIVLDOBIASEN'] = self.SYLODIVLDOBIASEN
        self.SYLODIVLDOEN = RM_Field_RAC_S_SYEN_SYLODIVLDOEN(self)
...
class RM_Register_RAC_S_SYLOEN(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYLODIVRLO12G4EN = RM_Field_RAC_S_SYLOEN_SYLODIVRLO12G4EN(self)
        self.zz_fdict['SYLODIVRLO12G4EN'] = self.SYLODIVRLO12G4EN
        self.SYLODIVRLO1SGEN = RM_Field_RAC_S_SYLOEN_SYLODIVRLO1SGEN(self)
        self.zz_fdict['SYLODIVRLO1SGEN'] = self.SYLODIVRLO1SGEN
        self.SYLODIVRLO22G4EN = RM_Field_RAC_S_SYLOEN_SYLODIVRLO22G4EN(self)
        self.zz_fdict['SYLODIVRLO22G4EN'] = self.SYLODIVRLO22G4EN
        self.SYLODIVRLO2SGEN = RM_Field_RAC_S_SYLOEN_SYLODIVRLO2SGEN(self)
        ...
        self.SYLODIVTLO0DBMSGAUXEN = RM_Field_RAC_S_SYLOEN_SYLODIVTLO0DBMSGAUXEN(self)
        self.zz_fdict['SYLODIVTLO0DBMSGAUXEN'] = self.SYLODIVTLO0DBMSGAUXEN
        self.SYLODIVTLO0DBMSGEN = RM_Field_RAC_S_SYLOEN_SYLODIVTLO0DBMSGEN(self)
        ...
        self.SYLODIVTLO20DBMSGAUXEN = RM_Field_RAC_S_SYLOEN_SYLODIVTLO20DBMSGAUXEN(self)
        self.zz_fdict['SYLODIVTLO20DBMSGAUXEN'] = self.SYLODIVTLO20DBMSGAUXEN
        self.SYLODIVTLO20DBMSGEN = RM_Field_RAC_S_SYLOEN_SYLODIVTLO20DBMSGEN(self)
...
class RM_Register_RAC_S_XOSQBUFFILT(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_XOSQBUFFILT, self).__init__(rmio, label,
            0xa8020000, 0x16C,
            'XOSQBUFFILT', 'RAC_S.XOSQBUFFILT', 'read-write',
            u"",
            0x00000000, 0x00000003,
            0x00001000, 0x00002000,
            0x00003000)

        self.XOSQBUFFILT = RM_Field_RAC_S_XOSQBUFFILT_XOSQBUFFILT(self)
...
class RM_Register_RAC_S_SPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.IFADCSPARE = RM_Field_RAC_S_SPARE_IFADCSPARE(self)
        self.zz_fdict['IFADCSPARE'] = self.IFADCSPARE
        self.PATRIMSPARE = RM_Field_RAC_S_SPARE_PATRIMSPARE(self)
        self.zz_fdict['PATRIMSPARE'] = self.PATRIMSPARE
        self.PGASPACER0 = RM_Field_RAC_S_SPARE_PGASPACER0(self)
...
class RM_Register_RAC_S_ANTDIV(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.EN = RM_Field_RAC_S_ANTDIV_EN(self)
        self.zz_fdict['EN'] = self.EN
        self.STATUS = RM_Field_RAC_S_ANTDIV_STATUS(self)
        self.zz_fdict['STATUS'] = self.STATUS
        self.__dict__['zz_frozen'] = True
...
class RM_Register_RAC_S_RFLOCK0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RACPAEN10DBMM = RM_Field_RAC_S_RFLOCK0_RACPAEN10DBMM(self)
        self.zz_fdict['RACPAEN10DBMM'] = self.RACPAEN10DBMM
        self.RACPAEN10DBMP = RM_Field_RAC_S_RFLOCK0_RACPAEN10DBMP(self)
        self.zz_fdict['RACPAEN10DBMP'] = self.RACPAEN10DBMP
        self.RACPAEN20DBM = RM_Field_RAC_S_RFLOCK0_RACPAEN20DBM(self)
        self.zz_fdict['RACPAEN20DBM'] = self.RACPAEN20DBM
        self.RACSGPAEN = RM_Field_RAC_S_RFLOCK0_RACSGPAEN(self)
...
class RM_Register_RAC_S_RFLOCK1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RACPASLICE0DBM = RM_Field_RAC_S_RFLOCK1_RACPASLICE0DBM(self)
        self.zz_fdict['RACPASLICE0DBM'] = self.RACPASLICE0DBM
        self.RACDRVSLICE0DBM = RM_Field_RAC_S_RFLOCK1_RACDRVSLICE0DBM(self)
        self.zz_fdict['RACDRVSLICE0DBM'] = self.RACDRVSLICE0DBM
        self.RACPASTRIPE10DBM = RM_Field_RAC_S_RFLOCK1_RACPASTRIPE10DBM(self)
        self.zz_fdict['RACPASTRIPE10DBM'] = self.RACPASTRIPE10DBM
        self.RACPASLICE10DBM = RM_Field_RAC_S_RFLOCK1_RACPASLICE10DBM(self)
        self.zz_fdict['RACPASLICE10DBM'] = self.RACPASLICE10DBM
        self.RACPASTRIPE20DBM = RM_Field_RAC_S_RFLOCK1_RACPASTRIPE20DBM(self)
        self.zz_fdict['RACPASTRIPE20DBM'] = self.RACPASTRIPE20DBM
        self.RACPASLICE20DBM = RM_Field_RAC_S_RFLOCK1_RACPASLICE20DBM(self)
