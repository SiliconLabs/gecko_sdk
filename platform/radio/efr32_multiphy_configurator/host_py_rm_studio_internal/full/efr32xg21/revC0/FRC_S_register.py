...
class RM_Register_FRC_S_MIRRORIF(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FRC_S_MIRRORIF, self).__init__(rmio, label,
            0xa8004000, 0x070,
            'MIRRORIF', 'FRC_S.MIRRORIF', 'read-write',
            u"",
            0x00000000, 0x0003FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.TXDONE = RM_Field_FRC_S_MIRRORIF_TXDONE(self)
        self.zz_fdict['TXDONE'] = self.TXDONE
        self.TXAFTERFRAMEDONE = RM_Field_FRC_S_MIRRORIF_TXAFTERFRAMEDONE(self)
        self.zz_fdict['TXAFTERFRAMEDONE'] = self.TXAFTERFRAMEDONE
        self.TXABORTED = RM_Field_FRC_S_MIRRORIF_TXABORTED(self)
        self.zz_fdict['TXABORTED'] = self.TXABORTED
        self.TXUF = RM_Field_FRC_S_MIRRORIF_TXUF(self)
        self.zz_fdict['TXUF'] = self.TXUF
        self.RXDONE = RM_Field_FRC_S_MIRRORIF_RXDONE(self)
        self.zz_fdict['RXDONE'] = self.RXDONE
        self.RXABORTED = RM_Field_FRC_S_MIRRORIF_RXABORTED(self)
        self.zz_fdict['RXABORTED'] = self.RXABORTED
        self.FRAMEERROR = RM_Field_FRC_S_MIRRORIF_FRAMEERROR(self)
        self.zz_fdict['FRAMEERROR'] = self.FRAMEERROR
        self.BLOCKERROR = RM_Field_FRC_S_MIRRORIF_BLOCKERROR(self)
        self.zz_fdict['BLOCKERROR'] = self.BLOCKERROR
        self.RXOF = RM_Field_FRC_S_MIRRORIF_RXOF(self)
        self.zz_fdict['RXOF'] = self.RXOF
        self.ADDRERROR = RM_Field_FRC_S_MIRRORIF_ADDRERROR(self)
        self.zz_fdict['ADDRERROR'] = self.ADDRERROR
        self.BUSERROR = RM_Field_FRC_S_MIRRORIF_BUSERROR(self)
        self.zz_fdict['BUSERROR'] = self.BUSERROR
        self.SNIFFOF = RM_Field_FRC_S_MIRRORIF_SNIFFOF(self)
        self.zz_fdict['SNIFFOF'] = self.SNIFFOF
        self.FRAMEDETPAUSED = RM_Field_FRC_S_MIRRORIF_FRAMEDETPAUSED(self)
        self.zz_fdict['FRAMEDETPAUSED'] = self.FRAMEDETPAUSED
        self.INTERLEAVEWRITEPAUSED = RM_Field_FRC_S_MIRRORIF_INTERLEAVEWRITEPAUSED(self)
        self.zz_fdict['INTERLEAVEWRITEPAUSED'] = self.INTERLEAVEWRITEPAUSED
        self.INTERLEAVEREADPAUSED = RM_Field_FRC_S_MIRRORIF_INTERLEAVEREADPAUSED(self)
        self.zz_fdict['INTERLEAVEREADPAUSED'] = self.INTERLEAVEREADPAUSED
        self.TXSUBFRAMEPAUSED = RM_Field_FRC_S_MIRRORIF_TXSUBFRAMEPAUSED(self)
        self.zz_fdict['TXSUBFRAMEPAUSED'] = self.TXSUBFRAMEPAUSED
        self.CONVPAUSED = RM_Field_FRC_S_MIRRORIF_CONVPAUSED(self)
        self.zz_fdict['CONVPAUSED'] = self.CONVPAUSED
        self.IFMIRRORCLEAR = RM_Field_FRC_S_MIRRORIF_IFMIRRORCLEAR(self)
...
class RM_Register_FRC_S_RAMBASEADDR(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FRC_S_RAMBASEADDR, self).__init__(rmio, label,
            0xa8004000, 0x0B0,
            'RAMBASEADDR', 'FRC_S.RAMBASEADDR', 'read-write',
            u"",
            0xA0002000, 0xFFFFF000,
            0x00001000, 0x00002000,
            0x00003000)

        self.RAMBASEADDR = RM_Field_FRC_S_RAMBASEADDR_RAMBASEADDR(self)
