...
class RM_Field_SYNTH_NS_IF_CAPCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_IF_CAPCALDONE, self).__init__(register,
            'CAPCALDONE', 'SYNTH_NS.IF.CAPCALDONE', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_SYNTH_NS_IEN_CAPCALDONE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_SYNTH_NS_IEN_CAPCALDONE, self).__init__(register,
            'CAPCALDONE', 'SYNTH_NS.IEN.CAPCALDONE', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
