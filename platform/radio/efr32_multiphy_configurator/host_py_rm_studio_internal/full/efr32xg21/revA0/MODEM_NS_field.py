...
class RM_Field_MODEM_NS_CTRL5_PRSDEBUG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CTRL5_PRSDEBUG, self).__init__(register,
            'PRSDEBUG', 'MODEM_NS.CTRL5.PRSDEBUG', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_CTRL5_XINGDEBUG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CTRL5_XINGDEBUG, self).__init__(register,
            'XINGDEBUG', 'MODEM_NS.CTRL5.XINGDEBUG', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_CF_RESYNCRESETTIMING(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CF_RESYNCRESETTIMING, self).__init__(register,
            'RESYNCRESETTIMING', 'MODEM_NS.CF.RESYNCRESETTIMING', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_CF_RESYNCBYPASS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_CF_RESYNCBYPASS, self).__init__(register,
            'RESYNCBYPASS', 'MODEM_NS.CF.RESYNCBYPASS', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_SHAPING4_COEFF20(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING4_COEFF20, self).__init__(register,
            'COEFF20', 'MODEM_NS.SHAPING4.COEFF20', 'read-write',
            u"",
            23, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING4_COEFF21(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING4_COEFF21, self).__init__(register,
            'COEFF21', 'MODEM_NS.SHAPING4.COEFF21', 'read-write',
            u"",
            28, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_SHAPING5_COEFF24(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF24, self).__init__(register,
            'COEFF24', 'MODEM_NS.SHAPING5.COEFF24', 'read-write',
            u"",
            8, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING5_COEFF25(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF25, self).__init__(register,
            'COEFF25', 'MODEM_NS.SHAPING5.COEFF25', 'read-write',
            u"",
            12, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING5_COEFF26(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF26, self).__init__(register,
            'COEFF26', 'MODEM_NS.SHAPING5.COEFF26', 'read-write',
            u"",
            16, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING5_COEFF27(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF27, self).__init__(register,
            'COEFF27', 'MODEM_NS.SHAPING5.COEFF27', 'read-write',
            u"",
            20, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING5_COEFF28(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF28, self).__init__(register,
            'COEFF28', 'MODEM_NS.SHAPING5.COEFF28', 'read-write',
            u"",
            24, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING5_COEFF29(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING5_COEFF29, self).__init__(register,
            'COEFF29', 'MODEM_NS.SHAPING5.COEFF29', 'read-write',
            u"",
            28, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF30(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF30, self).__init__(register,
            'COEFF30', 'MODEM_NS.SHAPING6.COEFF30', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF31(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF31, self).__init__(register,
            'COEFF31', 'MODEM_NS.SHAPING6.COEFF31', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF32(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF32, self).__init__(register,
            'COEFF32', 'MODEM_NS.SHAPING6.COEFF32', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF33(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF33, self).__init__(register,
            'COEFF33', 'MODEM_NS.SHAPING6.COEFF33', 'read-write',
            u"",
            11, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF34(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF34, self).__init__(register,
            'COEFF34', 'MODEM_NS.SHAPING6.COEFF34', 'read-write',
            u"",
            14, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF35(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF35, self).__init__(register,
            'COEFF35', 'MODEM_NS.SHAPING6.COEFF35', 'read-write',
            u"",
            17, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF36(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF36, self).__init__(register,
            'COEFF36', 'MODEM_NS.SHAPING6.COEFF36', 'read-write',
            u"",
            20, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF37(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF37, self).__init__(register,
            'COEFF37', 'MODEM_NS.SHAPING6.COEFF37', 'read-write',
            u"",
            23, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF38(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF38, self).__init__(register,
            'COEFF38', 'MODEM_NS.SHAPING6.COEFF38', 'read-write',
            u"",
            26, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SHAPING6_COEFF39(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SHAPING6_COEFF39, self).__init__(register,
            'COEFF39', 'MODEM_NS.SHAPING6.COEFF39', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_LONGRANGE_LRCORRTHDDYNEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_LONGRANGE_LRCORRTHDDYNEN, self).__init__(register,
            'LRCORRTHDDYNEN', 'MODEM_NS.LONGRANGE.LRCORRTHDDYNEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_PADEBUG_MANPAAMPCTRL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PADEBUG_MANPAAMPCTRL, self).__init__(register,
            'MANPAAMPCTRL', 'MODEM_NS.PADEBUG.MANPAAMPCTRL', 'read-write',
            u"",
            0, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_PADEBUG_ENMANPAAMPCTRL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PADEBUG_ENMANPAAMPCTRL, self).__init__(register,
            'ENMANPAAMPCTRL', 'MODEM_NS.PADEBUG.ENMANPAAMPCTRL', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_NS_PADEBUG_ENMANPATRIMPASLICE0DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_PADEBUG_ENMANPATRIMPASLICE0DBM, self).__init__(register,
            'ENMANPATRIMPASLICE0DBM', 'MODEM_NS.PADEBUG.ENMANPATRIMPASLICE0DBM', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True
