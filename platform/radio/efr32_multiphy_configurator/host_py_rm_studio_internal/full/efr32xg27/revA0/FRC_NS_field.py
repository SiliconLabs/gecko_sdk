...
class RM_Field_FRC_NS_CMD_PKTBUFSTOP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_NS_CMD_PKTBUFSTOP, self).__init__(register,
            'PKTBUFSTOP', 'FRC_NS.CMD.PKTBUFSTOP', 'write-only',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True
