...
class RM_Register_MODEM_S_VTTRACK(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.SYNCTIMEOUTSEL = RM_Field_MODEM_S_VTTRACK_SYNCTIMEOUTSEL(self)
...
class RM_Register_MODEM_S_STATUS2(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RTVTCORR = RM_Field_MODEM_S_STATUS2_RTVTCORR(self)
...
class RM_Register_MODEM_S_TRECPMDET(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.VTPMDETSEL = RM_Field_MODEM_S_TRECPMDET_VTPMDETSEL(self)
...
class RM_Register_MODEM_S_BLEIQDSAEXT2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_BLEIQDSAEXT2, self).__init__(rmio, label,
            0xa8014000, 0x280,
            'BLEIQDSAEXT2', 'MODEM_S.BLEIQDSAEXT2', 'read-write',
            u"",
            0x00000000, 0x000007FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.DISMAXPEAKTRACKMODE = RM_Field_MODEM_S_BLEIQDSAEXT2_DISMAXPEAKTRACKMODE(self)
        self.zz_fdict['DISMAXPEAKTRACKMODE'] = self.DISMAXPEAKTRACKMODE
        self.BBSSDEBOUNCETIM = RM_Field_MODEM_S_BLEIQDSAEXT2_BBSSDEBOUNCETIM(self)
        self.zz_fdict['BBSSDEBOUNCETIM'] = self.BBSSDEBOUNCETIM
        self.BBSSDIFFCHVAL = RM_Field_MODEM_S_BLEIQDSAEXT2_BBSSDIFFCHVAL(self)
