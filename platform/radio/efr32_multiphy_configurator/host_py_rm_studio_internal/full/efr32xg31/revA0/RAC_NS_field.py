...
class RM_Field_RAC_NS_SPARE_FENOTCHSPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPARE_FENOTCHSPARE, self).__init__(register,
            'FENOTCHSPARE', 'RAC_NS.SPARE.FENOTCHSPARE', 'read-write',
            u"",
            17, 5)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_FENOTCH0_FENOTCHVBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH0_FENOTCHVBIAS, self).__init__(register,
            'FENOTCHVBIAS', 'RAC_NS.FENOTCH0.FENOTCHVBIAS', 'read-write',
            u"",
            12, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_FENOTCH1_FENOTCHENVDDSW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH1_FENOTCHENVDDSW, self).__init__(register,
            'FENOTCHENVDDSW', 'RAC_NS.FENOTCH1.FENOTCHENVDDSW', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALEN, self).__init__(register,
            'FENOTCHRCCALEN', 'RAC_NS.FENOTCH1.FENOTCHRCCALEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALCOUNTER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALCOUNTER, self).__init__(register,
            'FENOTCHRCCALCOUNTER', 'RAC_NS.FENOTCH1.FENOTCHRCCALCOUNTER', 'read-write',
            u"",
            8, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALOSC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALOSC, self).__init__(register,
            'FENOTCHRCCALOSC', 'RAC_NS.FENOTCH1.FENOTCHRCCALOSC', 'read-write',
            u"",
            16, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_FENOTCH1_FENOTCHRCCALOUT, self).__init__(register,
            'FENOTCHRCCALOUT', 'RAC_NS.FENOTCH1.FENOTCHRCCALOUT', 'read-only',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True
