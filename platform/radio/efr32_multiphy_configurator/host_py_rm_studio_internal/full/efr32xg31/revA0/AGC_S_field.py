...
class RM_Field_AGC_S_LNAMIXCODE2_LNAMIXSLICE11(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_AGC_S_LNAMIXCODE2_LNAMIXSLICE11, self).__init__(register,
            'LNAMIXSLICE11', 'AGC_S.LNAMIXCODE2.LNAMIXSLICE11', 'read-write',
            u"",
            0, 6)
        self.__dict__['zz_frozen'] = True
