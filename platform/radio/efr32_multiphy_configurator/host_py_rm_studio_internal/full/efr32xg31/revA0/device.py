...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG31XFULL_RevA0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG31XFULL_RevA0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG31XFULL_RevA0' ]
...
class RM_Device_EFR32XG31XFULL_RevA0(Base_RM_Device):
    """
