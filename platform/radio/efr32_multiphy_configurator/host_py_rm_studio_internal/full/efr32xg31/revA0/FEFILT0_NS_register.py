...
class RM_Register_FEFILT0_NS_CFG(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.DEC1 = RM_Field_FEFILT0_NS_CFG_DEC1(self)
        self.zz_fdict['DEC1'] = self.DEC1
        self.CHFGAINREDUCTION = RM_Field_FEFILT0_NS_CFG_CHFGAINREDUCTION(self)
        self.zz_fdict['CHFGAINREDUCTION'] = self.CHFGAINREDUCTION
        self.CHFCOEFFSWEN = RM_Field_FEFILT0_NS_CFG_CHFCOEFFSWEN(self)
        self.zz_fdict['CHFCOEFFSWEN'] = self.CHFCOEFFSWEN
        self.CHFCOEFFSWSEL = RM_Field_FEFILT0_NS_CFG_CHFCOEFFSWSEL(self)
        self.zz_fdict['CHFCOEFFSWSEL'] = self.CHFCOEFFSWSEL
        self.CHFCOEFFFWSWEN = RM_Field_FEFILT0_NS_CFG_CHFCOEFFFWSWEN(self)
        self.zz_fdict['CHFCOEFFFWSWEN'] = self.CHFCOEFFFWSWEN
        self.CHFCOEFFFWSWSEL = RM_Field_FEFILT0_NS_CFG_CHFCOEFFFWSWSEL(self)
        self.zz_fdict['CHFCOEFFFWSWSEL'] = self.CHFCOEFFFWSWSEL
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_SRC2(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_SRC2, self).__init__(rmio, label,
            0xb803c000, 0x104,
            'SRC2', 'FEFILT0_NS.SRC2', 'read-write',
            u"",
            0x00000000, 0x09C07FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SRC2RATIO = RM_Field_FEFILT0_NS_SRC2_SRC2RATIO(self)
        self.zz_fdict['SRC2RATIO'] = self.SRC2RATIO
        self.UPGAPS = RM_Field_FEFILT0_NS_SRC2_UPGAPS(self)
        self.zz_fdict['UPGAPS'] = self.UPGAPS
        self.SRC2ENABLE = RM_Field_FEFILT0_NS_SRC2_SRC2ENABLE(self)
        self.zz_fdict['SRC2ENABLE'] = self.SRC2ENABLE
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_GAINCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_GAINCTRL, self).__init__(rmio, label,
            0xb803c000, 0x108,
            'GAINCTRL', 'FEFILT0_NS.GAINCTRL', 'read-write',
            u"",
            0x00000000, 0x00000700,
            0x00001000, 0x00002000,
            0x00003000)

        self.DEC0GAIN = RM_Field_FEFILT0_NS_GAINCTRL_DEC0GAIN(self)
        self.zz_fdict['DEC0GAIN'] = self.DEC0GAIN
        self.DEC1GAIN = RM_Field_FEFILT0_NS_GAINCTRL_DEC1GAIN(self)
        self.zz_fdict['DEC1GAIN'] = self.DEC1GAIN
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE00(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE00, self).__init__(rmio, label,
            0xb803c000, 0x10C,
            'CHFCSDCOE00', 'FEFILT0_NS.CHFCSDCOE00', 'read-write',
            u"",
            0x00000000, 0xFFFFFF3F,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF0 = RM_Field_FEFILT0_NS_CHFCSDCOE00_SET0CSDCOEFF0(self)
        self.zz_fdict['SET0CSDCOEFF0'] = self.SET0CSDCOEFF0
        self.SET0CSDCOEFF1 = RM_Field_FEFILT0_NS_CHFCSDCOE00_SET0CSDCOEFF1(self)
        self.zz_fdict['SET0CSDCOEFF1'] = self.SET0CSDCOEFF1
        self.SET0CSDCOEFF2 = RM_Field_FEFILT0_NS_CHFCSDCOE00_SET0CSDCOEFF2(self)
        self.zz_fdict['SET0CSDCOEFF2'] = self.SET0CSDCOEFF2
        self.SET0CSDCOEFF3 = RM_Field_FEFILT0_NS_CHFCSDCOE00_SET0CSDCOEFF3(self)
        self.zz_fdict['SET0CSDCOEFF3'] = self.SET0CSDCOEFF3
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE01(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE01, self).__init__(rmio, label,
            0xb803c000, 0x110,
            'CHFCSDCOE01', 'FEFILT0_NS.CHFCSDCOE01', 'read-write',
            u"",
            0x00000000, 0x03FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF4 = RM_Field_FEFILT0_NS_CHFCSDCOE01_SET0CSDCOEFF4(self)
        self.zz_fdict['SET0CSDCOEFF4'] = self.SET0CSDCOEFF4
        self.SET0CSDCOEFF5 = RM_Field_FEFILT0_NS_CHFCSDCOE01_SET0CSDCOEFF5(self)
        self.zz_fdict['SET0CSDCOEFF5'] = self.SET0CSDCOEFF5
        self.SET0CSDCOEFF6 = RM_Field_FEFILT0_NS_CHFCSDCOE01_SET0CSDCOEFF6(self)
        self.zz_fdict['SET0CSDCOEFF6'] = self.SET0CSDCOEFF6
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE02(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE02, self).__init__(rmio, label,
            0xb803c000, 0x114,
            'CHFCSDCOE02', 'FEFILT0_NS.CHFCSDCOE02', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF7 = RM_Field_FEFILT0_NS_CHFCSDCOE02_SET0CSDCOEFF7(self)
        self.zz_fdict['SET0CSDCOEFF7'] = self.SET0CSDCOEFF7
        self.SET0CSDCOEFF8 = RM_Field_FEFILT0_NS_CHFCSDCOE02_SET0CSDCOEFF8(self)
        self.zz_fdict['SET0CSDCOEFF8'] = self.SET0CSDCOEFF8
        self.SET0CSDCOEFF9 = RM_Field_FEFILT0_NS_CHFCSDCOE02_SET0CSDCOEFF9(self)
        self.zz_fdict['SET0CSDCOEFF9'] = self.SET0CSDCOEFF9
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE03(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE03, self).__init__(rmio, label,
            0xb803c000, 0x118,
            'CHFCSDCOE03', 'FEFILT0_NS.CHFCSDCOE03', 'read-write',
            u"",
            0x00000000, 0x007FFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF10 = RM_Field_FEFILT0_NS_CHFCSDCOE03_SET0CSDCOEFF10(self)
        self.zz_fdict['SET0CSDCOEFF10'] = self.SET0CSDCOEFF10
        self.SET0CSDCOEFF11 = RM_Field_FEFILT0_NS_CHFCSDCOE03_SET0CSDCOEFF11(self)
        self.zz_fdict['SET0CSDCOEFF11'] = self.SET0CSDCOEFF11
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE10(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE10, self).__init__(rmio, label,
            0xb803c000, 0x11C,
            'CHFCSDCOE10', 'FEFILT0_NS.CHFCSDCOE10', 'read-write',
            u"",
            0x00000000, 0xFFFFFF3F,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF0 = RM_Field_FEFILT0_NS_CHFCSDCOE10_SET1CSDCOEFF0(self)
        self.zz_fdict['SET1CSDCOEFF0'] = self.SET1CSDCOEFF0
        self.SET1CSDCOEFF1 = RM_Field_FEFILT0_NS_CHFCSDCOE10_SET1CSDCOEFF1(self)
        self.zz_fdict['SET1CSDCOEFF1'] = self.SET1CSDCOEFF1
        self.SET1CSDCOEFF2 = RM_Field_FEFILT0_NS_CHFCSDCOE10_SET1CSDCOEFF2(self)
        self.zz_fdict['SET1CSDCOEFF2'] = self.SET1CSDCOEFF2
        self.SET1CSDCOEFF3 = RM_Field_FEFILT0_NS_CHFCSDCOE10_SET1CSDCOEFF3(self)
        self.zz_fdict['SET1CSDCOEFF3'] = self.SET1CSDCOEFF3
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE11(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE11, self).__init__(rmio, label,
            0xb803c000, 0x120,
            'CHFCSDCOE11', 'FEFILT0_NS.CHFCSDCOE11', 'read-write',
            u"",
            0x00000000, 0x03FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF4 = RM_Field_FEFILT0_NS_CHFCSDCOE11_SET1CSDCOEFF4(self)
        self.zz_fdict['SET1CSDCOEFF4'] = self.SET1CSDCOEFF4
        self.SET1CSDCOEFF5 = RM_Field_FEFILT0_NS_CHFCSDCOE11_SET1CSDCOEFF5(self)
        self.zz_fdict['SET1CSDCOEFF5'] = self.SET1CSDCOEFF5
        self.SET1CSDCOEFF6 = RM_Field_FEFILT0_NS_CHFCSDCOE11_SET1CSDCOEFF6(self)
        self.zz_fdict['SET1CSDCOEFF6'] = self.SET1CSDCOEFF6
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE12(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE12, self).__init__(rmio, label,
            0xb803c000, 0x124,
            'CHFCSDCOE12', 'FEFILT0_NS.CHFCSDCOE12', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF7 = RM_Field_FEFILT0_NS_CHFCSDCOE12_SET1CSDCOEFF7(self)
        self.zz_fdict['SET1CSDCOEFF7'] = self.SET1CSDCOEFF7
        self.SET1CSDCOEFF8 = RM_Field_FEFILT0_NS_CHFCSDCOE12_SET1CSDCOEFF8(self)
        self.zz_fdict['SET1CSDCOEFF8'] = self.SET1CSDCOEFF8
        self.SET1CSDCOEFF9 = RM_Field_FEFILT0_NS_CHFCSDCOE12_SET1CSDCOEFF9(self)
        self.zz_fdict['SET1CSDCOEFF9'] = self.SET1CSDCOEFF9
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE13(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE13, self).__init__(rmio, label,
            0xb803c000, 0x128,
            'CHFCSDCOE13', 'FEFILT0_NS.CHFCSDCOE13', 'read-write',
            u"",
            0x00000000, 0x007FFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF10 = RM_Field_FEFILT0_NS_CHFCSDCOE13_SET1CSDCOEFF10(self)
        self.zz_fdict['SET1CSDCOEFF10'] = self.SET1CSDCOEFF10
        self.SET1CSDCOEFF11 = RM_Field_FEFILT0_NS_CHFCSDCOE13_SET1CSDCOEFF11(self)
        self.zz_fdict['SET1CSDCOEFF11'] = self.SET1CSDCOEFF11
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE00S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE00S, self).__init__(rmio, label,
            0xb803c000, 0x12C,
            'CHFCSDCOE00S', 'FEFILT0_NS.CHFCSDCOE00S', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF0S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF0S(self)
        self.zz_fdict['SET0CSDCOEFF0S'] = self.SET0CSDCOEFF0S
        self.SET0CSDCOEFF1S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF1S(self)
        self.zz_fdict['SET0CSDCOEFF1S'] = self.SET0CSDCOEFF1S
        self.SET0CSDCOEFF2S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF2S(self)
        self.zz_fdict['SET0CSDCOEFF2S'] = self.SET0CSDCOEFF2S
        self.SET0CSDCOEFF3S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF3S(self)
        self.zz_fdict['SET0CSDCOEFF3S'] = self.SET0CSDCOEFF3S
        self.SET0CSDCOEFF4S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF4S(self)
        self.zz_fdict['SET0CSDCOEFF4S'] = self.SET0CSDCOEFF4S
        self.SET0CSDCOEFF5S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF5S(self)
        self.zz_fdict['SET0CSDCOEFF5S'] = self.SET0CSDCOEFF5S
        self.SET0CSDCOEFF6S = RM_Field_FEFILT0_NS_CHFCSDCOE00S_SET0CSDCOEFF6S(self)
        self.zz_fdict['SET0CSDCOEFF6S'] = self.SET0CSDCOEFF6S
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE01S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE01S, self).__init__(rmio, label,
            0xb803c000, 0x130,
            'CHFCSDCOE01S', 'FEFILT0_NS.CHFCSDCOE01S', 'read-write',
            u"",
            0x00000000, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET0CSDCOEFF7S = RM_Field_FEFILT0_NS_CHFCSDCOE01S_SET0CSDCOEFF7S(self)
        self.zz_fdict['SET0CSDCOEFF7S'] = self.SET0CSDCOEFF7S
        self.SET0CSDCOEFF8S = RM_Field_FEFILT0_NS_CHFCSDCOE01S_SET0CSDCOEFF8S(self)
        self.zz_fdict['SET0CSDCOEFF8S'] = self.SET0CSDCOEFF8S
        self.SET0CSDCOEFF9S = RM_Field_FEFILT0_NS_CHFCSDCOE01S_SET0CSDCOEFF9S(self)
        self.zz_fdict['SET0CSDCOEFF9S'] = self.SET0CSDCOEFF9S
        self.SET0CSDCOEFF10S = RM_Field_FEFILT0_NS_CHFCSDCOE01S_SET0CSDCOEFF10S(self)
        self.zz_fdict['SET0CSDCOEFF10S'] = self.SET0CSDCOEFF10S
        self.SET0CSDCOEFF11S = RM_Field_FEFILT0_NS_CHFCSDCOE01S_SET0CSDCOEFF11S(self)
        self.zz_fdict['SET0CSDCOEFF11S'] = self.SET0CSDCOEFF11S
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE10S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE10S, self).__init__(rmio, label,
            0xb803c000, 0x134,
            'CHFCSDCOE10S', 'FEFILT0_NS.CHFCSDCOE10S', 'read-write',
            u"",
            0x00000000, 0x1FFFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF0S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF0S(self)
        self.zz_fdict['SET1CSDCOEFF0S'] = self.SET1CSDCOEFF0S
        self.SET1CSDCOEFF1S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF1S(self)
        self.zz_fdict['SET1CSDCOEFF1S'] = self.SET1CSDCOEFF1S
        self.SET1CSDCOEFF2S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF2S(self)
        self.zz_fdict['SET1CSDCOEFF2S'] = self.SET1CSDCOEFF2S
        self.SET1CSDCOEFF3S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF3S(self)
        self.zz_fdict['SET1CSDCOEFF3S'] = self.SET1CSDCOEFF3S
        self.SET1CSDCOEFF4S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF4S(self)
        self.zz_fdict['SET1CSDCOEFF4S'] = self.SET1CSDCOEFF4S
        self.SET1CSDCOEFF5S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF5S(self)
        self.zz_fdict['SET1CSDCOEFF5S'] = self.SET1CSDCOEFF5S
        self.SET1CSDCOEFF6S = RM_Field_FEFILT0_NS_CHFCSDCOE10S_SET1CSDCOEFF6S(self)
        self.zz_fdict['SET1CSDCOEFF6S'] = self.SET1CSDCOEFF6S
        self.__dict__['zz_frozen'] = True


class RM_Register_FEFILT0_NS_CHFCSDCOE11S(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_FEFILT0_NS_CHFCSDCOE11S, self).__init__(rmio, label,
            0xb803c000, 0x138,
            'CHFCSDCOE11S', 'FEFILT0_NS.CHFCSDCOE11S', 'read-write',
            u"",
            0x00000000, 0x07FFFFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SET1CSDCOEFF7S = RM_Field_FEFILT0_NS_CHFCSDCOE11S_SET1CSDCOEFF7S(self)
        self.zz_fdict['SET1CSDCOEFF7S'] = self.SET1CSDCOEFF7S
        self.SET1CSDCOEFF8S = RM_Field_FEFILT0_NS_CHFCSDCOE11S_SET1CSDCOEFF8S(self)
        self.zz_fdict['SET1CSDCOEFF8S'] = self.SET1CSDCOEFF8S
        self.SET1CSDCOEFF9S = RM_Field_FEFILT0_NS_CHFCSDCOE11S_SET1CSDCOEFF9S(self)
        self.zz_fdict['SET1CSDCOEFF9S'] = self.SET1CSDCOEFF9S
        self.SET1CSDCOEFF10S = RM_Field_FEFILT0_NS_CHFCSDCOE11S_SET1CSDCOEFF10S(self)
        self.zz_fdict['SET1CSDCOEFF10S'] = self.SET1CSDCOEFF10S
        self.SET1CSDCOEFF11S = RM_Field_FEFILT0_NS_CHFCSDCOE11S_SET1CSDCOEFF11S(self)
