...
class RM_Peripheral_AGC_NS(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FLARE = RM_Register_AGC_NS_FLARE(self.zz_rmio, self.zz_label)
        self.zz_rdict['FLARE'] = self.FLARE
        self.STEPDWNSAFE = RM_Register_AGC_NS_STEPDWNSAFE(self.zz_rmio, self.zz_label)
        ...
        self.TIACODE0 = RM_Register_AGC_NS_TIACODE0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACODE0'] = self.TIACODE0
        self.TIACODE1 = RM_Register_AGC_NS_TIACODE1(self.zz_rmio, self.zz_label)
        ...
        self.COLLDETSTATUS = RM_Register_AGC_NS_COLLDETSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['COLLDETSTATUS'] = self.COLLDETSTATUS
        self.SETTLINGINDCTRL = RM_Register_AGC_NS_SETTLINGINDCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['SETTLINGINDCTRL'] = self.SETTLINGINDCTRL
        self.SETTLINGINDPER = RM_Register_AGC_NS_SETTLINGINDPER(self.zz_rmio, self.zz_label)
