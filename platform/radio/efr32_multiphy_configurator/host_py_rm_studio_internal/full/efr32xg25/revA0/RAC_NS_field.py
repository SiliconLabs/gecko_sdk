...
class RM_Field_RAC_NS_AUXADCCTRL1_AUXADCIN6SHIMEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AUXADCCTRL1_AUXADCIN6SHIMEN, self).__init__(register,
            'AUXADCIN6SHIMEN', 'RAC_NS.AUXADCCTRL1.AUXADCIN6SHIMEN', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AUXADCCTRL1_AUXADCIN8SHIMEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AUXADCCTRL1_AUXADCIN8SHIMEN, self).__init__(register,
            'AUXADCIN8SHIMEN', 'RAC_NS.AUXADCCTRL1.AUXADCIN8SHIMEN', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PATRIM1_TXTRIMHPAVMIDCURRENT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM1_TXTRIMHPAVMIDCURRENT, self).__init__(register,
            'TXTRIMHPAVMIDCURRENT', 'RAC_NS.PATRIM1.TXTRIMHPAVMIDCURRENT', 'read-write',
            u"",
            22, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PATRIM3_TXTRIMRREGCN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TXTRIMRREGCN, self).__init__(register,
            'TXTRIMRREGCN', 'RAC_NS.PATRIM3.TXTRIMRREGCN', 'read-write',
            u"",
            29, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PATRIM5_TXVCASRAIL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM5_TXVCASRAIL, self).__init__(register,
            'TXVCASRAIL', 'RAC_NS.PATRIM5.TXVCASRAIL', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_TXRAMP_TXBYPASSBBDIGREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRAMP_TXBYPASSBBDIGREG, self).__init__(register,
            'TXBYPASSBBDIGREG', 'RAC_NS.TXRAMP.TXBYPASSBBDIGREG', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRAMP_TXBYPASSBUFREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRAMP_TXBYPASSBUFREG, self).__init__(register,
            'TXBYPASSBUFREG', 'RAC_NS.TXRAMP.TXBYPASSBUFREG', 'read-write',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRAMP_TXSTARTUPITCCORE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRAMP_TXSTARTUPITCCORE, self).__init__(register,
            'TXSTARTUPITCCORE', 'RAC_NS.TXRAMP.TXSTARTUPITCCORE', 'read-write',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFPATHEN0_TXENFSKPA0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN0_TXENFSKPA0, self).__init__(register,
            'TXENFSKPA0', 'RAC_NS.RFPATHEN0.TXENFSKPA0', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFPATHEN0_TXENOFDMPA0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN0_TXENOFDMPA0, self).__init__(register,
            'TXENOFDMPA0', 'RAC_NS.RFPATHEN0.TXENOFDMPA0', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFPATHEN1_TXENFSKPA1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN1_TXENFSKPA1, self).__init__(register,
            'TXENFSKPA1', 'RAC_NS.RFPATHEN1.TXENFSKPA1', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFPATHEN1_TXENOFDMPA1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN1_TXENOFDMPA1, self).__init__(register,
            'TXENOFDMPA1', 'RAC_NS.RFPATHEN1.TXENOFDMPA1', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RX_FEFILTOUTPUTSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RX_FEFILTOUTPUTSEL, self).__init__(register,
            'FEFILTOUTPUTSEL', 'RAC_NS.RX.FEFILTOUTPUTSEL', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_TX_TXENRFPKD0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENRFPKD0, self).__init__(register,
            'TXENRFPKD0', 'RAC_NS.TX.TXENRFPKD0', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXENRFPKD1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENRFPKD1, self).__init__(register,
            'TXENRFPKD1', 'RAC_NS.TX.TXENRFPKD1', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXENRREGBLEED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENRREGBLEED, self).__init__(register,
            'TXENRREGBLEED', 'RAC_NS.TX.TXENRREGBLEED', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_TX_TXSWPENDACI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXSWPENDACI, self).__init__(register,
            'TXSWPENDACI', 'RAC_NS.TX.TXSWPENDACI', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXSWPENDACQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXSWPENDACQ, self).__init__(register,
            'TXSWPENDACQ', 'RAC_NS.TX.TXSWPENDACQ', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXENITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENITCDAC, self).__init__(register,
            'TXENITCDAC', 'RAC_NS.TX.TXENITCDAC', 'read-write',
            u"",
            26, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXENITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENITCPA, self).__init__(register,
            'TXENITCPA', 'RAC_NS.TX.TXENITCPA', 'read-write',
            u"",
            27, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TXENITCCORE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TXENITCCORE, self).__init__(register,
            'TXENITCCORE', 'RAC_NS.TX.TXENITCCORE', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYTRIM1_SYLODIVTLOTRIMDELAYOFDM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYTRIM1_SYLODIVTLOTRIMDELAYOFDM, self).__init__(register,
            'SYLODIVTLOTRIMDELAYOFDM', 'RAC_NS.SYTRIM1.SYLODIVTLOTRIMDELAYOFDM', 'read-write',
            u"",
            15, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYLOEN_SYLODIVTLOOFDMSUBGEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYLOEN_SYLODIVTLOOFDMSUBGEN, self).__init__(register,
            'SYLODIVTLOOFDMSUBGEN', 'RAC_NS.SYLOEN.SYLODIVTLOOFDMSUBGEN', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_TXOGNDPKD_TXPKDOGNDATTEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOGNDPKD_TXPKDOGNDATTEN, self).__init__(register,
            'TXPKDOGNDATTEN', 'RAC_NS.TXOGNDPKD.TXPKDOGNDATTEN', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOGNDPKD_TXPKDOGNDCLKHIGH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOGNDPKD_TXPKDOGNDCLKHIGH, self).__init__(register,
            'TXPKDOGNDCLKHIGH', 'RAC_NS.TXOGNDPKD.TXPKDOGNDCLKHIGH', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SPARE_SPARE0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPARE_SPARE0, self).__init__(register,
            'SPARE0', 'RAC_NS.SPARE.SPARE0', 'read-write',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEENRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEENRETIME, self).__init__(register,
            'GPPLLCLKRETIMEENRETIME', 'RAC_NS.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMEENRETIME', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEDISRETIME(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMEDISRETIME, self).__init__(register,
            'GPPLLCLKRETIMEDISRETIME', 'RAC_NS.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMEDISRETIME', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMERESETN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMERESETN, self).__init__(register,
            'GPPLLCLKRETIMERESETN', 'RAC_NS.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMERESETN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITH, self).__init__(register,
            'GPPLLCLKRETIMELIMITH', 'RAC_NS.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMELIMITH', 'read-write',
            u"",
            4, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMECTRL_GPPLLCLKRETIMELIMITL, self).__init__(register,
            'GPPLLCLKRETIMELIMITL', 'RAC_NS.GPPLLCLKRETIMECTRL.GPPLLCLKRETIMELIMITL', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMECLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMECLKSEL, self).__init__(register,
            'GPPLLCLKRETIMECLKSEL', 'RAC_NS.GPPLLCLKRETIMESTATUS.GPPLLCLKRETIMECLKSEL', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMERESETNLO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_GPPLLCLKRETIMESTATUS_GPPLLCLKRETIMERESETNLO, self).__init__(register,
            'GPPLLCLKRETIMERESETNLO', 'RAC_NS.GPPLLCLKRETIMESTATUS.GPPLLCLKRETIMERESETNLO', 'read-only',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMBBDIGREGIOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMBBDIGREGIOUT, self).__init__(register,
            'TXTRIMBBDIGREGIOUT', 'RAC_NS.PATRIM6.TXTRIMBBDIGREGIOUT', 'read-write',
            u"",
            1, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMBBREGVREF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMBBREGVREF, self).__init__(register,
            'TXTRIMBBREGVREF', 'RAC_NS.PATRIM6.TXTRIMBBREGVREF', 'read-write',
            u"",
            3, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMBBREGFB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMBBREGFB, self).__init__(register,
            'TXTRIMBBREGFB', 'RAC_NS.PATRIM6.TXTRIMBBREGFB', 'read-write',
            u"",
            6, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMFILVCOM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMFILVCOM, self).__init__(register,
            'TXTRIMFILVCOM', 'RAC_NS.PATRIM6.TXTRIMFILVCOM', 'read-write',
            u"",
            12, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMFILCAP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMFILCAP, self).__init__(register,
            'TXTRIMFILCAP', 'RAC_NS.PATRIM6.TXTRIMFILCAP', 'read-write',
            u"",
            16, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMFILGAIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMFILGAIN, self).__init__(register,
            'TXTRIMFILGAIN', 'RAC_NS.PATRIM6.TXTRIMFILGAIN', 'read-write',
            u"",
            18, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMFILRES(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMFILRES, self).__init__(register,
            'TXTRIMFILRES', 'RAC_NS.PATRIM6.TXTRIMFILRES', 'read-write',
            u"",
            20, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMBIASNMAX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMBIASNMAX, self).__init__(register,
            'TXTRIMBIASNMAX', 'RAC_NS.PATRIM6.TXTRIMBIASNMAX', 'read-write',
            u"",
            24, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM6_TXTRIMBIASPMAX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM6_TXTRIMBIASPMAX, self).__init__(register,
            'TXTRIMBIASPMAX', 'RAC_NS.PATRIM6.TXTRIMBIASPMAX', 'read-write',
            u"",
            28, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMMIXGMBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMMIXGMBIAS, self).__init__(register,
            'TXTRIMMIXGMBIAS', 'RAC_NS.PATRIM7.TXTRIMMIXGMBIAS', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMMIXLOBIASI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMMIXLOBIASI, self).__init__(register,
            'TXTRIMMIXLOBIASI', 'RAC_NS.PATRIM7.TXTRIMMIXLOBIASI', 'read-write',
            u"",
            2, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMMIXLOBIASQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMMIXLOBIASQ, self).__init__(register,
            'TXTRIMMIXLOBIASQ', 'RAC_NS.PATRIM7.TXTRIMMIXLOBIASQ', 'read-write',
            u"",
            4, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMMIXINDSW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMMIXINDSW, self).__init__(register,
            'TXTRIMMIXINDSW', 'RAC_NS.PATRIM7.TXTRIMMIXINDSW', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMSHVDDREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMSHVDDREG, self).__init__(register,
            'TXTRIMSHVDDREG', 'RAC_NS.PATRIM7.TXTRIMSHVDDREG', 'read-write',
            u"",
            14, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMSHIBINBUF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMSHIBINBUF, self).__init__(register,
            'TXTRIMSHIBINBUF', 'RAC_NS.PATRIM7.TXTRIMSHIBINBUF', 'read-write',
            u"",
            16, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMSHIBVCM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMSHIBVCM, self).__init__(register,
            'TXTRIMSHIBVCM', 'RAC_NS.PATRIM7.TXTRIMSHIBVCM', 'read-write',
            u"",
            19, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM7_TXTRIMSHVCM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM7_TXTRIMSHVCM, self).__init__(register,
            'TXTRIMSHVCM', 'RAC_NS.PATRIM7.TXTRIMSHVCM', 'read-write',
            u"",
            22, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDVDDD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDVDDD, self).__init__(register,
            'TXTRIMRFPKDVDDD', 'RAC_NS.PATRIM8.TXTRIMRFPKDVDDD', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDIB, self).__init__(register,
            'TXTRIMRFPKDIB', 'RAC_NS.PATRIM8.TXTRIMRFPKDIB', 'read-write',
            u"",
            2, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDVCM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMRFPKDVCM, self).__init__(register,
            'TXTRIMRFPKDVCM', 'RAC_NS.PATRIM8.TXTRIMRFPKDVCM', 'read-write',
            u"",
            4, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMBUFBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMBUFBIAS, self).__init__(register,
            'TXTRIMBUFBIAS', 'RAC_NS.PATRIM8.TXTRIMBUFBIAS', 'read-write',
            u"",
            6, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMBUFSLICESN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMBUFSLICESN, self).__init__(register,
            'TXTRIMBUFSLICESN', 'RAC_NS.PATRIM8.TXTRIMBUFSLICESN', 'read-write',
            u"",
            10, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMBUFSLICESP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMBUFSLICESP, self).__init__(register,
            'TXTRIMBUFSLICESP', 'RAC_NS.PATRIM8.TXTRIMBUFSLICESP', 'read-write',
            u"",
            13, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMBUFVMID(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMBUFVMID, self).__init__(register,
            'TXTRIMBUFVMID', 'RAC_NS.PATRIM8.TXTRIMBUFVMID', 'read-write',
            u"",
            16, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM8_TXTRIMBUFVREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM8_TXTRIMBUFVREG, self).__init__(register,
            'TXTRIMBUFVREG', 'RAC_NS.PATRIM8.TXTRIMBUFVREG', 'read-write',
            u"",
            18, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMDACVCAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMDACVCAS, self).__init__(register,
            'TXTRIMDACVCAS', 'RAC_NS.PATRIM9.TXTRIMDACVCAS', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMDACSCALE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMDACSCALE, self).__init__(register,
            'TXTRIMDACSCALE', 'RAC_NS.PATRIM9.TXTRIMDACSCALE', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMDACVDDD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMDACVDDD, self).__init__(register,
            'TXTRIMDACVDDD', 'RAC_NS.PATRIM9.TXTRIMDACVDDD', 'read-write',
            u"",
            2, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMDACIBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMDACIBIAS, self).__init__(register,
            'TXTRIMDACIBIAS', 'RAC_NS.PATRIM9.TXTRIMDACIBIAS', 'read-write',
            u"",
            4, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMPASLICESN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMPASLICESN, self).__init__(register,
            'TXTRIMPASLICESN', 'RAC_NS.PATRIM9.TXTRIMPASLICESN', 'read-write',
            u"",
            16, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM9_TXTRIMPASLICESP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM9_TXTRIMPASLICESP, self).__init__(register,
            'TXTRIMPASLICESP', 'RAC_NS.PATRIM9.TXTRIMPASLICESP', 'read-write',
            u"",
            24, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM10_TXTRIMPAMIRROR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM10_TXTRIMPAMIRROR, self).__init__(register,
            'TXTRIMPAMIRROR', 'RAC_NS.PATRIM10.TXTRIMPAMIRROR', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM10_TXTRIMPANBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM10_TXTRIMPANBIAS, self).__init__(register,
            'TXTRIMPANBIAS', 'RAC_NS.PATRIM10.TXTRIMPANBIAS', 'read-write',
            u"",
            2, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM10_TXTRIMPANCBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM10_TXTRIMPANCBIAS, self).__init__(register,
            'TXTRIMPANCBIAS', 'RAC_NS.PATRIM10.TXTRIMPANCBIAS', 'read-write',
            u"",
            10, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM10_TXTRIMPAPBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM10_TXTRIMPAPBIAS, self).__init__(register,
            'TXTRIMPAPBIAS', 'RAC_NS.PATRIM10.TXTRIMPAPBIAS', 'read-write',
            u"",
            16, 8)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM10_TXTRIMPAPCBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM10_TXTRIMPAPCBIAS, self).__init__(register,
            'TXTRIMPAPCBIAS', 'RAC_NS.PATRIM10.TXTRIMPAPCBIAS', 'read-write',
            u"",
            24, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXRESETRFPKD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXRESETRFPKD, self).__init__(register,
            'TXRESETRFPKD', 'RAC_NS.TXRFPKD.TXRESETRFPKD', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXSELRFPKDREF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXSELRFPKDREF, self).__init__(register,
            'TXSELRFPKDREF', 'RAC_NS.TXRFPKD.TXSELRFPKDREF', 'read-write',
            u"",
            2, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXRFPKDOUTMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXRFPKDOUTMODE, self).__init__(register,
            'TXRFPKDOUTMODE', 'RAC_NS.TXRFPKD.TXRFPKDOUTMODE', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXRFPKDCALMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXRFPKDCALMODE, self).__init__(register,
            'TXRFPKDCALMODE', 'RAC_NS.TXRFPKD.TXRFPKDCALMODE', 'read-write',
            u"",
            9, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXRFPKDCALCODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXRFPKDCALCODE, self).__init__(register,
            'TXRFPKDCALCODE', 'RAC_NS.TXRFPKD.TXRFPKDCALCODE', 'read-write',
            u"",
            12, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXRFPKD_TXRFPKDCAPATT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXRFPKD_TXRFPKDCAPATT, self).__init__(register,
            'TXRFPKDCAPATT', 'RAC_NS.TXRFPKD.TXRFPKDCAPATT', 'read-write',
            u"",
            20, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXSTATUS_TXRFPKDOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXSTATUS_TXRFPKDOUT, self).__init__(register,
            'TXRFPKDOUT', 'RAC_NS.TXSTATUS.TXRFPKDOUT', 'read-only',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBDIGREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBDIGREG, self).__init__(register,
            'TXENBBDIGREG', 'RAC_NS.TXOFDM.TXENBBDIGREG', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBREG, self).__init__(register,
            'TXENBBREG', 'RAC_NS.TXOFDM.TXENBBREG', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBREGBLEED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBREGBLEED, self).__init__(register,
            'TXENBBREGBLEED', 'RAC_NS.TXOFDM.TXENBBREGBLEED', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBUF0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBUF0, self).__init__(register,
            'TXENBUF0', 'RAC_NS.TXOFDM.TXENBUF0', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBUF1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBUF1, self).__init__(register,
            'TXENBUF1', 'RAC_NS.TXOFDM.TXENBUF1', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBDACI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBDACI, self).__init__(register,
            'TXENBBDACI', 'RAC_NS.TXOFDM.TXENBBDACI', 'read-write',
            u"",
            6, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBDACQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBDACQ, self).__init__(register,
            'TXENBBDACQ', 'RAC_NS.TXOFDM.TXENBBDACQ', 'read-write',
            u"",
            7, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENMIX(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENMIX, self).__init__(register,
            'TXENMIX', 'RAC_NS.TXOFDM.TXENMIX', 'read-write',
            u"",
            8, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBUFREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBUFREG, self).__init__(register,
            'TXENBUFREG', 'RAC_NS.TXOFDM.TXENBUFREG', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBUFREGBLEED(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBUFREGBLEED, self).__init__(register,
            'TXENBUFREGBLEED', 'RAC_NS.TXOFDM.TXENBUFREGBLEED', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENMIXRLOAD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENMIXRLOAD, self).__init__(register,
            'TXENMIXRLOAD', 'RAC_NS.TXOFDM.TXENMIXRLOAD', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENPAFASTSTARTUP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENPAFASTSTARTUP, self).__init__(register,
            'TXENPAFASTSTARTUP', 'RAC_NS.TXOFDM.TXENPAFASTSTARTUP', 'read-write',
            u"",
            13, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENSH(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENSH, self).__init__(register,
            'TXENSH', 'RAC_NS.TXOFDM.TXENSH', 'read-write',
            u"",
            15, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENSHINBUF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENSHINBUF, self).__init__(register,
            'TXENSHINBUF', 'RAC_NS.TXOFDM.TXENSHINBUF', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENSHUGB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENSHUGB, self).__init__(register,
            'TXENSHUGB', 'RAC_NS.TXOFDM.TXENSHUGB', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENFILI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENFILI, self).__init__(register,
            'TXENFILI', 'RAC_NS.TXOFDM.TXENFILI', 'read-write',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENFILQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENFILQ, self).__init__(register,
            'TXENFILQ', 'RAC_NS.TXOFDM.TXENFILQ', 'read-write',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENBBDATA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENBBDATA, self).__init__(register,
            'TXENBBDATA', 'RAC_NS.TXOFDM.TXENBBDATA', 'read-write',
            u"",
            20, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENPACMOS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENPACMOS, self).__init__(register,
            'TXENPACMOS', 'RAC_NS.TXOFDM.TXENPACMOS', 'read-write',
            u"",
            21, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXENTXBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXENTXBIAS, self).__init__(register,
            'TXENTXBIAS', 'RAC_NS.TXOFDM.TXENTXBIAS', 'read-write',
            u"",
            23, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXRESETSHCLKDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXRESETSHCLKDIV, self).__init__(register,
            'TXRESETSHCLKDIV', 'RAC_NS.TXOFDM.TXRESETSHCLKDIV', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXOFDM_TXSELPABIASMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXOFDM_TXSELPABIASMODE, self).__init__(register,
            'TXSELPABIASMODE', 'RAC_NS.TXOFDM.TXSELPABIASMODE', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXCTUNE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXCTUNE, self).__init__(register,
            'TXSELMIXCTUNE', 'RAC_NS.TXMIX.TXSELMIXCTUNE', 'read-write',
            u"",
            0, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXGMSLICEI(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXGMSLICEI, self).__init__(register,
            'TXSELMIXGMSLICEI', 'RAC_NS.TXMIX.TXSELMIXGMSLICEI', 'read-write',
            u"",
            6, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXGMSLICEQ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXGMSLICEQ, self).__init__(register,
            'TXSELMIXGMSLICEQ', 'RAC_NS.TXMIX.TXSELMIXGMSLICEQ', 'read-write',
            u"",
            10, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXRLOAD(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXRLOAD, self).__init__(register,
            'TXSELMIXRLOAD', 'RAC_NS.TXMIX.TXSELMIXRLOAD', 'read-write',
            u"",
            14, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXBAND(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXBAND, self).__init__(register,
            'TXSELMIXBAND', 'RAC_NS.TXMIX.TXSELMIXBAND', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELMIXRDEG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELMIXRDEG, self).__init__(register,
            'TXSELMIXRDEG', 'RAC_NS.TXMIX.TXSELMIXRDEG', 'read-write',
            u"",
            18, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXMIXCAPPULLDOWN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXMIXCAPPULLDOWN, self).__init__(register,
            'TXMIXCAPPULLDOWN', 'RAC_NS.TXMIX.TXMIXCAPPULLDOWN', 'read-write',
            u"",
            21, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELSHINPUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELSHINPUT, self).__init__(register,
            'TXSELSHINPUT', 'RAC_NS.TXMIX.TXSELSHINPUT', 'read-write',
            u"",
            22, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELSHCAPATTN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELSHCAPATTN, self).__init__(register,
            'TXSELSHCAPATTN', 'RAC_NS.TXMIX.TXSELSHCAPATTN', 'read-write',
            u"",
            23, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELSHCLKDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELSHCLKDIV, self).__init__(register,
            'TXSELSHCLKDIV', 'RAC_NS.TXMIX.TXSELSHCLKDIV', 'read-write',
            u"",
            26, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXMIX_TXSELSHINBUFATTN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXMIX_TXSELSHINBUFATTN, self).__init__(register,
            'TXSELSHINBUFATTN', 'RAC_NS.TXMIX.TXSELSHINBUFATTN', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXITC_TXSELITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXITC_TXSELITCDAC, self).__init__(register,
            'TXSELITCDAC', 'RAC_NS.TXITC.TXSELITCDAC', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXITC_TXSELITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXITC_TXSELITCPA, self).__init__(register,
            'TXSELITCPA', 'RAC_NS.TXITC.TXSELITCPA', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXITC_TXSELITCDACLEVEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXITC_TXSELITCDACLEVEL, self).__init__(register,
            'TXSELITCDACLEVEL', 'RAC_NS.TXITC.TXSELITCDACLEVEL', 'read-write',
            u"",
            4, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXITC_TXSELITCPALEVEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXITC_TXSELITCPALEVEL, self).__init__(register,
            'TXSELITCPALEVEL', 'RAC_NS.TXITC.TXSELITCPALEVEL', 'read-write',
            u"",
            6, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALENITCDAC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALENITCDAC, self).__init__(register,
            'TXCALENITCDAC', 'RAC_NS.TXCALITC.TXCALENITCDAC', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALENITCPA(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALENITCPA, self).__init__(register,
            'TXCALENITCPA', 'RAC_NS.TXCALITC.TXCALENITCPA', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALITCDACIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALITCDACIB, self).__init__(register,
            'TXCALITCDACIB', 'RAC_NS.TXCALITC.TXCALITCDACIB', 'read-write',
            u"",
            4, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALITCPAIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALITCPAIB, self).__init__(register,
            'TXCALITCPAIB', 'RAC_NS.TXCALITC.TXCALITCPAIB', 'read-write',
            u"",
            10, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALITCCOREIB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALITCCOREIB, self).__init__(register,
            'TXCALITCCOREIB', 'RAC_NS.TXCALITC.TXCALITCCOREIB', 'read-write',
            u"",
            16, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TXCALITC_TXCALITCCORETC(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TXCALITC_TXCALITCCORETC, self).__init__(register,
            'TXCALITCCORETC', 'RAC_NS.TXCALITC.TXCALITCCORETC', 'read-write',
            u"",
            22, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SPACER_CLKMULTSPACER0(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPACER_CLKMULTSPACER0, self).__init__(register,
            'CLKMULTSPACER0', 'RAC_NS.SPACER.CLKMULTSPACER0', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SPACER_AUXADCSPACER1(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPACER_AUXADCSPACER1, self).__init__(register,
            'AUXADCSPACER1', 'RAC_NS.SPACER.AUXADCSPACER1', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SPACER_RXSPACER2(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPACER_RXSPACER2, self).__init__(register,
            'RXSPACER2', 'RAC_NS.SPACER.RXSPACER2', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFLOCK0_FFTCORPRO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFLOCK0_FFTCORPRO, self).__init__(register,
            'FFTCORPRO', 'RAC_NS.RFLOCK0.FFTCORPRO', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True
