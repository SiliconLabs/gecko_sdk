...
class RM_Peripheral_RAC_NS(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.GPPLLCLKRETIMECTRL = RM_Register_RAC_NS_GPPLLCLKRETIMECTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['GPPLLCLKRETIMECTRL'] = self.GPPLLCLKRETIMECTRL
        self.GPPLLCLKRETIMESTATUS = RM_Register_RAC_NS_GPPLLCLKRETIMESTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['GPPLLCLKRETIMESTATUS'] = self.GPPLLCLKRETIMESTATUS
        self.PATRIM6 = RM_Register_RAC_NS_PATRIM6(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM6'] = self.PATRIM6
        self.PATRIM7 = RM_Register_RAC_NS_PATRIM7(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM7'] = self.PATRIM7
        self.PATRIM8 = RM_Register_RAC_NS_PATRIM8(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM8'] = self.PATRIM8
        self.PATRIM9 = RM_Register_RAC_NS_PATRIM9(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM9'] = self.PATRIM9
        self.PATRIM10 = RM_Register_RAC_NS_PATRIM10(self.zz_rmio, self.zz_label)
        self.zz_rdict['PATRIM10'] = self.PATRIM10
        self.TXRFPKD = RM_Register_RAC_NS_TXRFPKD(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXRFPKD'] = self.TXRFPKD
        self.TXSTATUS = RM_Register_RAC_NS_TXSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXSTATUS'] = self.TXSTATUS
        self.TXOFDM = RM_Register_RAC_NS_TXOFDM(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXOFDM'] = self.TXOFDM
        self.TXMIX = RM_Register_RAC_NS_TXMIX(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXMIX'] = self.TXMIX
        self.TXITC = RM_Register_RAC_NS_TXITC(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXITC'] = self.TXITC
        self.TXCALITC = RM_Register_RAC_NS_TXCALITC(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXCALITC'] = self.TXCALITC
        self.SPACER = RM_Register_RAC_NS_SPACER(self.zz_rmio, self.zz_label)
