...
class RM_Peripheral_SYNTH_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.CALCTRL = RM_Register_SYNTH_S_CALCTRL(self.zz_rmio, self.zz_label)
        ...
        self.CHPDACCTRL = RM_Register_SYNTH_S_CHPDACCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['CHPDACCTRL'] = self.CHPDACCTRL
        self.CAPCALCYCLECNT = RM_Register_SYNTH_S_CAPCALCYCLECNT(self.zz_rmio, self.zz_label)
        ...
        self.CHPDACINIT = RM_Register_SYNTH_S_CHPDACINIT(self.zz_rmio, self.zz_label)
        self.zz_rdict['CHPDACINIT'] = self.CHPDACINIT
        self.LPFCTRL1CAL = RM_Register_SYNTH_S_LPFCTRL1CAL(self.zz_rmio, self.zz_label)
        self.zz_rdict['LPFCTRL1CAL'] = self.LPFCTRL1CAL
        self.LPFCTRL1RX = RM_Register_SYNTH_S_LPFCTRL1RX(self.zz_rmio, self.zz_label)
        self.zz_rdict['LPFCTRL1RX'] = self.LPFCTRL1RX
        self.LPFCTRL1TX = RM_Register_SYNTH_S_LPFCTRL1TX(self.zz_rmio, self.zz_label)
        self.zz_rdict['LPFCTRL1TX'] = self.LPFCTRL1TX
        self.LPFCTRL2RX = RM_Register_SYNTH_S_LPFCTRL2RX(self.zz_rmio, self.zz_label)
        self.zz_rdict['LPFCTRL2RX'] = self.LPFCTRL2RX
        self.LPFCTRL2TX = RM_Register_SYNTH_S_LPFCTRL2TX(self.zz_rmio, self.zz_label)
        ...
        self.SFMIF = RM_Register_SYNTH_S_SFMIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['SFMIF'] = self.SFMIF
        self.SFMIEN = RM_Register_SYNTH_S_SFMIEN(self.zz_rmio, self.zz_label)
