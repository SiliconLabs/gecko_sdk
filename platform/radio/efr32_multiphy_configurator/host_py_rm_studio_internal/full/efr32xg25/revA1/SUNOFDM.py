...
class RM_Peripheral_SUNOFDM(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.ANTDIVDLY = RM_Register_SUNOFDM_ANTDIVDLY(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANTDIVDLY'] = self.ANTDIVDLY
        self.PREEMPH = RM_Register_SUNOFDM_PREEMPH(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPH'] = self.PREEMPH
        self.PREEMPHCOGR0 = RM_Register_SUNOFDM_PREEMPHCOGR0(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR0'] = self.PREEMPHCOGR0
        self.PREEMPHCOGR1 = RM_Register_SUNOFDM_PREEMPHCOGR1(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR1'] = self.PREEMPHCOGR1
        self.PREEMPHCOGR2 = RM_Register_SUNOFDM_PREEMPHCOGR2(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR2'] = self.PREEMPHCOGR2
        self.PREEMPHCOGR3 = RM_Register_SUNOFDM_PREEMPHCOGR3(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR3'] = self.PREEMPHCOGR3
        self.PREEMPHCOGR4 = RM_Register_SUNOFDM_PREEMPHCOGR4(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR4'] = self.PREEMPHCOGR4
        self.PREEMPHCOGR5 = RM_Register_SUNOFDM_PREEMPHCOGR5(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR5'] = self.PREEMPHCOGR5
        self.PREEMPHCOGR6 = RM_Register_SUNOFDM_PREEMPHCOGR6(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR6'] = self.PREEMPHCOGR6
        self.PREEMPHCOGR7 = RM_Register_SUNOFDM_PREEMPHCOGR7(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR7'] = self.PREEMPHCOGR7
        self.PREEMPHCOGR8 = RM_Register_SUNOFDM_PREEMPHCOGR8(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR8'] = self.PREEMPHCOGR8
        self.PREEMPHCOGR9 = RM_Register_SUNOFDM_PREEMPHCOGR9(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR9'] = self.PREEMPHCOGR9
        self.PREEMPHCOGR10 = RM_Register_SUNOFDM_PREEMPHCOGR10(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR10'] = self.PREEMPHCOGR10
        self.PREEMPHCOGR11 = RM_Register_SUNOFDM_PREEMPHCOGR11(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR11'] = self.PREEMPHCOGR11
        self.PREEMPHCOGR12 = RM_Register_SUNOFDM_PREEMPHCOGR12(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREEMPHCOGR12'] = self.PREEMPHCOGR12
        self.ANTDIVDLY2 = RM_Register_SUNOFDM_ANTDIVDLY2(self.zz_rmio, self.zz_label)
        self.zz_rdict['ANTDIVDLY2'] = self.ANTDIVDLY2
