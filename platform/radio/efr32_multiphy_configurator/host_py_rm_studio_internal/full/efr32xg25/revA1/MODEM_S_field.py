...
class RM_Field_MODEM_S_CTRL5_INTOSR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_CTRL5_INTOSR, self).__init__(register,
            'INTOSR', 'MODEM_S.CTRL5.INTOSR', 'read-write',
            u"",
            12, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_PHDMODANTDIV_SKIPTHDSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_PHDMODANTDIV_SKIPTHDSEL, self).__init__(register,
            'SKIPTHDSEL', 'MODEM_S.PHDMODANTDIV.SKIPTHDSEL', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_S_PHDMODANTDIV_RECHKCORREN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_PHDMODANTDIV_RECHKCORREN, self).__init__(register,
            'RECHKCORREN', 'MODEM_S.PHDMODANTDIV.RECHKCORREN', 'read-write',
            u"",
            29, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_MODEM_S_PHDMODANTDIV_ANTDECRSTBYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_S_PHDMODANTDIV_ANTDECRSTBYP, self).__init__(register,
            'ANTDECRSTBYP', 'MODEM_S.PHDMODANTDIV.ANTDECRSTBYP', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
