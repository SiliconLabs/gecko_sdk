...
class RM_Field_MODEM_NS_SRC2NCOCTRL_SRC2NCOEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SRC2NCOCTRL_SRC2NCOEN, self).__init__(register,
            'SRC2NCOEN', 'MODEM_NS.SRC2NCOCTRL.SRC2NCOEN', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_MODEM_NS_SRC2NCOCTRL_PHASEPERCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_MODEM_NS_SRC2NCOCTRL_PHASEPERCLK, self).__init__(register,
            'PHASEPERCLK', 'MODEM_NS.SRC2NCOCTRL.PHASEPERCLK', 'read-write',
            u"",
            1, 14)
        self.__dict__['zz_frozen'] = True
