...
class RM_Peripheral_MODEM_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FWHOPPINGCTRL = RM_Register_MODEM_S_FWHOPPINGCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['FWHOPPINGCTRL'] = self.FWHOPPINGCTRL
        self.FSWIF = RM_Register_MODEM_S_FSWIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWIF'] = self.FSWIF
        self.FSWIEN = RM_Register_MODEM_S_FSWIEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWIEN'] = self.FSWIEN
        self.FSWSPARE = RM_Register_MODEM_S_FSWSPARE(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWSPARE'] = self.FSWSPARE
        self.SIDSSS0 = RM_Register_MODEM_S_SIDSSS0(self.zz_rmio, self.zz_label)
        ...
        self.EHDSSSCFG3 = RM_Register_MODEM_S_EHDSSSCFG3(self.zz_rmio, self.zz_label)
        ...
        self.SYNC3 = RM_Register_MODEM_S_SYNC3(self.zz_rmio, self.zz_label)
        ...
        self.TXFREQCORR = RM_Register_MODEM_S_TXFREQCORR(self.zz_rmio, self.zz_label)
        ...
        self.TXDACVAL = RM_Register_MODEM_S_TXDACVAL(self.zz_rmio, self.zz_label)
        ...
        self.EXPECTPATTDUAL = RM_Register_MODEM_S_EXPECTPATTDUAL(self.zz_rmio, self.zz_label)
        self.zz_rdict['EXPECTPATTDUAL'] = self.EXPECTPATTDUAL
        self.AUXADCIFCTRL = RM_Register_MODEM_S_AUXADCIFCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['AUXADCIFCTRL'] = self.AUXADCIFCTRL
        self.AUXADCIFDOUT = RM_Register_MODEM_S_AUXADCIFDOUT(self.zz_rmio, self.zz_label)
