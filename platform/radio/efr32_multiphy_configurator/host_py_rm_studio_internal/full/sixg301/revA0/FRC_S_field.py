...
class RM_Field_FRC_S_CTRL_LPMODEEXTEND(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_S_CTRL_LPMODEEXTEND, self).__init__(register,
            'LPMODEEXTEND', 'FRC_S.CTRL.LPMODEEXTEND', 'read-write',
            u"",
            27, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_FRC_S_SNIFFCTRL_SNIFFRACSTATE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_FRC_S_SNIFFCTRL_SNIFFRACSTATE, self).__init__(register,
            'SNIFFRACSTATE', 'FRC_S.SNIFFCTRL.SNIFFRACSTATE', 'read-write',
            u"",
            18, 1)
        self.__dict__['zz_frozen'] = True
