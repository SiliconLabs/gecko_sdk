...
class RM_Register_SYNTH_S_QNCCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.QNCMODE = RM_Field_SYNTH_S_QNCCTRL_QNCMODE(self)
...
class RM_Register_SYNTH_S_MMDDENOMINIT(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.MMDXOJINTN = RM_Field_SYNTH_S_MMDDENOMINIT_MMDXOJINTN(self)
...
class RM_Register_SYNTH_S_LMSOVERRIDE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.GLMSOVERRIDEVAL = RM_Field_SYNTH_S_LMSOVERRIDE_GLMSOVERRIDEVAL(self)
