...
class RM_Peripheral_RAC_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.FSWIF = RM_Register_RAC_S_FSWIF(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWIF'] = self.FSWIF
        self.FSWIEN = RM_Register_RAC_S_FSWIEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['FSWIEN'] = self.FSWIEN
        self.TXWRAPUPNEXT = RM_Register_RAC_S_TXWRAPUPNEXT(self.zz_rmio, self.zz_label)
        self.zz_rdict['TXWRAPUPNEXT'] = self.TXWRAPUPNEXT
        self.RXWRAPUPNEXT = RM_Register_RAC_S_RXWRAPUPNEXT(self.zz_rmio, self.zz_label)
        self.zz_rdict['RXWRAPUPNEXT'] = self.RXWRAPUPNEXT
        self.SEQEND = RM_Register_RAC_S_SEQEND(self.zz_rmio, self.zz_label)
        self.zz_rdict['SEQEND'] = self.SEQEND
        self.SEQENDEN = RM_Register_RAC_S_SEQENDEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['SEQENDEN'] = self.SEQENDEN
        self.FRCCLKDIS = RM_Register_RAC_S_FRCCLKDIS(self.zz_rmio, self.zz_label)
        self.zz_rdict['FRCCLKDIS'] = self.FRCCLKDIS
        self.BUFCCLKDIS = RM_Register_RAC_S_BUFCCLKDIS(self.zz_rmio, self.zz_label)
        ...
        self.HYDRARAMREMAP = RM_Register_RAC_S_HYDRARAMREMAP(self.zz_rmio, self.zz_label)
        ...
        self.ADCSTATUS = RM_Register_RAC_S_ADCSTATUS(self.zz_rmio, self.zz_label)
        ...
        self.SYLOEN0 = RM_Register_RAC_S_SYLOEN0(self.zz_rmio, self.zz_label)
        ...
        self.MIXDACTRIM = RM_Register_RAC_S_MIXDACTRIM(self.zz_rmio, self.zz_label)
        self.zz_rdict['MIXDACTRIM'] = self.MIXDACTRIM
        self.SYTRIM2 = RM_Register_RAC_S_SYTRIM2(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYTRIM2'] = self.SYTRIM2
        self.SYDLFCTRL1 = RM_Register_RAC_S_SYDLFCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYDLFCTRL1'] = self.SYDLFCTRL1
        self.SYSTATUS = RM_Register_RAC_S_SYSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYSTATUS'] = self.SYSTATUS
        self.SYCTRL2 = RM_Register_RAC_S_SYCTRL2(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYCTRL2'] = self.SYCTRL2
        self.TIATRIM0 = RM_Register_RAC_S_TIATRIM0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIATRIM0'] = self.TIATRIM0
        self.TIAEN = RM_Register_RAC_S_TIAEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIAEN'] = self.TIAEN
        self.VTRCTRL0 = RM_Register_RAC_S_VTRCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['VTRCTRL0'] = self.VTRCTRL0
        self.AUXADCCAL = RM_Register_RAC_S_AUXADCCAL(self.zz_rmio, self.zz_label)
        self.zz_rdict['AUXADCCAL'] = self.AUXADCCAL
        self.AUXADCCTRL2 = RM_Register_RAC_S_AUXADCCTRL2(self.zz_rmio, self.zz_label)
        self.zz_rdict['AUXADCCTRL2'] = self.AUXADCCTRL2
        self.LNAMIXEN0 = RM_Register_RAC_S_LNAMIXEN0(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAMIXEN0'] = self.LNAMIXEN0
        self.MIXDACEN = RM_Register_RAC_S_MIXDACEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['MIXDACEN'] = self.MIXDACEN
        self.SYCTRL1 = RM_Register_RAC_S_SYCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYCTRL1'] = self.SYCTRL1
        self.TX0DBMEN = RM_Register_RAC_S_TX0DBMEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX0DBMEN'] = self.TX0DBMEN
        self.TX0DBMCTRL = RM_Register_RAC_S_TX0DBMCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX0DBMCTRL'] = self.TX0DBMCTRL
        self.TX0DBMTRIM1 = RM_Register_RAC_S_TX0DBMTRIM1(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX0DBMTRIM1'] = self.TX0DBMTRIM1
        self.TX0DBMTRIM0 = RM_Register_RAC_S_TX0DBMTRIM0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX0DBMTRIM0'] = self.TX0DBMTRIM0
        self.TX10DBMEN = RM_Register_RAC_S_TX10DBMEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMEN'] = self.TX10DBMEN
        self.TX10DBMCTRL0 = RM_Register_RAC_S_TX10DBMCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMCTRL0'] = self.TX10DBMCTRL0
        self.TX10DBMTRIM1 = RM_Register_RAC_S_TX10DBMTRIM1(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMTRIM1'] = self.TX10DBMTRIM1
        self.TX10DBMTRIM2 = RM_Register_RAC_S_TX10DBMTRIM2(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMTRIM2'] = self.TX10DBMTRIM2
        self.PREREGTRIM = RM_Register_RAC_S_PREREGTRIM(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREREGTRIM'] = self.PREREGTRIM
        self.MIXDACTRIM1 = RM_Register_RAC_S_MIXDACTRIM1(self.zz_rmio, self.zz_label)
        self.zz_rdict['MIXDACTRIM1'] = self.MIXDACTRIM1
        self.SYDLF1 = RM_Register_RAC_S_SYDLF1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYDLF1'] = self.SYDLF1
        self.SPARE1 = RM_Register_RAC_S_SPARE1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SPARE1'] = self.SPARE1
        self.PREREGSTATUS = RM_Register_RAC_S_PREREGSTATUS(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREREGSTATUS'] = self.PREREGSTATUS
        self.VTRTRIM = RM_Register_RAC_S_VTRTRIM(self.zz_rmio, self.zz_label)
        self.zz_rdict['VTRTRIM'] = self.VTRTRIM
        self.ADCCTRL0 = RM_Register_RAC_S_ADCCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADCCTRL0'] = self.ADCCTRL0
        self.ADCCTRL1 = RM_Register_RAC_S_ADCCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADCCTRL1'] = self.ADCCTRL1
        self.ADCEN0 = RM_Register_RAC_S_ADCEN0(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADCEN0'] = self.ADCEN0
        self.ADCTRIM0 = RM_Register_RAC_S_ADCTRIM0(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADCTRIM0'] = self.ADCTRIM0
        self.ADCCTRL2 = RM_Register_RAC_S_ADCCTRL2(self.zz_rmio, self.zz_label)
        self.zz_rdict['ADCCTRL2'] = self.ADCCTRL2
        self.LNAMIXEN1 = RM_Register_RAC_S_LNAMIXEN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAMIXEN1'] = self.LNAMIXEN1
        self.LNAMIXCTRL0 = RM_Register_RAC_S_LNAMIXCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAMIXCTRL0'] = self.LNAMIXCTRL0
        self.LNAMIXCTRL1 = RM_Register_RAC_S_LNAMIXCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['LNAMIXCTRL1'] = self.LNAMIXCTRL1
        self.PREREGEN = RM_Register_RAC_S_PREREGEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREREGEN'] = self.PREREGEN
        self.PREDEBUG = RM_Register_RAC_S_PREDEBUG(self.zz_rmio, self.zz_label)
        self.zz_rdict['PREDEBUG'] = self.PREDEBUG
        self.SYDLFCTRL0 = RM_Register_RAC_S_SYDLFCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYDLFCTRL0'] = self.SYDLFCTRL0
        self.SYEN0 = RM_Register_RAC_S_SYEN0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYEN0'] = self.SYEN0
        self.SYEN1 = RM_Register_RAC_S_SYEN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYEN1'] = self.SYEN1
        self.SYEN2 = RM_Register_RAC_S_SYEN2(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYEN2'] = self.SYEN2
        self.SYCTRL0 = RM_Register_RAC_S_SYCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYCTRL0'] = self.SYCTRL0
        self.SYLOEN1 = RM_Register_RAC_S_SYLOEN1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOEN1'] = self.SYLOEN1
        self.SYLOEN2 = RM_Register_RAC_S_SYLOEN2(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOEN2'] = self.SYLOEN2
        self.SYLOCTRL0 = RM_Register_RAC_S_SYLOCTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOCTRL0'] = self.SYLOCTRL0
        self.SYLOCTRL1 = RM_Register_RAC_S_SYLOCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOCTRL1'] = self.SYLOCTRL1
        self.SYLOTRIM0 = RM_Register_RAC_S_SYLOTRIM0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOTRIM0'] = self.SYLOTRIM0
        self.SYTRIM3 = RM_Register_RAC_S_SYTRIM3(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYTRIM3'] = self.SYTRIM3
        self.TIACTRL0 = RM_Register_RAC_S_TIACTRL0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACTRL0'] = self.TIACTRL0
        self.TIACTRL1 = RM_Register_RAC_S_TIACTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['TIACTRL1'] = self.TIACTRL1
        self.TX10DBMCTRL1 = RM_Register_RAC_S_TX10DBMCTRL1(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMCTRL1'] = self.TX10DBMCTRL1
        self.TX10DBMTRIM0 = RM_Register_RAC_S_TX10DBMTRIM0(self.zz_rmio, self.zz_label)
        self.zz_rdict['TX10DBMTRIM0'] = self.TX10DBMTRIM0
        self.SYCTRLTX0 = RM_Register_RAC_S_SYCTRLTX0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYCTRLTX0'] = self.SYCTRLTX0
        self.SYLOCTRLTX0 = RM_Register_RAC_S_SYLOCTRLTX0(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOCTRLTX0'] = self.SYLOCTRLTX0
        self.SYLOCTRLTX1 = RM_Register_RAC_S_SYLOCTRLTX1(self.zz_rmio, self.zz_label)
        self.zz_rdict['SYLOCTRLTX1'] = self.SYLOCTRLTX1
        self.CLKMULTEN2 = RM_Register_RAC_S_CLKMULTEN2(self.zz_rmio, self.zz_label)
        ...
        self.FSWCTRL = RM_Register_RAC_S_FSWCTRL(self.zz_rmio, self.zz_label)
