...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG13XFULL_RevA2``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG13XFULL_RevA2
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG13XFULL_RevA2' ]
...
class RM_Device_EFR32XG13XFULL_RevA2(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm'):
        ...
        super(RM_Device_EFR32XG13XFULL_RevA2, self).__init__(rmio, label,
            'EFR32XG13XFULL',
