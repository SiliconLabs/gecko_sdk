...
class RM_Register_RAC_S_PATRIM0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXTRIMLPAVMID = RM_Field_RAC_S_PATRIM0_TXTRIMLPAVMID(self)
...
class RM_Register_RAC_S_RFPATHEN0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENHPA0 = RM_Field_RAC_S_RFPATHEN0_TXENHPA0(self)
        self.zz_fdict['TXENHPA0'] = self.TXENHPA0
        self.TXENLPA0 = RM_Field_RAC_S_RFPATHEN0_TXENLPA0(self)
        ...
        self.TXENVMIDLPA0 = RM_Field_RAC_S_RFPATHEN0_TXENVMIDLPA0(self)
...
class RM_Register_RAC_S_RFPATHEN1(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.TXENHPA1 = RM_Field_RAC_S_RFPATHEN1_TXENHPA1(self)
        self.zz_fdict['TXENHPA1'] = self.TXENHPA1
        self.TXENLPA1 = RM_Field_RAC_S_RFPATHEN1_TXENLPA1(self)
        ...
        self.TXENVMIDLPA1 = RM_Field_RAC_S_RFPATHEN1_TXENVMIDLPA1(self)
...
class RM_Register_RAC_S_IFADCPLLCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCPLLCTRL, self).__init__(rmio, label,
            0xa8020000, 0x1A8,
            'IFADCPLLCTRL', 'RAC_S.IFADCPLLCTRL', 'read-write',
            u"",
            0x00000000, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCPLLINNIBBLE = RM_Field_RAC_S_IFADCPLLCTRL_IFADCPLLINNIBBLE(self)
        self.zz_fdict['IFADCPLLINNIBBLE'] = self.IFADCPLLINNIBBLE
        self.IFADCPLLLDCNIB = RM_Field_RAC_S_IFADCPLLCTRL_IFADCPLLLDCNIB(self)
        self.zz_fdict['IFADCPLLLDCNIB'] = self.IFADCPLLLDCNIB
        self.IFADCPLLLDFNIB = RM_Field_RAC_S_IFADCPLLCTRL_IFADCPLLLDFNIB(self)
        self.zz_fdict['IFADCPLLLDFNIB'] = self.IFADCPLLLDFNIB
        self.IFADCPLLLDMNIB = RM_Field_RAC_S_IFADCPLLCTRL_IFADCPLLLDMNIB(self)
        self.zz_fdict['IFADCPLLLDMNIB'] = self.IFADCPLLLDMNIB
        self.IFADCPLLRDNIBBLE = RM_Field_RAC_S_IFADCPLLCTRL_IFADCPLLRDNIBBLE(self)
        self.zz_fdict['IFADCPLLRDNIBBLE'] = self.IFADCPLLRDNIBBLE
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_IFADCPLLDCO(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCPLLDCO, self).__init__(rmio, label,
            0xa8020000, 0x1AC,
            'IFADCPLLDCO', 'RAC_S.IFADCPLLDCO', 'read-write',
            u"",
            0x00010104, 0x0001FFFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCPLLDCOBBCAL = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOBBCAL(self)
        self.zz_fdict['IFADCPLLDCOBBCAL'] = self.IFADCPLLDCOBBCAL
        self.IFADCPLLDCOTEMPADJ = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOTEMPADJ(self)
        self.zz_fdict['IFADCPLLDCOTEMPADJ'] = self.IFADCPLLDCOTEMPADJ
        self.IFADCPLLDCOBIASHALF = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOBIASHALF(self)
        self.zz_fdict['IFADCPLLDCOBIASHALF'] = self.IFADCPLLDCOBIASHALF
        self.IFADCPLLDCOENABLE = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOENABLE(self)
        self.zz_fdict['IFADCPLLDCOENABLE'] = self.IFADCPLLDCOENABLE
        self.IFADCPLLDCOFILTER = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOFILTER(self)
        self.zz_fdict['IFADCPLLDCOFILTER'] = self.IFADCPLLDCOFILTER
        self.IFADCPLLDCOFULLRATE = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOFULLRATE(self)
        self.zz_fdict['IFADCPLLDCOFULLRATE'] = self.IFADCPLLDCOFULLRATE
        self.IFADCPLLDCOMSBCURRENT = RM_Field_RAC_S_IFADCPLLDCO_IFADCPLLDCOMSBCURRENT(self)
        self.zz_fdict['IFADCPLLDCOMSBCURRENT'] = self.IFADCPLLDCOMSBCURRENT
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_IFADCPLLEN(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCPLLEN, self).__init__(rmio, label,
            0xa8020000, 0x1B0,
            'IFADCPLLEN', 'RAC_S.IFADCPLLEN', 'read-write',
            u"",
            0x00000000, 0x000003FD,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCPLLENBBDET = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENBBDET(self)
        self.zz_fdict['IFADCPLLENBBDET'] = self.IFADCPLLENBBDET
        self.IFADCPLLENBBXLDET = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENBBXLDET(self)
        self.zz_fdict['IFADCPLLENBBXLDET'] = self.IFADCPLLENBBXLDET
        self.IFADCPLLENBBXMDET = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENBBXMDET(self)
        self.zz_fdict['IFADCPLLENBBXMDET'] = self.IFADCPLLENBBXMDET
        self.IFADCPLLENCFDET = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENCFDET(self)
        self.zz_fdict['IFADCPLLENCFDET'] = self.IFADCPLLENCFDET
        self.IFADCPLLENROTDET = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENROTDET(self)
        self.zz_fdict['IFADCPLLENROTDET'] = self.IFADCPLLENROTDET
        self.IFADCPLLSERIEREGENABLE = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLSERIEREGENABLE(self)
        self.zz_fdict['IFADCPLLSERIEREGENABLE'] = self.IFADCPLLSERIEREGENABLE
        self.IFADCPLLSHUNTREGENABLE = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLSHUNTREGENABLE(self)
        self.zz_fdict['IFADCPLLSHUNTREGENABLE'] = self.IFADCPLLSHUNTREGENABLE
        self.IFADCPLLENREFBUF = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENREFBUF(self)
        self.zz_fdict['IFADCPLLENREFBUF'] = self.IFADCPLLENREFBUF
        self.IFADCPLLENXOBYP = RM_Field_RAC_S_IFADCPLLEN_IFADCPLLENXOBYP(self)
        self.zz_fdict['IFADCPLLENXOBYP'] = self.IFADCPLLENXOBYP
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_IFADCPLLREG(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCPLLREG, self).__init__(rmio, label,
            0xa8020000, 0x1B4,
            'IFADCPLLREG', 'RAC_S.IFADCPLLREG', 'read-write',
            u"",
            0x00000136, 0x000001FF,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCPLLSERIEREGFILTER = RM_Field_RAC_S_IFADCPLLREG_IFADCPLLSERIEREGFILTER(self)
        self.zz_fdict['IFADCPLLSERIEREGFILTER'] = self.IFADCPLLSERIEREGFILTER
        self.IFADCPLLSERIEREGVCTRL = RM_Field_RAC_S_IFADCPLLREG_IFADCPLLSERIEREGVCTRL(self)
        self.zz_fdict['IFADCPLLSERIEREGVCTRL'] = self.IFADCPLLSERIEREGVCTRL
        self.IFADCPLLSHUNTREGICTRL = RM_Field_RAC_S_IFADCPLLREG_IFADCPLLSHUNTREGICTRL(self)
        self.zz_fdict['IFADCPLLSHUNTREGICTRL'] = self.IFADCPLLSHUNTREGICTRL
        self.IFADCPLLSHUNTREGVCTRL = RM_Field_RAC_S_IFADCPLLREG_IFADCPLLSHUNTREGVCTRL(self)
        self.zz_fdict['IFADCPLLSHUNTREGVCTRL'] = self.IFADCPLLSHUNTREGVCTRL
        self.__dict__['zz_frozen'] = True


class RM_Register_RAC_S_IFADCPLLOUTSTATUS(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_RAC_S_IFADCPLLOUTSTATUS, self).__init__(rmio, label,
            0xa8020000, 0x1B8,
            'IFADCPLLOUTSTATUS', 'RAC_S.IFADCPLLOUTSTATUS', 'read-only',
            u"",
            0x00000000, 0x0000000F,
            0x00001000, 0x00002000,
            0x00003000)

        self.IFADCPLLOUTNIBBLE = RM_Field_RAC_S_IFADCPLLOUTSTATUS_IFADCPLLOUTNIBBLE(self)
...
class RM_Register_RAC_S_SPARE(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.IFADCPLLSPARE = RM_Field_RAC_S_SPARE_IFADCPLLSPARE(self)
...
class RM_Register_RAC_S_RFLOCK0(Base_RM_Register):
    def __init__(self, rmio, label):
        ...
        self.RACTXENLPA = RM_Field_RAC_S_RFLOCK0_RACTXENLPA(self)
        self.zz_fdict['RACTXENLPA'] = self.RACTXENLPA
        self.RACTXENHPA = RM_Field_RAC_S_RFLOCK0_RACTXENHPA(self)
