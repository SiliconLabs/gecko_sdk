...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG12XFULL_RevA1``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG12XFULL_RevA1
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG12XFULL_RevA1' ]
...
class RM_Device_EFR32XG12XFULL_RevA1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG12XFULL_RevA1, self).__init__(rmio, label,
            'EFR32XG12XFULL',
            RM_SVD_Info('EFR32XG12XFULL_SEQ.svd', '80d9e0e5adf58e89295f295da8492f6d'))
