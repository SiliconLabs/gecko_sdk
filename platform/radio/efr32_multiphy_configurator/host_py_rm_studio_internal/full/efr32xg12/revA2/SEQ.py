...
class RM_Peripheral_SEQ(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        super(RM_Peripheral_SEQ, self).__init__(rmio, label,
            0x21001FDC, 'SEQ',
            u"")
        self.BBSS_GROUP_1 = RM_Register_SEQ_BBSS_GROUP_1(self.zz_rmio, self.zz_label)
        self.zz_rdict['BBSS_GROUP_1'] = self.BBSS_GROUP_1
        self.BBSS_GROUP_2 = RM_Register_SEQ_BBSS_GROUP_2(self.zz_rmio, self.zz_label)
        self.zz_rdict['BBSS_GROUP_2'] = self.BBSS_GROUP_2
        self.BBSS_GROUP_3 = RM_Register_SEQ_BBSS_GROUP_3(self.zz_rmio, self.zz_label)
        self.zz_rdict['BBSS_GROUP_3'] = self.BBSS_GROUP_3
        self.BBSS_GROUP_4 = RM_Register_SEQ_BBSS_GROUP_4(self.zz_rmio, self.zz_label)
        self.zz_rdict['BBSS_GROUP_4'] = self.BBSS_GROUP_4
