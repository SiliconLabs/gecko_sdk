...
class RM_Peripheral_RAC(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.IFADCPLLCTRL = RM_Register_RAC_IFADCPLLCTRL(self.zz_rmio, self.zz_label)
        self.zz_rdict['IFADCPLLCTRL'] = self.IFADCPLLCTRL
        self.IFADCPLLDCO = RM_Register_RAC_IFADCPLLDCO(self.zz_rmio, self.zz_label)
        self.zz_rdict['IFADCPLLDCO'] = self.IFADCPLLDCO
        self.IFADCPLLEN = RM_Register_RAC_IFADCPLLEN(self.zz_rmio, self.zz_label)
        self.zz_rdict['IFADCPLLEN'] = self.IFADCPLLEN
        self.IFADCPLLREG = RM_Register_RAC_IFADCPLLREG(self.zz_rmio, self.zz_label)
        self.zz_rdict['IFADCPLLREG'] = self.IFADCPLLREG
        self.IFADCPLLOUTSTATUS = RM_Register_RAC_IFADCPLLOUTSTATUS(self.zz_rmio, self.zz_label)
