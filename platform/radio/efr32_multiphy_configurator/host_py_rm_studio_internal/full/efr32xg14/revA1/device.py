...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG14XFULL_RevA1``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG14XFULL_RevA1
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG14XFULL_RevA1' ]
...
class RM_Device_EFR32XG14XFULL_RevA1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm'):
        ...
        super(RM_Device_EFR32XG14XFULL_RevA1, self).__init__(rmio, label,
            'EFR32XG14XFULL',
            RM_SVD_Info('EFR32XG14XFULL_SEQ.svd', 'c7cfda68c111bd7ee7f3ee61de3447eb'))
