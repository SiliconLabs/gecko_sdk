...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG14XFULL_RevA0``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG14XFULL_RevA0
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG14XFULL_RevA0' ]
...
class RM_Device_EFR32XG14XFULL_RevA0(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm'):
        ...
        super(RM_Device_EFR32XG14XFULL_RevA0, self).__init__(rmio, label,
            'EFR32XG14XFULL',
            RM_SVD_Info('EFR32XG14XFULL_SEQ.svd', '88fb16cac795868fe82d2d2611ad8a54'))
