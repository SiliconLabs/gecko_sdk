...
class RM_Peripheral_MODEM_S(Base_RM_Peripheral):
    def __init__(self, rmio, label):
        ...
        self.BLEIQDSA = RM_Register_MODEM_S_BLEIQDSA(self.zz_rmio, self.zz_label)
        self.zz_rdict['BLEIQDSA'] = self.BLEIQDSA
        self.BLEIQDSAEXT1 = RM_Register_MODEM_S_BLEIQDSAEXT1(self.zz_rmio, self.zz_label)
        ...
        self.BLEIQDSAEXT2 = RM_Register_MODEM_S_BLEIQDSAEXT2(self.zz_rmio, self.zz_label)
