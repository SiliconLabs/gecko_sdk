...
class RM_Field_RAC_NS_PAENCTRL_PARAMPMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PAENCTRL_PARAMPMODE, self).__init__(register,
            'PARAMPMODE', 'RAC_NS.PAENCTRL.PARAMPMODE', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_LNAMIXDEBUG_LNAMIXDISMXR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXDEBUG_LNAMIXDISMXR, self).__init__(register,
            'LNAMIXDISMXR', 'RAC_NS.LNAMIXDEBUG.LNAMIXDISMXR', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXIBIASADJ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXIBIASADJ, self).__init__(register,
            'LNAMIXIBIASADJ', 'RAC_NS.LNAMIXTRIM1.LNAMIXIBIASADJ', 'read-write',
            u"",
            0, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXLNACAPSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXLNACAPSEL, self).__init__(register,
            'LNAMIXLNACAPSEL', 'RAC_NS.LNAMIXTRIM1.LNAMIXLNACAPSEL', 'read-write',
            u"",
            6, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXMXRBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXMXRBIAS, self).__init__(register,
            'LNAMIXMXRBIAS', 'RAC_NS.LNAMIXTRIM1.LNAMIXMXRBIAS', 'read-write',
            u"",
            9, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXNCASADJ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXNCASADJ, self).__init__(register,
            'LNAMIXNCASADJ', 'RAC_NS.LNAMIXTRIM1.LNAMIXNCASADJ', 'read-write',
            u"",
            11, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXPCASADJ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXPCASADJ, self).__init__(register,
            'LNAMIXPCASADJ', 'RAC_NS.LNAMIXTRIM1.LNAMIXPCASADJ', 'read-write',
            u"",
            13, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXVOUTADJ(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXTRIM1_LNAMIXVOUTADJ, self).__init__(register,
            'LNAMIXVOUTADJ', 'RAC_NS.LNAMIXTRIM1.LNAMIXVOUTADJ', 'read-write',
            u"",
            15, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_LNAMIXCAL_LNAMIXENIRCAL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXCAL_LNAMIXENIRCAL, self).__init__(register,
            'LNAMIXENIRCAL', 'RAC_NS.LNAMIXCAL.LNAMIXENIRCAL', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_LNAMIXCAL_LNAMIXIRCALAMP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_LNAMIXCAL_LNAMIXIRCALAMP, self).__init__(register,
            'LNAMIXIRCALAMP', 'RAC_NS.LNAMIXCAL.LNAMIXIRCALAMP', 'read-write',
            u"",
            4, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYN, self).__init__(register,
            'TX0DBMTRIMDUTYCYN', 'RAC_NS.PATRIM0.TX0DBMTRIMDUTYCYN', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM0_TX0DBMTRIMDUTYCYP, self).__init__(register,
            'TX0DBMTRIMDUTYCYP', 'RAC_NS.PATRIM0.TX0DBMTRIMDUTYCYP', 'read-write',
            u"",
            11, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PATRIM1_TX0DBMTRIMTAPCAP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM1_TX0DBMTRIMTAPCAP, self).__init__(register,
            'TX0DBMTRIMTAPCAP', 'RAC_NS.PATRIM1.TX0DBMTRIMTAPCAP', 'read-write',
            u"",
            16, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASN, self).__init__(register,
            'TX6DBMTRIMBIASN', 'RAC_NS.PATRIM2.TX6DBMTRIMBIASN', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMBIASP, self).__init__(register,
            'TX6DBMTRIMBIASP', 'RAC_NS.PATRIM2.TX6DBMTRIMBIASP', 'read-write',
            u"",
            4, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYN, self).__init__(register,
            'TX6DBMTRIMDUTYCYN', 'RAC_NS.PATRIM2.TX6DBMTRIMDUTYCYN', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYP(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM2_TX6DBMTRIMDUTYCYP, self).__init__(register,
            'TX6DBMTRIMDUTYCYP', 'RAC_NS.PATRIM2.TX6DBMTRIMDUTYCYP', 'read-write',
            u"",
            11, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMIBIASMASTER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMIBIASMASTER, self).__init__(register,
            'TX6DBMTRIMIBIASMASTER', 'RAC_NS.PATRIM3.TX6DBMTRIMIBIASMASTER', 'read-write',
            u"",
            0, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFB, self).__init__(register,
            'TX6DBMTRIMPREDRVREGFB', 'RAC_NS.PATRIM3.TX6DBMTRIMPREDRVREGFB', 'read-write',
            u"",
            2, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFBKATT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGFBKATT, self).__init__(register,
            'TX6DBMTRIMPREDRVREGFBKATT', 'RAC_NS.PATRIM3.TX6DBMTRIMPREDRVREGFBKATT', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGPSR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGPSR, self).__init__(register,
            'TX6DBMTRIMPREDRVREGPSR', 'RAC_NS.PATRIM3.TX6DBMTRIMPREDRVREGPSR', 'read-write',
            u"",
            5, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGSLICE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGSLICE, self).__init__(register,
            'TX6DBMTRIMPREDRVREGSLICE', 'RAC_NS.PATRIM3.TX6DBMTRIMPREDRVREGSLICE', 'read-write',
            u"",
            6, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGVREF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMPREDRVREGVREF, self).__init__(register,
            'TX6DBMTRIMPREDRVREGVREF', 'RAC_NS.PATRIM3.TX6DBMTRIMPREDRVREGVREF', 'read-write',
            u"",
            8, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGBLEEDAUTO(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGBLEEDAUTO, self).__init__(register,
            'TX6DBMTRIMREGBLEEDAUTO', 'RAC_NS.PATRIM3.TX6DBMTRIMREGBLEEDAUTO', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGFB(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGFB, self).__init__(register,
            'TX6DBMTRIMREGFB', 'RAC_NS.PATRIM3.TX6DBMTRIMREGFB', 'read-write',
            u"",
            12, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGPSR(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGPSR, self).__init__(register,
            'TX6DBMTRIMREGPSR', 'RAC_NS.PATRIM3.TX6DBMTRIMREGPSR', 'read-write',
            u"",
            14, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGVREF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMREGVREF, self).__init__(register,
            'TX6DBMTRIMREGVREF', 'RAC_NS.PATRIM3.TX6DBMTRIMREGVREF', 'read-write',
            u"",
            17, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMRXMODEVREF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PATRIM3_TX6DBMTRIMRXMODEVREF, self).__init__(register,
            'TX6DBMTRIMRXMODEVREF', 'RAC_NS.PATRIM3.TX6DBMTRIMRXMODEVREF', 'read-write',
            u"",
            21, 2)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX0DBMPOWER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX0DBMPOWER, self).__init__(register,
            'TX0DBMPOWER', 'RAC_NS.PACTRL.TX0DBMPOWER', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX0DBMSELSLICE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX0DBMSELSLICE, self).__init__(register,
            'TX0DBMSELSLICE', 'RAC_NS.PACTRL.TX0DBMSELSLICE', 'read-write',
            u"",
            4, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_PACTRL_TX6DBMPOWER(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMPOWER, self).__init__(register,
            'TX6DBMPOWER', 'RAC_NS.PACTRL.TX6DBMPOWER', 'read-write',
            u"",
            16, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMSELSLICE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMSELSLICE, self).__init__(register,
            'TX6DBMSELSLICE', 'RAC_NS.PACTRL.TX6DBMSELSLICE', 'read-write',
            u"",
            21, 3)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMSLICERESET(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMSLICERESET, self).__init__(register,
            'TX6DBMSLICERESET', 'RAC_NS.PACTRL.TX6DBMSLICERESET', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMLATCHBYPASS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMLATCHBYPASS, self).__init__(register,
            'TX6DBMLATCHBYPASS', 'RAC_NS.PACTRL.TX6DBMLATCHBYPASS', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMPREDRVREGBYPASS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMPREDRVREGBYPASS, self).__init__(register,
            'TX6DBMPREDRVREGBYPASS', 'RAC_NS.PACTRL.TX6DBMPREDRVREGBYPASS', 'read-write',
            u"",
            26, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMPULLDOWNREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMPULLDOWNREG, self).__init__(register,
            'TX6DBMPULLDOWNREG', 'RAC_NS.PACTRL.TX6DBMPULLDOWNREG', 'read-write',
            u"",
            27, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_PACTRL_TX6DBMREGBYPASS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_PACTRL_TX6DBMREGBYPASS, self).__init__(register,
            'TX6DBMREGBYPASS', 'RAC_NS.PACTRL.TX6DBMREGBYPASS', 'read-write',
            u"",
            28, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFPATHEN_LNAMIXEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN_LNAMIXEN, self).__init__(register,
            'LNAMIXEN', 'RAC_NS.RFPATHEN.LNAMIXEN', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFPATHEN_LNAMIXRFATTDCEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN_LNAMIXRFATTDCEN, self).__init__(register,
            'LNAMIXRFATTDCEN', 'RAC_NS.RFPATHEN.LNAMIXRFATTDCEN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFPATHEN_LNAMIXRFPKDENRF(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN_LNAMIXRFPKDENRF, self).__init__(register,
            'LNAMIXRFPKDENRF', 'RAC_NS.RFPATHEN.LNAMIXRFPKDENRF', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFPATHEN_LNAMIXTRSW(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFPATHEN_LNAMIXTRSW, self).__init__(register,
            'LNAMIXTRSW', 'RAC_NS.RFPATHEN.LNAMIXTRSW', 'read-write',
            u"",
            4, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RX_TX6DBMENRXMODEBIAS(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RX_TX6DBMENRXMODEBIAS, self).__init__(register,
            'TX6DBMENRXMODEBIAS', 'RAC_NS.RX.TX6DBMENRXMODEBIAS', 'read-write',
            u"",
            11, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_TX_TX6DBMENBLEEDPREDRVREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENBLEEDPREDRVREG, self).__init__(register,
            'TX6DBMENBLEEDPREDRVREG', 'RAC_NS.TX.TX6DBMENBLEEDPREDRVREG', 'read-write',
            u"",
            16, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENBLEEDREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENBLEEDREG, self).__init__(register,
            'TX6DBMENBLEEDREG', 'RAC_NS.TX.TX6DBMENBLEEDREG', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENPREDRVREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENPREDRVREG, self).__init__(register,
            'TX6DBMENPREDRVREG', 'RAC_NS.TX.TX6DBMENPREDRVREG', 'read-write',
            u"",
            19, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENRAMPCLK(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENRAMPCLK, self).__init__(register,
            'TX6DBMENRAMPCLK', 'RAC_NS.TX.TX6DBMENRAMPCLK', 'read-write',
            u"",
            22, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENREG(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENREG, self).__init__(register,
            'TX6DBMENREG', 'RAC_NS.TX.TX6DBMENREG', 'read-write',
            u"",
            23, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENPACORE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENPACORE, self).__init__(register,
            'TX6DBMENPACORE', 'RAC_NS.TX.TX6DBMENPACORE', 'read-write',
            u"",
            24, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_TX_TX6DBMENPAOUT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_TX_TX6DBMENPAOUT, self).__init__(register,
            'TX6DBMENPAOUT', 'RAC_NS.TX.TX6DBMENPAOUT', 'read-write',
            u"",
            25, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYTRIM1_SYLODIVRLOADCCLKSEL(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYTRIM1_SYLODIVRLOADCCLKSEL, self).__init__(register,
            'SYLODIVRLOADCCLKSEL', 'RAC_NS.SYTRIM1.SYLODIVRLOADCCLKSEL', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SYTRIM1_SYLODIVSGTESTDIV(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYTRIM1_SYLODIVSGTESTDIV, self).__init__(register,
            'SYLODIVSGTESTDIV', 'RAC_NS.SYTRIM1.SYLODIVSGTESTDIV', 'read-write',
            u"",
            29, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYLOEN_SYLODIVRLO2G4EN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYLOEN_SYLODIVRLO2G4EN, self).__init__(register,
            'SYLODIVRLO2G4EN', 'RAC_NS.SYLOEN.SYLODIVRLO2G4EN', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4AUXEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4AUXEN, self).__init__(register,
            'SYLODIVTLO6DBM2G4AUXEN', 'RAC_NS.SYLOEN.SYLODIVTLO6DBM2G4AUXEN', 'read-write',
            u"",
            9, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4EN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYLOEN_SYLODIVTLO6DBM2G4EN, self).__init__(register,
            'SYLODIVTLO6DBM2G4EN', 'RAC_NS.SYLOEN.SYLODIVTLO6DBM2G4EN', 'read-write',
            u"",
            10, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_SYLOEN_SYLODIVSGTESTDIVEN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYLOEN_SYLODIVSGTESTDIVEN, self).__init__(register,
            'SYLODIVSGTESTDIVEN', 'RAC_NS.SYLOEN.SYLODIVSGTESTDIVEN', 'read-write',
            u"",
            31, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SYMMDCTRL_SYMMDMODE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SYMMDCTRL_SYMMDMODE, self).__init__(register,
            'SYMMDMODE', 'RAC_NS.SYMMDCTRL.SYMMDMODE', 'read-write',
            u"",
            9, 3)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_SPARE_TX6DBMSPARE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_SPARE_TX6DBMSPARE, self).__init__(register,
            'TX6DBMSPARE', 'RAC_NS.SPARE.TX6DBMSPARE', 'read-write',
            u"",
            8, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXRFATT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXRFATT, self).__init__(register,
            'ENMANLNAMIXRFATT', 'RAC_NS.AGCOVERWRITE.ENMANLNAMIXRFATT', 'read-write',
            u"",
            0, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXSLICE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_ENMANLNAMIXSLICE, self).__init__(register,
            'ENMANLNAMIXSLICE', 'RAC_NS.AGCOVERWRITE.ENMANLNAMIXSLICE', 'read-write',
            u"",
            1, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_ENMANPGAGAIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_ENMANPGAGAIN, self).__init__(register,
            'ENMANPGAGAIN', 'RAC_NS.AGCOVERWRITE.ENMANPGAGAIN', 'read-write',
            u"",
            2, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_ENMANIFADCSCALE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_ENMANIFADCSCALE, self).__init__(register,
            'ENMANIFADCSCALE', 'RAC_NS.AGCOVERWRITE.ENMANIFADCSCALE', 'read-write',
            u"",
            3, 1)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXRFATT(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXRFATT, self).__init__(register,
            'MANLNAMIXRFATT', 'RAC_NS.AGCOVERWRITE.MANLNAMIXRFATT', 'read-write',
            u"",
            4, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXSLICE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_MANLNAMIXSLICE, self).__init__(register,
            'MANLNAMIXSLICE', 'RAC_NS.AGCOVERWRITE.MANLNAMIXSLICE', 'read-write',
            u"",
            10, 6)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_MANPGAGAIN(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_MANPGAGAIN, self).__init__(register,
            'MANPGAGAIN', 'RAC_NS.AGCOVERWRITE.MANPGAGAIN', 'read-write',
            u"",
            20, 4)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_AGCOVERWRITE_MANIFADCSCALE(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_AGCOVERWRITE_MANIFADCSCALE, self).__init__(register,
            'MANIFADCSCALE', 'RAC_NS.AGCOVERWRITE.MANIFADCSCALE', 'read-write',
            u"",
            24, 2)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFLOCK0_RACPAEN6DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFLOCK0_RACPAEN6DBM, self).__init__(register,
            'RACPAEN6DBM', 'RAC_NS.RFLOCK0.RACPAEN6DBM', 'read-write',
            u"",
            17, 1)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE0DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE0DBM, self).__init__(register,
            'RACPASTRIPE0DBM', 'RAC_NS.RFLOCK1.RACPASTRIPE0DBM', 'read-write',
            u"",
            0, 4)
        self.__dict__['zz_frozen'] = True
...
class RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE6DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFLOCK1_RACPASTRIPE6DBM, self).__init__(register,
            'RACPASTRIPE6DBM', 'RAC_NS.RFLOCK1.RACPASTRIPE6DBM', 'read-write',
            u"",
            8, 5)
        self.__dict__['zz_frozen'] = True


class RM_Field_RAC_NS_RFLOCK1_RACPASLICE6DBM(Base_RM_Field):
    def __init__(self, register):
        self.__dict__['zz_frozen'] = False
        super(RM_Field_RAC_NS_RFLOCK1_RACPASLICE6DBM, self).__init__(register,
            'RACPASLICE6DBM', 'RAC_NS.RFLOCK1.RACPASLICE6DBM', 'read-write',
            u"",
            13, 3)
        self.__dict__['zz_frozen'] = True
