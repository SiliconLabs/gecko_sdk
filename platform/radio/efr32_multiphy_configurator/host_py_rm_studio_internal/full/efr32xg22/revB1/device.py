...
Device
^^^^^^
This package provides a top-level device class, ``RM_Device_EFR32XG22X000F512IM32_RevB1``,
...
register I/O or in a live session with a real part.
  ...
  .. autoclass::  RM_Device_EFR32XG22X000F512IM32_RevB1
     :members:
     :show-inheritance:
     :inherited-members:
...
__all__ = [ 'RM_Device_EFR32XG22X000F512IM32_RevB1' ]
...
class RM_Device_EFR32XG22X000F512IM32_RevB1(Base_RM_Device):
    """
    ...
    def __init__(self, rmio=None, label='offline_rm', default_tz_access_mode=RM_TrustZone_Access_Mode.TZ_SECURE):
        ...
        super(RM_Device_EFR32XG22X000F512IM32_RevB1, self).__init__(rmio, label,
            'EFR32XG22X000F512IM32',
            RM_SVD_Info('EFR32XG22X000F512IM32_SEQ.svd', 'e0fc706f7739dcda1bdeebc1c09c2cd5'))
