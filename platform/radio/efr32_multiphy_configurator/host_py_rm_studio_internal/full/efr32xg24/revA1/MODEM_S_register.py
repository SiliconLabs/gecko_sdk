...
class RM_Register_MODEM_S_SRC2NCOCTRL(Base_RM_Register):
    def __init__(self, rmio, label):
        self.__dict__['zz_frozen'] = False
        super(RM_Register_MODEM_S_SRC2NCOCTRL, self).__init__(rmio, label,
            0xa8014000, 0x3E0,
            'SRC2NCOCTRL', 'MODEM_S.SRC2NCOCTRL', 'read-write',
            u"",
            0x00000000, 0x00007FFF,
            0x00001000, 0x00002000,
            0x00003000)

        self.SRC2NCOEN = RM_Field_MODEM_S_SRC2NCOCTRL_SRC2NCOEN(self)
        self.zz_fdict['SRC2NCOEN'] = self.SRC2NCOEN
        self.PHASEPERCLK = RM_Field_MODEM_S_SRC2NCOCTRL_PHASEPERCLK(self)
