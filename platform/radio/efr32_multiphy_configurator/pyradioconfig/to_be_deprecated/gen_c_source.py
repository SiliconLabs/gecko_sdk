...
from pyradioconfig.calculator_model_framework.Utils.PhyUtils import find_all_nonsim_phys
...
def print_h_top_format_hack(source_lines_h, remote_url, remote_hash, part_family):
    ...
    source_lines_h.append('')
    source_lines_h.append('#include "radio_config_%s_autogen.h"' % part_family.lower())
...
#define EFRTEST_SelectPhy_string(phySelect) do { \
    ...
    \
    SelectPhy_##phySelect##_sim_margay_autogen(); \
    \
    EFRTEST_SetupLO(); \
    \
