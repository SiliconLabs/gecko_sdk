...
def build_modem_regs_jumbo(model,profile):
    ...
    profile.outputs.append(ModelOutput(model.vars.SEQ_MISC_DYNAMIC_BBSS_SW_EN,   '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.MISC.DYNAMIC_BBSS_SW_EN'))
    ...
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_4_BBSS_LEVEL_4_OFFSET, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_4.BBSS_LEVEL_4_OFFSET'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_4_BBSS_LEVEL_5_VALUE, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_4.BBSS_LEVEL_5_VALUE'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_4_DEFAULT_TIM_THRESH, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_4.DEFAULT_TIM_THRESH'))

    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_3_BBSS_LEVEL_2_VALUE, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_3.BBSS_LEVEL_2_VALUE'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_3_BBSS_TIM_DETECTED_TIM_THRESH, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_3.BBSS_TIM_DETECTED_TIM_THRESH'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_3_BBSS_LEVEL_3_OFFSET, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_3.BBSS_LEVEL_3_OFFSET'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_3_BBSS_LEVEL_3_VALUE, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_3.BBSS_LEVEL_3_VALUE'))

    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_2_SYNC_THRESH_LOW, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_2.SYNC_THRESH_LOW'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_2_BBSS_LEVEL_1_VALUE, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_2.BBSS_LEVEL_1_VALUE'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_2_SYNC_THRESH_MID, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_2.SYNC_THRESH_MID'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_2_BBSS_LEVEL_2_OFFSET, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_2.BBSS_LEVEL_2_OFFSET'))

    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_1_BBS_LEVEL_1_OFFSET, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_1.BBS_LEVEL_1_OFFSET'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_1_BBSS_LEVEL_LOW, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_1.BBSS_LEVEL_LOW'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_1_BBSS_HYSTERESIS, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_1.BBSS_HYSTERESIS'))
    profile.outputs.append(ModelOutput(model.vars.SEQ_BBSS_GROUP_1_IIR_SHIFT, '', ModelOutputType.SEQ_REG_FIELD, readable_name='SEQ.BBSS_GROUP_1.IIR_SHIFT'))