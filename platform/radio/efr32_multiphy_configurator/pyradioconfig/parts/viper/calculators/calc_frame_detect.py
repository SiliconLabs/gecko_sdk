...
class calc_frame_detect_viper(Calc_Frame_Detect_Bobcat):
    ...
    def calc_dualsync_reg(self, model):
        ...
        self._reg_write(model.vars.MODEM_SYNCWORDCTRL_TRISYNC, reg2_value)
    ...
    def calc_syncbits_reg(self, model):
        ...
        self._reg_write(model.vars.MODEM_SYNCWORDCTRL_SYNC1BITS, syncword_length - 1)
        self._reg_write(model.vars.MODEM_SYNCWORDCTRL_SYNC2BITS, syncword_length - 1) ##fix me
    ...
    def calc_syncword_length_actual(self, model):
        ...
        model.vars.syncword_length_actual.value = model.vars.MODEM_SYNCWORDCTRL_SYNC0BITS.value + 1
