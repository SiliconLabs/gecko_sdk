...
class Profile_Long_Range_Jumbo(IProfile):
    ...
    def _fixed_longrange_vars(self, model):
        ...
        model.vars.var_length_minlength.value_forced = 3
        model.vars.var_length_maxlength.value_forced = 0xFF
    ...
    def _lookup_from_longrange_mode(self, model):
        ...
        if longrange_mode == model.vars.longrange_mode.var_enum.LR_1p2k:
            ...
            model.vars.bitrate.value_forced = 38400
            model.vars.deviation.value_forced = 76800
            model.vars.timing_detection_threshold.value_forced = 175
            model.vars.MODEM_CTRL5_BBSS.value_forced = 3
