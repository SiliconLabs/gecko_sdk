...
class ProfileWisunFanJumbo(IProfile):
    ...
    def __init__(self):
        self._profileName = "wisun_fan_1_0"
        self._readable_name = "Wi-SUN FAN 1.0 Profile"
        self._category = ""
        self._description = "Profile used for Wi-SUN FAN 1.0 PHYs"
        self._default = False
