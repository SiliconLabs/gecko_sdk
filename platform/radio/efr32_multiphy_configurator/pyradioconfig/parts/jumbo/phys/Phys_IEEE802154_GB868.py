...
class PHYS_IEEE802154_GB868_Jumbo(IPhy):
    ...
    def PHY_IEEE802154_GB868_863MHz_PHR2(self, model, phy_name=None):
        ...
        phy.profile_outputs.MODEM_AFCADJLIM_AFCADJLIM.override = 4500
        phy.profile_outputs.MODEM_AFC_AFCDEL.override = 31
        phy.profile_outputs.MODEM_AFC_AFCSCALEM.override = 15
        phy.profile_outputs.MODEM_AFC_AFCSCALEE.override = 1
        phy.profile_outputs.MODEM_TIMING_OFFSUBNUM.override = 0
        phy.profile_outputs.MODEM_TIMING_OFFSUBDEN.override = 1
        phy.profile_outputs.MODEM_CTRL5_RESYNCBAUDTRANS.override = 1
        phy.profile_outputs.MODEM_CTRL4_ISICOMP.override = 7
