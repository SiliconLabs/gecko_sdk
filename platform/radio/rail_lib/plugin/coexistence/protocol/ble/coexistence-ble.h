...
#define SL_BT_COEX_OPTION_RHO_ENABLE_SHIFT      9
...
/* Radio hold-off is enabled */
#define SL_BT_COEX_OPTION_RHO_ENABLE            (1 << SL_BT_COEX_OPTION_RHO_ENABLE_SHIFT)
...
// Initialise coexistence interface
  ...
  coexInit.options |= SL_RAIL_UTIL_COEX_RHO_ENABLED ? SL_BT_COEX_OPTION_RHO_ENABLE : 0;
