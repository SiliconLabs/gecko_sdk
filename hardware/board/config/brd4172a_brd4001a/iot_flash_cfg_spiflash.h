...
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PIN        6
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_LOC        11

// USART1 RX on PC7
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PORT       gpioPortC
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PIN        7
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_LOC        11

// USART1 CLK on PC8
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PORT      gpioPortC
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PIN       8
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_LOC       11

// USART1 CS on PA4
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PORT       gpioPortA
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PIN        4
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_LOC        1
