...
// USART2 TX on PK0
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PORT       gpioPortK
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PIN        0
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_LOC        29

// USART2 RX on PK2
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PORT       gpioPortK
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PIN        2
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_LOC        30

// USART2 CLK on PF7
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PORT      gpioPortF
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PIN       7
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_LOC       18

// USART2 CS on PK1
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PORT       gpioPortK
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PIN        1
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_LOC        27
