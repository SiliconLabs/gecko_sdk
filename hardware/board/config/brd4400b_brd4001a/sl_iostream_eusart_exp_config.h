...
#define SL_IOSTREAM_EUSART_EXP_PERIPHERAL        EUSART2
#define SL_IOSTREAM_EUSART_EXP_PERIPHERAL_NO     2

// EUSART2 TX on PD11
#define SL_IOSTREAM_EUSART_EXP_TX_PORT           gpioPortD
#define SL_IOSTREAM_EUSART_EXP_TX_PIN            11

// EUSART2 RX on PD12
#define SL_IOSTREAM_EUSART_EXP_RX_PORT           gpioPortD
#define SL_IOSTREAM_EUSART_EXP_RX_PIN            12
