...
// <d> 0
#define SL_CPC_DRV_SPI_MIKROE_CS_EXTI_NUMBER              4
// </h>
...
#define SL_CPC_DRV_SPI_MIKROE_TX_PIN             1
...
#define SL_CPC_DRV_SPI_MIKROE_SCLK_PIN           3

// EUSART1 CS on PC04
#define SL_CPC_DRV_SPI_MIKROE_CS_PORT            gpioPortC
#define SL_CPC_DRV_SPI_MIKROE_CS_PIN             4
