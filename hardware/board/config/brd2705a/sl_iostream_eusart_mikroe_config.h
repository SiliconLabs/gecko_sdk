...
#define SL_IOSTREAM_EUSART_MIKROE_PERIPHERAL     EUSART1
#define SL_IOSTREAM_EUSART_MIKROE_PERIPHERAL_NO  1

// EUSART1 TX on PA04
#define SL_IOSTREAM_EUSART_MIKROE_TX_PORT        gpioPortA
#define SL_IOSTREAM_EUSART_MIKROE_TX_PIN         4

// EUSART1 RX on PA05
#define SL_IOSTREAM_EUSART_MIKROE_RX_PORT        gpioPortA
#define SL_IOSTREAM_EUSART_MIKROE_RX_PIN         5
