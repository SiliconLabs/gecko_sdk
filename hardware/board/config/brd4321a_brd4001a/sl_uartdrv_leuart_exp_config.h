...
// LEUART0 TX on PE14
#define SL_UARTDRV_LEUART_EXP_TX_PORT            gpioPortE
#define SL_UARTDRV_LEUART_EXP_TX_PIN             14
#define SL_UARTDRV_LEUART_EXP_TX_LOC             2

// LEUART0 RX on PE15
#define SL_UARTDRV_LEUART_EXP_RX_PORT            gpioPortE
#define SL_UARTDRV_LEUART_EXP_RX_PIN             15
#define SL_UARTDRV_LEUART_EXP_RX_LOC             2
