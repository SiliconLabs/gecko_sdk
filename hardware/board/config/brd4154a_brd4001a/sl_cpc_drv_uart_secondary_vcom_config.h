...
#define SL_CPC_DRV_UART_VCOM_CTS_PIN             11
#define SL_CPC_DRV_UART_VCOM_CTS_LOC             2

// USART0 RTS on PD13
#define SL_CPC_DRV_UART_VCOM_RTS_PORT            gpioPortD
#define SL_CPC_DRV_UART_VCOM_RTS_PIN             13
#define SL_CPC_DRV_UART_VCOM_RTS_LOC             16
