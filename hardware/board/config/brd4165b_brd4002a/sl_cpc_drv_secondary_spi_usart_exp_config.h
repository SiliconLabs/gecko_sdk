...
#define SL_CPC_DRV_SPI_EXP_RX_IRQ_PIN            10
...
#define SL_CPC_DRV_SPI_EXP_CLK_PIN               11
#define SL_CPC_DRV_SPI_EXP_CLK_LOC               4

// USART1 CS on PF7
#define SL_CPC_DRV_SPI_EXP_CS_PORT               gpioPortF
#define SL_CPC_DRV_SPI_EXP_CS_PIN                7
#define SL_CPC_DRV_SPI_EXP_CS_LOC                28
