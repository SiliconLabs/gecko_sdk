...
// <<< sl:start pin_tool >>>
// <usart signal=TX,RX> SL_UARTDRV_USART_VCOM
// $[USART_SL_UARTDRV_USART_VCOM]
#define SL_UARTDRV_USART_VCOM_PERIPHERAL         UART0
#define SL_UARTDRV_USART_VCOM_PERIPHERAL_NO      0

// UART0 TX on PE0
#define SL_UARTDRV_USART_VCOM_TX_PORT            gpioPortE
#define SL_UARTDRV_USART_VCOM_TX_PIN             0
#define SL_UARTDRV_USART_VCOM_ROUTE_LOC          1

// UART0 RX on PE1
#define SL_UARTDRV_USART_VCOM_RX_PORT            gpioPortE
#define SL_UARTDRV_USART_VCOM_RX_PIN             1

// [USART_SL_UARTDRV_USART_VCOM]$
// <gpio> SL_UARTDRV_USART_VCOM_CTS
// $[GPIO_SL_UARTDRV_USART_VCOM_CTS]

// [GPIO_SL_UARTDRV_USART_VCOM_CTS]$

// <gpio> SL_UARTDRV_USART_VCOM_RTS
// $[GPIO_SL_UARTDRV_USART_VCOM_RTS]
