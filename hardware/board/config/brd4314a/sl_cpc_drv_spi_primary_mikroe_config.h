...
#ifndef SL_CPC_DRV_SPI_MIKROE_PRIMARY_CONFIG_H
#define SL_CPC_DRV_SPI_MIKROE_PRIMARY_CONFIG_H
#include "spidrv.h"
...
// <o SL_CPC_DRV_SPI_MIKROE_RX_IRQ_FALLING_EDGE_INT_NO> Receive Interrupt Number on Falling Edge
// <i> Default: 0
#define SL_CPC_DRV_SPI_MIKROE_RX_IRQ_FALLING_EDGE_INT_NO  0

// <o SL_CPC_DRV_SPI_MIKROE_RX_IRQ_RISING_EDGE_INT_NO> Receive Interrupt Number on Rising Edge
// <i> Default: 1
...
#define SL_CPC_DRV_SPI_MIKROE_TX_PIN             0

// USART0 RX on PC01
#define SL_CPC_DRV_SPI_MIKROE_RX_PORT            gpioPortC
#define SL_CPC_DRV_SPI_MIKROE_RX_PIN             1
