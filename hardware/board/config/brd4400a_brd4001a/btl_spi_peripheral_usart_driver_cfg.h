...
#define SL_USART_SPINCP_RX_PIN                   8

// USART0 CS on PD10
#define SL_USART_SPINCP_CS_PORT                  gpioPortD
#define SL_USART_SPINCP_CS_PIN                   10

// USART0 CLK on PD09
#define SL_USART_SPINCP_CLK_PORT                 gpioPortD
#define SL_USART_SPINCP_CLK_PIN                  9
