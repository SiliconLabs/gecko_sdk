...
// $[TIMER_SL_PWM_LED0]
#define SL_PWM_LED0_PERIPHERAL                   TIMER6
#define SL_PWM_LED0_PERIPHERAL_NO                6

#define SL_PWM_LED0_OUTPUT_CHANNEL               2
// TIMER6 CC2 on PH10
#define SL_PWM_LED0_OUTPUT_PORT                  gpioPortH
#define SL_PWM_LED0_OUTPUT_PIN                   10
#define SL_PWM_LED0_OUTPUT_LOC                   4
