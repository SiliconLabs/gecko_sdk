...
// $[TIMER_SL_PWM_LED1]
#define SL_PWM_LED1_PERIPHERAL                   WTIMER1
#define SL_PWM_LED1_PERIPHERAL_NO                1

#define SL_PWM_LED1_OUTPUT_CHANNEL               1
// WTIMER1 CC1 on PH13
#define SL_PWM_LED1_OUTPUT_PORT                  gpioPortH
#define SL_PWM_LED1_OUTPUT_PIN                   13
#define SL_PWM_LED1_OUTPUT_LOC                   7
