...
#define SL_IOSTREAM_USART_EXP_TX_PIN             11
#define SL_IOSTREAM_USART_EXP_TX_LOC             2

// USART0 RX on PC10
#define SL_IOSTREAM_USART_EXP_RX_PORT            gpioPortC
#define SL_IOSTREAM_USART_EXP_RX_PIN             10
#define SL_IOSTREAM_USART_EXP_RX_LOC             2
