...
#define IOT_FLASH_CFG_SPIFLASH_SPI_PERIPHERAL    USART1
#define IOT_FLASH_CFG_SPIFLASH_SPI_PERIPHERAL_NO 1

// USART1 TX on PA0
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PORT       gpioPortA
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_PIN        0
#define IOT_FLASH_CFG_SPIFLASH_SPI_TX_LOC        0

// USART1 RX on PA1
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PORT       gpioPortA
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_PIN        1
#define IOT_FLASH_CFG_SPIFLASH_SPI_RX_LOC        0

// USART1 CLK on PB11
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PORT      gpioPortB
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_PIN       11
#define IOT_FLASH_CFG_SPIFLASH_SPI_CLK_LOC       4

// USART1 CS on PC7
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PORT       gpioPortC
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_PIN        7
#define IOT_FLASH_CFG_SPIFLASH_SPI_CS_LOC        9
