...
// EUSART1 TX on PC04
#define SL_SPIDRV_EUSART_MIKROE_TX_PORT          gpioPortC
#define SL_SPIDRV_EUSART_MIKROE_TX_PIN           4

// EUSART1 RX on PC05
#define SL_SPIDRV_EUSART_MIKROE_RX_PORT          gpioPortC
#define SL_SPIDRV_EUSART_MIKROE_RX_PIN           5

// EUSART1 SCLK on PC02
#define SL_SPIDRV_EUSART_MIKROE_SCLK_PORT        gpioPortC
#define SL_SPIDRV_EUSART_MIKROE_SCLK_PIN         2

// EUSART1 CS on PC03
#define SL_SPIDRV_EUSART_MIKROE_CS_PORT          gpioPortC
#define SL_SPIDRV_EUSART_MIKROE_CS_PIN           3
