...
// LEUART0 TX on PD4
#define SL_UARTDRV_LEUART_VCOM_TX_PORT           gpioPortD
#define SL_UARTDRV_LEUART_VCOM_TX_PIN            4
#define SL_UARTDRV_LEUART_VCOM_ROUTE_LOC         0

// LEUART0 RX on PD5
#define SL_UARTDRV_LEUART_VCOM_RX_PORT           gpioPortD
#define SL_UARTDRV_LEUART_VCOM_RX_PIN            5
