...
#define SL_UARTDRV_USART_EXP_PERIPHERAL          USART3
#define SL_UARTDRV_USART_EXP_PERIPHERAL_NO       3

// USART3 TX on PC4
#define SL_UARTDRV_USART_EXP_TX_PORT             gpioPortC
#define SL_UARTDRV_USART_EXP_TX_PIN              4
#define SL_UARTDRV_USART_EXP_TX_LOC              22

// USART3 RX on PC5
#define SL_UARTDRV_USART_EXP_RX_PORT             gpioPortC
#define SL_UARTDRV_USART_EXP_RX_PIN              5
#define SL_UARTDRV_USART_EXP_RX_LOC              22
