...
#define SL_SPIDRV_USART_EXP_PERIPHERAL           USART3
#define SL_SPIDRV_USART_EXP_PERIPHERAL_NO        3

// USART3 TX on PC0
#define SL_SPIDRV_USART_EXP_TX_PORT              gpioPortC
#define SL_SPIDRV_USART_EXP_TX_PIN               0
#define SL_SPIDRV_USART_EXP_TX_LOC               18

// USART3 RX on PC1
#define SL_SPIDRV_USART_EXP_RX_PORT              gpioPortC
#define SL_SPIDRV_USART_EXP_RX_PIN               1
#define SL_SPIDRV_USART_EXP_RX_LOC               18

// USART3 CLK on PC2
#define SL_SPIDRV_USART_EXP_CLK_PORT             gpioPortC
#define SL_SPIDRV_USART_EXP_CLK_PIN              2
#define SL_SPIDRV_USART_EXP_CLK_LOC              18

// USART3 CS on PC3
#define SL_SPIDRV_USART_EXP_CS_PORT              gpioPortC
#define SL_SPIDRV_USART_EXP_CS_PIN               3
#define SL_SPIDRV_USART_EXP_CS_LOC               18
