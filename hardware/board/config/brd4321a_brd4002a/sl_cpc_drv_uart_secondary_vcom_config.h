...
#ifndef SL_CPC_DRV_UART_VCOM_SECONDARY_CONFIG_H
#define SL_CPC_DRV_UART_VCOM_SECONDARY_CONFIG_H
...
// USART0 TX on PE7
#define SL_CPC_DRV_UART_VCOM_TX_PORT             gpioPortE
#define SL_CPC_DRV_UART_VCOM_TX_PIN              7
#define SL_CPC_DRV_UART_VCOM_TX_LOC              1

// USART0 RX on PE6
#define SL_CPC_DRV_UART_VCOM_RX_PORT             gpioPortE
#define SL_CPC_DRV_UART_VCOM_RX_PIN              6
#define SL_CPC_DRV_UART_VCOM_RX_LOC              1

// USART0 CTS on PB6
#define SL_CPC_DRV_UART_VCOM_CTS_PORT            gpioPortB
#define SL_CPC_DRV_UART_VCOM_CTS_PIN             6
