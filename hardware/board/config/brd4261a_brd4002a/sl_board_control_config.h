...
// <q SL_BOARD_ENABLE_OSCILLATOR_TCXO> Enable TCXO
// <i> Default: 1
#define SL_BOARD_ENABLE_OSCILLATOR_TCXO         1
...
// <gpio> SL_BOARD_ENABLE_OSCILLATOR_TCXO
// $[GPIO_SL_BOARD_ENABLE_OSCILLATOR_TCXO]
#define SL_BOARD_ENABLE_OSCILLATOR_TCXO_PORT    gpioPortC
#define SL_BOARD_ENABLE_OSCILLATOR_TCXO_PIN     9
// [GPIO_SL_BOARD_ENABLE_OSCILLATOR_TCXO]$
