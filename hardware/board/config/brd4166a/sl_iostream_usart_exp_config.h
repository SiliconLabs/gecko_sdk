...
// USART0 TX on PF3
#define SL_IOSTREAM_USART_EXP_TX_PORT            gpioPortF
#define SL_IOSTREAM_USART_EXP_TX_PIN             3
#define SL_IOSTREAM_USART_EXP_TX_LOC             27

// USART0 RX on PF4
#define SL_IOSTREAM_USART_EXP_RX_PORT            gpioPortF
#define SL_IOSTREAM_USART_EXP_RX_PIN             4
#define SL_IOSTREAM_USART_EXP_RX_LOC             27

// USART0 CTS on PA2
#define SL_IOSTREAM_USART_EXP_CTS_PORT           gpioPortA
#define SL_IOSTREAM_USART_EXP_CTS_PIN            2
#define SL_IOSTREAM_USART_EXP_CTS_LOC            30

// USART0 RTS on PA3
#define SL_IOSTREAM_USART_EXP_RTS_PORT           gpioPortA
#define SL_IOSTREAM_USART_EXP_RTS_PIN            3
#define SL_IOSTREAM_USART_EXP_RTS_LOC            30
