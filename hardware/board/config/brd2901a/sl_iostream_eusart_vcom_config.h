...
// EUART0 RX on PB03
#define SL_IOSTREAM_EUSART_VCOM_RX_PORT          gpioPortB
#define SL_IOSTREAM_EUSART_VCOM_RX_PIN           3

// EUART0 CTS on PB04
#define SL_IOSTREAM_EUSART_VCOM_CTS_PORT         gpioPortB
#define SL_IOSTREAM_EUSART_VCOM_CTS_PIN          4

// EUART0 RTS on PB02
#define SL_IOSTREAM_EUSART_VCOM_RTS_PORT         gpioPortB
#define SL_IOSTREAM_EUSART_VCOM_RTS_PIN          2
