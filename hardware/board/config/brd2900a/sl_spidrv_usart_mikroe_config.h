...
// USART0 TX on PD03
#define SL_SPIDRV_USART_MIKROE_TX_PORT           gpioPortD
#define SL_SPIDRV_USART_MIKROE_TX_PIN            3

// USART0 RX on PD02
#define SL_SPIDRV_USART_MIKROE_RX_PORT           gpioPortD
#define SL_SPIDRV_USART_MIKROE_RX_PIN            2

// USART0 CLK on PC00
#define SL_SPIDRV_USART_MIKROE_CLK_PORT          gpioPortC
#define SL_SPIDRV_USART_MIKROE_CLK_PIN           0

// USART0 CS on PC01
#define SL_SPIDRV_USART_MIKROE_CS_PORT           gpioPortC
#define SL_SPIDRV_USART_MIKROE_CS_PIN            1
