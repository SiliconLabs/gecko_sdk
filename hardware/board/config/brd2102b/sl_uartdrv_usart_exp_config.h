...
#define SL_UARTDRV_USART_EXP_PERIPHERAL          UART0
#define SL_UARTDRV_USART_EXP_PERIPHERAL_NO       0

// UART0 TX on PC14
#define SL_UARTDRV_USART_EXP_TX_PORT             gpioPortC
#define SL_UARTDRV_USART_EXP_TX_PIN              14
#define SL_UARTDRV_USART_EXP_TX_LOC              3

// UART0 RX on PC15
#define SL_UARTDRV_USART_EXP_RX_PORT             gpioPortC
#define SL_UARTDRV_USART_EXP_RX_PIN              15
#define SL_UARTDRV_USART_EXP_RX_LOC              3
