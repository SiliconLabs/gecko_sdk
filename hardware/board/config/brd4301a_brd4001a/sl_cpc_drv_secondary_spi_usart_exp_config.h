...
// <o SL_CPC_DRV_SPI_EXP_CS_INV_SYNCTRIG_PRS_CH> The LDMA SYNCTRIG bit number for the CS Inverted PRS channel [bit] <0-7>
// <i> Specify which SYNCTRIG bit is used. Modify this value to avoid collisions if specific LDMA SYNCTRIG bits need to be used elsewhere in the project
// <i> This bit number is tied to the equivalent PRS channel number. Keep that in mind if using PRS channels elsewhere in the project.
// <i> Default : 5
// <d> 5
#define SL_CPC_DRV_SPI_EXP_CS_INV_SYNCTRIG_PRS_CH      4
...
// <i> Default : 6
// <d> 6
#define SL_CPC_DRV_SPI_EXP_TXC_SYNCTRIG_PRS_CH         3
...
#define SL_CPC_DRV_SPI_EXP_RX_IRQ_PIN            11
...
// USART1 TX on PB11
#define SL_CPC_DRV_SPI_EXP_TX_PORT               gpioPortB
#define SL_CPC_DRV_SPI_EXP_TX_PIN                11
#define SL_CPC_DRV_SPI_EXP_TX_LOC                6

// USART1 RX on PB12
#define SL_CPC_DRV_SPI_EXP_RX_PORT               gpioPortB
#define SL_CPC_DRV_SPI_EXP_RX_PIN                12
#define SL_CPC_DRV_SPI_EXP_RX_LOC                6

// USART1 CLK on PB13
#define SL_CPC_DRV_SPI_EXP_CLK_PORT              gpioPortB
#define SL_CPC_DRV_SPI_EXP_CLK_PIN               13
#define SL_CPC_DRV_SPI_EXP_CLK_LOC               6

// USART1 CS on PD13
#define SL_CPC_DRV_SPI_EXP_CS_PORT               gpioPortD
#define SL_CPC_DRV_SPI_EXP_CS_PIN                13
#define SL_CPC_DRV_SPI_EXP_CS_LOC                18
