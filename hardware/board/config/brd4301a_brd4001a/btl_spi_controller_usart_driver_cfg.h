...
#define SL_USART_EXTFLASH_TX_PIN                 11
#define SL_USART_EXTFLASH_TX_LOC                 6

// USART1 RX on PB12
#define SL_USART_EXTFLASH_RX_PORT                gpioPortB
#define SL_USART_EXTFLASH_RX_PIN                 12
#define SL_USART_EXTFLASH_RX_LOC                 6

// USART1 CLK on PB13
#define SL_USART_EXTFLASH_CLK_PORT               gpioPortB
#define SL_USART_EXTFLASH_CLK_PIN                13
#define SL_USART_EXTFLASH_CLK_LOC                6

// USART1 CS on PD13
#define SL_USART_EXTFLASH_CS_PORT                gpioPortD
#define SL_USART_EXTFLASH_CS_PIN                 13
#define SL_USART_EXTFLASH_CS_LOC                 18
