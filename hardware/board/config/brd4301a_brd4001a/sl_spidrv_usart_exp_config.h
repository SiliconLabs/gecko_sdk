...
// USART1 TX on PB11
#define SL_SPIDRV_USART_EXP_TX_PORT              gpioPortB
#define SL_SPIDRV_USART_EXP_TX_PIN               11
#define SL_SPIDRV_USART_EXP_TX_LOC               6

// USART1 RX on PB12
#define SL_SPIDRV_USART_EXP_RX_PORT              gpioPortB
#define SL_SPIDRV_USART_EXP_RX_PIN               12
#define SL_SPIDRV_USART_EXP_RX_LOC               6

// USART1 CLK on PB13
#define SL_SPIDRV_USART_EXP_CLK_PORT             gpioPortB
#define SL_SPIDRV_USART_EXP_CLK_PIN              13
#define SL_SPIDRV_USART_EXP_CLK_LOC              6
