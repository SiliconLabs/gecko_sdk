...
// <i> Default: 10
#define SL_NCP_SPIDRV_USART_CS_FALLING_EDGE_INT_NO  4

// <o SL_NCP_SPIDRV_USART_CS_RISING_EDGE_INT_NO> Chip Select Interrupt Number on Rising Edge
// <i> Default: 9
#define SL_NCP_SPIDRV_USART_CS_RISING_EDGE_INT_NO   5
// </h>
...
#define SL_NCP_SPIDRV_USART_HOST_INT_PIN         2
...
#define SL_NCP_SPIDRV_USART_TX_PIN               5

// USART0 RX on PC03
#define SL_NCP_SPIDRV_USART_RX_PORT              gpioPortC
#define SL_NCP_SPIDRV_USART_RX_PIN               3
...
#define SL_NCP_SPIDRV_USART_CS_PIN               6
