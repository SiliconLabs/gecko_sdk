...
#define SL_IOSTREAM_EUSART_EXP_PERIPHERAL        EUART0
#define SL_IOSTREAM_EUSART_EXP_PERIPHERAL_NO     0

// EUART0 TX on PC02
#define SL_IOSTREAM_EUSART_EXP_TX_PORT           gpioPortC
#define SL_IOSTREAM_EUSART_EXP_TX_PIN            2

// EUART0 RX on PC03
#define SL_IOSTREAM_EUSART_EXP_RX_PORT           gpioPortC
#define SL_IOSTREAM_EUSART_EXP_RX_PIN            3
