...
#define SL_SIMPLE_RGB_PWM_LED_INST0_RED_PIN      4

#define SL_SIMPLE_RGB_PWM_LED_INST0_GREEN_CHANNEL 1
// TIMER0 CC1 on PB05
#define SL_SIMPLE_RGB_PWM_LED_INST0_GREEN_PORT   gpioPortB
#define SL_SIMPLE_RGB_PWM_LED_INST0_GREEN_PIN    5

#define SL_SIMPLE_RGB_PWM_LED_INST0_BLUE_CHANNEL 2
// TIMER0 CC2 on PB06
#define SL_SIMPLE_RGB_PWM_LED_INST0_BLUE_PORT    gpioPortB
#define SL_SIMPLE_RGB_PWM_LED_INST0_BLUE_PIN     6
