...
// <o SL_UARTDRV_LEUART_EXP_MAX_CONCURRENT_RX_BUFS> Size of the receive operation queue
// <i> Default: 6
#define SL_UARTDRV_LEUART_EXP_RX_BUFFER_SIZE 6

// <o SL_UARTDRV_LEUART_EXP_MAX_CONCURRENT_TX_BUFS> Size of the transmit operation queue
// <i> Default: 6
...
// LEUART0 TX on PD4
#define SL_UARTDRV_LEUART_EXP_TX_PORT            gpioPortD
#define SL_UARTDRV_LEUART_EXP_TX_PIN             4
#define SL_UARTDRV_LEUART_EXP_ROUTE_LOC          0

// LEUART0 RX on PD5
#define SL_UARTDRV_LEUART_EXP_RX_PORT            gpioPortD
#define SL_UARTDRV_LEUART_EXP_RX_PIN             5
